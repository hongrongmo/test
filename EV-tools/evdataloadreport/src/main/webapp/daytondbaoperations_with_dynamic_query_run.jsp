...
<br>
	...
	<br>
	<a class="rplink" href="#" onclick='addInputBox2()'>Run Custom Query</a>
...
function addInputBox() { 
	...
	//document.getElementById("dynamicsqlquery").style.display = 'none';
	document.getElementById("customCursorInfo").style.display = 'block';
	document.getElementById("dynamicquery").style.display = 'none';
...
function addInputBox2() { 
	...
	var ni = document.getElementById('dynamicquery'); 


	var newdiv = document.createElement('div'); 

	var divIdName = 'dynamicQuerydiv'; 

	newdiv.setAttribute('id',divIdName); 

	newdiv.innerHTML = "<form name=\"dynamicQuery\" class=\"dynamicQuery\" action=\"${pageContext.servletContext.contextPath}/EIAOpenedCusrors?op=dynamic\" method=\"post\">"+
						"<b>Enter SQL Query: </b><textarea rows=\"4\" cols=\"100\" name=\"dynamicsqlquery\" id=\"dynamicsqlquery\" ></textarea> "+
						"<input name=\"submit\" type=\"submit\" value=\"Run\" /></form>";


	ni.appendChild(newdiv); 
	
	document.getElementById("dynamicquery").style.display = 'block';
	//document.getElementById("sid").style.display = 'none';
	document.getElementById("customCursorInfo").style.display = 'none';
