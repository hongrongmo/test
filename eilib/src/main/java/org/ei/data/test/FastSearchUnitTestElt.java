 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class FastSearchUnitTestElt extends FastSearchUnitTest
{


    public FastSearchUnitTestElt(String inFile, 
            				     String outFile)
    {
    ...
    public static void main (String [] args) throws Exception
    {
        ...
        FastSearchUnitTestElt stest = new FastSearchUnitTestElt(inFile, outFile);
        stest.runTest();
    ...
    public void runTest() throws Exception
    {
        ...
        try
        {
            while((line=in.readLine()) != null)
            {
                ...
                {
                    boolean testResult = FastClient.unitTest(args);                
