...
public class NTISData {
    static Map<String, String> mapCountryCodes = new Hashtable<String, String>();
    static {
    ...
    public static Map<Key, String> authorAffiliationAndSponsor(String inSource) {

        String source = null;
        String performers = null;
        String sponsors = null;
        Map<Key, String> mapResult = new Hashtable<Key, String>();
    ...
    public static String formatCountry(String so, String ic) {
        Iterator<String> itrCountries = mapCountryCodes.values().iterator();
