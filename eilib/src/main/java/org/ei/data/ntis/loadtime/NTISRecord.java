...
public class NTISRecord extends Hashtable<Object, Object> {
    ...
    public static List<String> startswiththree;

    static {

        startswiththree = new ArrayList<String>();
    ...
    public NTISRecord(String serialNumber, String data) throws IOException {
