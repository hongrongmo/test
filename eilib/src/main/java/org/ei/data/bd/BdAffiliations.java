...
public class BdAffiliations {
    private TreeMap<BdAffiliation, BdAffiliation> affmap; // treeMap is used to exlude redundant affiliaitons
    private int affid;
    private LinkedHashMap<BdAffiliation, BdAffiliation> bdAffiliationsMap;
    private static ArrayList<String> elements = null;
    private static ArrayList<String> affElements = new ArrayList<String>();
    ...
    public BdAffiliations(String bdAffiliations, ArrayList<String> aElements) {
        elements = aElements;
        bdAffiliationsMap = new LinkedHashMap<BdAffiliation, BdAffiliation>();
    ...
    public LinkedHashMap<BdAffiliation, BdAffiliation> getAffMap() {
    ...
    public List<BdAffiliation> getAffiliations() {
        List<BdAffiliation> affList = new ArrayList<BdAffiliation>();
    ...
    public int getAffid(BdAffiliation cpxaff) {
        ...
        if (affmap != null && affmap.size() > 0) {
            Iterator<BdAffiliation> itr = affmap.keySet().iterator();
            while (itr.hasNext()) {
     ...
     */
    public TreeMap<BdAffiliation, BdAffiliation> getAffmap() {
        return affmap;
    }
     ...
     *            The affmap to set.
     */
    public void setAffmap(TreeMap<BdAffiliation, BdAffiliation> affmap) {
        this.affmap = affmap;
    }
    ...
    public BdAffiliations() {
        affmap = new TreeMap<BdAffiliation, BdAffiliation>(new AffIDComp());
    }

    class AffIDComp implements Comparator<Object> {
    ...
    public TreeMap<BdAffiliation, BdAffiliation> getAuthorsSorted() {
        return this.affmap;
    }
