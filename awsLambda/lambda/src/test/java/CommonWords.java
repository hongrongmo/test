...
public class CommonWords {
                                                 ...
                                                 List<String> wordsToExclude)
    {
        ...
        //literatureText = literatureText.replaceAll("\\W+"," ");					// another way to replace punctuations
        //literatureText = literatureText.replaceAll("[^a-zA-Z]+", " ");			// another way to replace punctuations
		...
		/*
		 * works in java 8, but not openjdk11s
    ...
    public static void main(String[] args)
    {
        ...
        ListIterator <String> itr = commonWords.listIterator();
        while(itr.hasNext())
        {
