...
import org.ei.common.ntis.NTISAuthor;
import org.ei.common.ntis.NTISData;
...
public class NTISDocBuilder implements DocumentBuilder {
    ...
    private String formatOrderNumbers(String num1)
    {
		...
		if(num1.indexOf(Constants.AUDELIMITER)>-1)
		{
			String[] num1Array = num1.split(Constants.AUDELIMITER);
			String num11="";
			String num12="";
