 ...
 * @author TELEBH
 * @Date: 02/09/2017
 * @Description: as per Bart request is to download VTW patents using
 *               multhithreads. we will need to use "10" threads (Max 20), each
 *               Thread will download "2000" Patents, and no need for waiting
 *               time (sleep time) using AssetAPI (instead of Search API)
 * 
 *               # of threads: 10 # of Patents in each Thread: 2k
 */
