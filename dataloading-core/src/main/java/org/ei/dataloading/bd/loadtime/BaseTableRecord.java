...
public class BaseTableRecord
{
	...
	public static final BaseTableRecord REFERENCEPUBLICATIONYEAR= new BaseTableRecord("REFERENCEPUBLICATIONYEAR", new Integer(4000), "cpx");
	public static final BaseTableRecord REFERENCEVOLUME= new BaseTableRecord("REFERENCEVOLUME", new Integer(4000), "cpx");
	public static final BaseTableRecord REFERENCEISSUE= new BaseTableRecord("REFERENCEISSUE", new Integer(4000), "cpx");
	public static final BaseTableRecord REFERENCEPAGES= new BaseTableRecord("REFERENCEPAGES", new Integer(4000), "cpx");
	...
	public static final BaseTableRecord REFERENCEWEBSITE= new BaseTableRecord("REFERENCEWEBSITE", new Integer(4000), "cpx");
	public static final BaseTableRecord REFERENCEITEMID= new BaseTableRecord("REFERENCEITEMID", new Integer(4000), "cpx");
	public static final BaseTableRecord REFERENCEITEMCITATIONPII= new BaseTableRecord("REFERENCEITEMCITATIONPII", new Integer(4000), "cpx");
	public static final BaseTableRecord REFERENCEITEMCITATIONDOI= new BaseTableRecord("REFERENCEITEMCITATIONDOI", new Integer(4000), "cpx");
	...
	public static final BaseTableRecord REFITEMCITATIONSOURCETITLE= new BaseTableRecord("REFITEMCITATIONSOURCETITLE", new Integer(4000), "cpx");
	...
	public static final BaseTableRecord REFERENCEITEMCITATIONISSN= new BaseTableRecord("REFERENCEITEMCITATIONISSN", new Integer(4000), "cpx");
	public static final BaseTableRecord REFERENCEITEMCITATIONISBN= new BaseTableRecord("REFERENCEITEMCITATIONISBN", new Integer(4000), "cpx");
	public static final BaseTableRecord REFERENCEITEMCITATIONCODEN= new BaseTableRecord("REFERENCEITEMCITATIONCODEN", new Integer(4000), "cpx");
	public static final BaseTableRecord REFERENCEITEMCITATIONPART= new BaseTableRecord("REFERENCEITEMCITATIONPART", new Integer(4000), "cpx");
	public static final BaseTableRecord REFERENCEITEMCITATIONPUBLICATIONYEAR= new BaseTableRecord("REFERENCEITEMCITATIONPUBLICATIONYEAR", new Integer(4000), "cpx");
	public static final BaseTableRecord REFERENCEITEMCITATIONVOLUME= new BaseTableRecord("REFERENCEITEMCITATIONVOLUME", new Integer(4000), "cpx");
	public static final BaseTableRecord REFERENCEITEMCITATIONISSUE= new BaseTableRecord("REFERENCEITEMCITATIONISSUE", new Integer(4000), "cpx");
	public static final BaseTableRecord REFERENCEITEMCITATIONPAGE= new BaseTableRecord("REFERENCEITEMCITATIONPAGE", new Integer(4000), "cpx");
	public static final BaseTableRecord REFERENCEITEMCITATIONARTICLENUMBER= new BaseTableRecord("REFERENCEITEMCITATIONARTICLENUMBER", new Integer(4000), "cpx");
	public static final BaseTableRecord REFERENCEITEMCITATIONWEBSITE= new BaseTableRecord("REFERENCEITEMCITATIONWEBSITE", new Integer(4000), "cpx");
