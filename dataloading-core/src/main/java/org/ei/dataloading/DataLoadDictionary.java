...
public class DataLoadDictionary
{
    ...
    static {
        ...
        badCharacterMap.put("A&ring;", "&#197;");
        badCharacterMap.put("u&ring;", "&#366;");
        badCharacterMap.put("U&ring;", "&#367;");
        
        badCharacterMap.put("C&cedil;", "&#199;");
        badCharacterMap.put("c&cedil;", "&#231;");
        badCharacterMap.put("G&cedil;", "&#290;");
        badCharacterMap.put("K&cedil;", "&#310;");
        badCharacterMap.put("k&cedil;", "&#311;");
        badCharacterMap.put("L&cedil;", "&#315;");
        badCharacterMap.put("l&cedil;", "&#316;");
        badCharacterMap.put("N&cedil;", "&#325;");
        badCharacterMap.put("n&cedil;", "&#326;");
        ...
        badCharacterMap.put("A&tilde;", "&#195;");
        badCharacterMap.put("i&tilde;", "&#297;");
        badCharacterMap.put("I&tilde;", "&#296;");
        badCharacterMap.put("n&tilde;", "&#241;");
        badCharacterMap.put("N&tilde;", "&#209;");
        badCharacterMap.put("o&tilde;", "&#245;");
        badCharacterMap.put("O&tilde;", "&#213;");
        badCharacterMap.put("u&tilde;", "&#361;");
        badCharacterMap.put("U&tilde;", "&#360;");
        ...
        badCharacterMap.put("c&caron;","&#269;");
        badCharacterMap.put("D&caron;","&#270;");
        badCharacterMap.put("d&caron;","&#271;");
        badCharacterMap.put("E&caron;","&#282;");
        badCharacterMap.put("e&caron;","&#283;");
        badCharacterMap.put("L&caron;","&#317;");
        badCharacterMap.put("l&caron;","&#318;");
        badCharacterMap.put("N&caron;","&#327;");
        badCharacterMap.put("n&caron;","&#328;");
        badCharacterMap.put("R&caron;","&#344;");
        badCharacterMap.put("r&caron;","&#345;");
        badCharacterMap.put("S&caron;","&#352;");
        badCharacterMap.put("s&caron;","&#353;");
        badCharacterMap.put("T&caron;","&#356;");
        badCharacterMap.put("t&caron;","&#357;");
        badCharacterMap.put("Z&caron;","&#381;");
        badCharacterMap.put("z&caron;","&#382;");
