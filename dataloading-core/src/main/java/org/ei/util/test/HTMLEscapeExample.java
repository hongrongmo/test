...
public class HTMLEscapeExample 
{
    ...
    public static void main(String[] args) 
    {
        ...
        if(args.length>0) 
        {
        	escapedString=args[0];
        }
        String unEscapedHTML = StringEscapeUtils.unescapeHtml4(escapedString);
         
        System.out.println("unescapeHtml4||"+StringEscapeUtils.unescapeHtml4(escapedString)+"||");
        System.out.println("unescapeCsv||"+StringEscapeUtils.unescapeCsv(escapedString)+"||");
        System.out.println("unescapeEcmaScript||"+StringEscapeUtils.unescapeEcmaScript(escapedString)+"||");
        System.out.println("unescapeJava||"+StringEscapeUtils.unescapeJava(escapedString)+"||");
        System.out.println("Character.toString||"+Character.toString((char)26234)+"||");
        System.out.println("Character.toString||"+Character.toString((char)20154)+"||");
        System.out.println("unescapeHtml4||"+StringEscapeUtils.unescapeHtml4(unescapeHtml3(escapedString))+"||");
        System.out.println("escapedString||"+unescapeHtml3(escapedString)+"||");
    }
    ...
    public static final String unescapeHtml3(final String input) 
    {
        ...
        while (true) 
        {
            ...
            else 
            {
            	...
            	//System.out.println("ORIG="+input.substring(i, j));
            	CharSequence value = StringEscapeUtils.unescapeHtml4("&"+input.substring(i, j)+";");
            	//System.out.println("value="+value);
            	//System.out.println("AFTER="+StringEscapeUtils.unescapeHtml4(input.substring(i, j)));
                if (value == null) {
                    i++;
                    continue;
                }
