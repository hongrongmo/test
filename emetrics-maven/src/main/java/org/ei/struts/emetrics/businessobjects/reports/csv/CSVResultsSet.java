...
/**
 * <p>
 * Concrete implementation of {@link ResultSet} for an in-Jdo database backed by an XML data file.
 * </p>
 */
...
public class CSVResultsSet implements ResultsSet {
    ...
    /**
     * <p>
     * Construct a new ResultSet associated with the specified {@link Report}.
     *
     * @param report
     *            The report with which we are associated
     * @param resultsSetId
     *            The resultsSet id for this resultset
     */
    ...
    /**
     * <p>
     * Construct a new ResultSet with no value ( required for ODMG)
     */
    ...
    /**
     * Create and return a new {@link ResultsSet} associated with this Report, for the specified id name.
     *
     * @param id
     *            Id for which to create a resultsSet
     *
     * @exception IllegalArgumentException
     *                if the id is not unique for this report
     */
    ...
    /**
     * Populate {@link populate} the results associated with the specified resultsSet. Start of SQL. If none is found, return <code>null</code>.
     *
     */
    ...
    public List populate(Map pStmntValues) throws DatastoreException {
        ...
        try {
            ...
            records = csvProcessor.executeQuery(this, pStmntValues, reportProcessor);
    ...
    /**
     * Find and return the {@link ResultsSet} associated with the specified resultsSetId. If none is found, return <code>null</code>.
     *
     * @param resultsSetId
     *            ResultsSetId to look up
     */
    ...
    public void toXML(Writer out) throws IOException {
        ...
        while (rows.hasNext()) {
            ...
            while (cols.hasNext()) {
                ...
                xml.append("<" + ((String) mybean.get(measure.getColumn())).replaceAll(" ", "_") + " start=\"").append(res.getName()).append("\" end=\"")
    ...
    public void toXLS(OutputStream out) throws IOException {
    ...
    public void setUser(UserView auser) {
        this.user = auser;
    }
