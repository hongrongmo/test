...
public class EmetricsServiceImpl implements IFrameworkService {
    ...
    public static Collection<LabelValueBean> getCharlist() {
        Collection<LabelValueBean> allChars = new ArrayList<LabelValueBean>();
    ...
    public static Collection<LabelValueBean> getSalesRegions() {

        Collection<LabelValueBean> allRegions = new ArrayList<LabelValueBean>();
    ...
    public static Collection<LabelValueBean> getStatuses() {

        Collection<LabelValueBean> allStatus = new ArrayList<LabelValueBean>();
    ...
    public static Collection<LabelValueBean> getProducts() {
        Collection<LabelValueBean> allProds = new ArrayList<LabelValueBean>();
    ...
    public static Collection<LabelValueBean> getYesNoOption() {

        Collection<LabelValueBean> yesno = new ArrayList<LabelValueBean>();
...
//                    pstmt.close();
     ...
     * Supply report.
     */
    public Collection<Report> getReportsByRole(String role) throws DatastoreException {

        Collection<Report> reps = new ArrayList<Report>();
...
//			emetricsCache.put(Constants.REPORTS_KEY, "x");
    ...
    public Collection<LabelValueBean> getMonths() {

        Collection<LabelValueBean> months = null;

		months = (Collection<LabelValueBean>) emetricsCache.get(Constants.MONTHS);
