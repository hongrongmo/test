...
<%!
    ...
    public void jspInit()
    {
      try
      {
        ...
        guruInfo.put("Kanti Prasad", "Professor, electrical engineering, and director, Microelectronics/VLSI Technology, University of Massachusetts");
    ...
    private String makeRefSvcsLink(int database, String searchphrase)
    {
      ...
      buf.append("/search/results/expert.url?CID=expertSearchCitationFormat");
