...
<%@ page import="org.ei.domain.personalization.*"%><%@ page import="org.engvillage.biz.controller.ControllerClient"%><%@ page import="org.ei.parser.base.*"%><%@ page import="org.ei.email.*"%><%@ page import="javax.mail.internet.*"%><%
	...
	request.setAttribute("PATREF_URL", new StringBuffer("test"));

	StringBuffer nonpatrefurl = getnonpatrefURL(recnum,searchID,dedupFlag,dedupOption,dedupDB,origin,linkSet,dbLink,dedupSet,database, request.getParameter("docid"));
