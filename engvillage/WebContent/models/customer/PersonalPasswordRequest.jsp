...
<%
	Logger log4j = Logger.getLogger("PersonalPasswordRequest.jsp");
	...
	if( display != null)
	{
		...
		sb.append("<EMAIL-SENT>false</EMAIL-SENT>");
...
// change for adding customer id in personal profile authetication -->
				...
				log4j.info("User Profile = ID: " + nUserId + 
				...
				emailText.append("(http://www.engineeringvillage.com/), simply login using this email address and password.\n\n");
            ...
            message.setFrom(EIMessage.DEFAULT_SENDER);
				...
				sb.append("<PASSWORD-REQUEST>");
				sb.append("<EMAIL-EXISTS>true</EMAIL-EXISTS>");
				sb.append("<EMAIL-SENT>"+emailsent+"</EMAIL-SENT>");
