  ...
  if(geo != null)
  {
    ...
    for(int mindex = 0;itrmods.hasNext();mindex++)
    {
      ...
      if(modifier != null)
      {
        ...
        {
          out.write("{");
          out.write("\"search\":\"/search/results/expert.url?CID=expertSearchCitationFormat" + ((dbmask != null) ? ("&database=" + dbmask) : "") + "&RERUN="+searchId+"&geonav=" + geocount + "~" + geovalue  + "~" + geoterm + "&mapevent=search\",");
