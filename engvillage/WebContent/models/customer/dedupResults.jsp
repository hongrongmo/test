...
<%
    ...
    if(request.getParameter("linkResultCount") != null)
    {
    	linkResultCount = request.getParameter("linkResultCount");
    }
    ...
    if(null ==currentPage)
    {
        ...
        if (currentPage != null && currentPage.trim().equals("")) {
        	...
        	// convert to index
        	currentPage = Integer.toString((((Integer.parseInt(currentPage))-1) * pagesize)+1);
        }else{
        	currentPage = "1";
        }
    }
