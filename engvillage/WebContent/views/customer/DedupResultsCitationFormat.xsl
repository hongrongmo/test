...
<xsl:template match="PAGE">
    ...
    <script language="JavaScript" type="text/javascript" src="/static/js/citedby2.js"></script>
...
-->
        ...
        <tr>
            ...
            <xsl:if test="($ISDUP='true')">
              <a href="" title="View duplicate" onclick="window.open('/controller/servlet/Controller?CID=viewDups&amp;dups={$DUPS}', 'newwindow', 'width=800,height=500,toolbar=no,location=no, scrollbars,resizable');return false"><img src="/static/images/d.gif" align="absbottom" border="0"/></a><a CLASS="SmBlackText">&#160; - &#160;</a>
            </xsl:if>

	<xsl:if test="not((EI-DOCUMENT/DOC/DB/DBMASK = '131072'))">
		<a class="LgBlueLink" href="/search/doc/abstract.url?CID=dedupSearchAbstractFormat&amp;pageType=dedupSearch&amp;SEARCHID={$SEARCH-ID}&amp;DOCINDEX={$INDEX}&amp;PAGEINDEX={$CURRENT-PAGE}&amp;database={$SELECTED-DB}&amp;format={$CID-PREFIX}AbstractFormat&amp;DupFlag={$DEDUP}&amp;dbpref={$DBPREF}&amp;fieldpref={$FIELDPREF}&amp;origin={$ORIGIN}&amp;dbLink={$DBLINK}&amp;linkSet={$LINKSET}&amp;dedupSet={$DEDUPSET}">Abstract</a>
	...
	<xsl:if test="(EI-DOCUMENT/DOC/DB/DBMASK = '131072')">
		...
		<xsl:if test="not(EI-DOCUMENT/BPP = '0')">
			<a class="LgBlueLink" title="Page Details" href="/search/doc/detailed.url?CID=dedupSearchDetailedFormat&amp;pageType=dedupSearch&amp;SEARCHID={$SEARCH-ID}&amp;DOCINDEX={$INDEX}&amp;PAGEINDEX={$CURRENT-PAGE}&amp;database={$SELECTED-DB}&amp;format={$CID-PREFIX}DetailedFormat&amp;DupFlag={$DEDUP}&amp;dbpref={$DBPREF}&amp;fieldpref={$FIELDPREF}&amp;origin={$ORIGIN}&amp;dbLink={$DBLINK}&amp;linkSet={$LINKSET}&amp;dedupSet={$DEDUPSET}">Page Details</a>
			<a class="MedBlackText">&#160; - &#160;</a>
		</xsl:if>
