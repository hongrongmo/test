...
<table border="0" width="99%" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
  ...
  <tr><td valign="top" width="20"><img src="/static/images/s.gif" border="0" width="20"/></td>
    <td valign="top" colspan="2">
      <table width="400" border="0" cellspacing="0" cellpadding="0">
       ...
       <!--   <td width="134" align="right"><img src="/static/images/chs_icon.gif" width="70" height="19" border="0"/></td> -->
          <td width="257" align="left"><A href="/controller/servlet/Controller?CID=help&amp;database={$DATABASE}" onFocus="javascript:this.blur();"><img src="/static/images/english_version.gif" border="0"/></A></td>
        </tr>
      </table>
    </td>
  </tr>
  ...
  <tr><td valign="top" width="20"><img src="/static/images/s.gif" border="0" width="20"/></td>
    <td valign="top"> <A CLASS="MedBlackText"> 这里提供两种帮助方式：在线HTML和可打印的PDF（需要安装</A><A CLASS="LgBlueLink" href="#" onClick="javascript:window.open('http://www.adobe.com/');">Adobe Acrobat Reader</A><A CLASS="MedBlackText">）.</A>
      ...
      <P/> <A CLASS="MedBlackText">你可以在快速检索、高级检索页点击 </A><img src="/static/images/blue_help1.gif" border="0"/><A CLASS="MedBlackText">按钮访问相应的帮助内容。</A>
    </td><td valign="top" width="10"><img src="/static/images/s.gif" border="0" width="10"/></td>
  </tr>
</table>
