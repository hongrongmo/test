...
<xsl:template match="PAGE">
  ...
  <table border="0" width="80%" cellspacing="0" cellpadding="0">
    ...
    <tr>
      ...
      <form name="removedup" action="/search/results/dedup.url?EISESSION={$SESSION-ID}&amp;CID=dedup&amp;SEARCHID={$SEARCH-ID}&amp;COUNT={$COUNT}&amp;database={$DATABASE}" method="POST">
            ...
            <table border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td valign="top"><a class="MedBlackText"><b>Field Preferences:</b></a>&#160;
                  ...
                  <img src="/static/images/blue_help.gif" align="absmiddle" border="0"/>
                  </a>
                </td>
              </tr>
              <tr>
