  ...
  <body topmargin="0" marginheight="0" marginwidth="0">
            ...
            <table border="0" width="99%" cellspacing="0" cellpadding="0" bgcolor="#C3C8D1" height="20">
                <tr>
                  ...
                  <td valign="bottom" align="left">
                    &nbsp; <a href="#qsearchform"><img src="/static/images/rs.gif" border="0"></img></a>
                    &nbsp; <a href="/controller/servlet/Controller?CID={$SEARCH-FORM}"><img src="/static/images/ns.gif" border="0"></img></a>
                  </td>
                  <td valign="bottom" height="20" align="right">
                   <xsl:if test="($QCO > 0)">
                     <xsl:if test="($PRV > 0)">
                     <a href="/controller/servlet/Controller?CID=resultsKeyWord&amp;docIndex={$PRV}&amp;queryToString={$ENCODED-QSTR}"><img src="/static/images/pp.gif" border="0"></img></a> &nbsp;
                     </xsl:if>

                      <xsl:if test="($NXT > 0)">
                     <a href="/controller/servlet/Controller?CID=resultsKeyWord&amp;docIndex={$NXT}&amp;queryToString={$ENCODED-QSTR}"><img src="/static/images/np.gif" border="0"></img></a>&nbsp;
                     </xsl:if>
                    ...
                    &nbsp; <input type="image" name="go" src="/static/images/go1.gif" border="0"/></a>&nbsp;
                   </xsl:if>
                  </td>
                  </form>
                 </tr>
    ...
    <center>
	  ...
	  <td colspan="7" height="2">
	     <img src="/static/images/s.gif" height="2"></img>
	  </td>
	</tr>
	<tr>
	  <td colspan="7" align="right"><a class="LgBlueLink" href="javascript:window.open('/engresources/downloads.html','newwind','width=550,height=500,scrollbars=yes,resizable,taskbar=1,status=yes');void('');">Viewing Requirements</a></td>
        ...
        <tr>
          <td colspan="7" height="8">
            <img src="/static/images/s.gif" height="8"></img>
          </td>
        </tr>
        <tr>
      ...
      <table width="100%">
        <tr>
          <td colspan="5" height="20" bgcolor="#FFFFFF">
            <img src="/static/images/s.gif" border="0" height="20"></img>
          </td>
        </tr>
