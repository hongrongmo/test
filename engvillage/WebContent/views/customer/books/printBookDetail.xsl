                ...
                <TABLE cellSpacing="0" cellPadding="0" width="99%" border="0">
                    <TR>
                        ...
                        <TD valign="center" align="right">
                            <A href="javascript:window.print()">
                                <IMG src="/static/images/printer.gif" border="0"/>
                            </A>
                            <A href="javascript:window.close();">
                                <IMG src="/static/images/close.gif" border="0"/>
                            </A>
                        </TD>
                    </TR>
                    <TR>
                        <TD vAlign="top" colSpan="2" height="5">
                            <IMG height="5" src="/static/images/spacer.gif" border="0"/>
                        </TD>
                    </TR>
                    <TR>
                    ...
                    <TR>
                        <TD vAlign="top" colSpan="2" height="10">
                            <IMG height="10" src="/static/images/spacer.gif" border="0"/>
                        </TD>
                    </TR>
                </TABLE>
                <center>
