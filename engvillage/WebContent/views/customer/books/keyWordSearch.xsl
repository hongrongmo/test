    ...
    <xsl:template match="DOC">
      <html>
        <head>
          ...
          <SCRIPT TYPE="text/javascript" LANGUAGE="Javascript" SRC="/static/js/ReferexSearch.js"/>
        ...
        <table border="0" width="99%" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <table border="0" width="140" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td valign="top" colspan="3" height="20"><img src="/static/images/spacer.gif" border="0" height="20"/></td>
              </tr>
          ...
          <td valign="top" align="right" width="100%">
            ...
            <tr>
              <td valign="top" bgcolor="#C3C8D1" height="5"><img src="/static/images/spacer.gif" border="0" height="5"/></td>
            </tr>
            ...
            <center>
              <table border="0" width="97%" cellspacing="0" cellpadding="0">
                ...
                <tr>
                <td width="1" bgcolor="#148BA9"><img src="/static/images/spacer.gif" border="0" width="1"/></td>
                <td valign="top" width="100%">
                 ...
                 <table border="0" width="100%" cellspacing="0" cellpadding="0" bgcolor="#F5F5F5">
                    ...
                    <tr>
                      ...
                      <!-- Individual table for materials -->
                        <table border="0" cellspacing="0" cellpadding="0" width="100%">
                          ...
                          <tr>
                            <td height="5">
                            <img src="/static/images/spacer.gif" height="5"></img>
                            </td>
                          </tr>
                          <tr>
                      ...
                      <td valign="top">
                        ...
                        <table border="0" cellspacing="0" cellpadding="0" width="100%">
                          ...
                          <tr>
                            <td height="5">
                              <img src="/static/images/spacer.gif" height="5"/>
                            </td>
                          </tr>
                          <tr>
                            <xsl:if test="$BCD = 'DEFAULT_VIEW'">
                      ...
                      <!-- Individual table for chemical -->
                        <table border="0" cellspacing="0" cellpadding="0" width="100%" >
                          ...
                          <tr>
                            <td height="5"><img src="/static/images/spacer.gif" height="5"></img></td>
                          </tr>
                          <tr>
                            <xsl:if test="$BCD = 'DEFAULT_VIEW'">
                              <td valign="top">
                    ...
                    <tr>
                      <td colspan="2" height="10"><img src="/static/images/spacer.gif" height="10"/></td>
                    </tr>
                  </table>
                </td>
                <td width="1" bgcolor="#148BA9"><img src="/static/images/spacer.gif" border="0" width="1"/></td>
                ...
                <tr>
                  <td height="1" colspan="3" bgcolor="#148BA9"><img src="/static/images/spacer.gif" border="0" height="1"/></td>
                </tr>
                <tr>
                  <td colspan="3" height="10"><img src="/static/images/spacer.gif" border="0" height="10"/></td>
                </tr>
              </table>
            </center>
          </td>
