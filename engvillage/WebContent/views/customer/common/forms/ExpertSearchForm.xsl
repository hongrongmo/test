...
<xsl:template match="EXPERT-SEARCH">
  ...
  <!-- END OF JAVA SCRIPT -->
    ...
    <table border="0" width="99%" cellspacing="0" cellpadding="0">
      <tr>
        <td valign="top" width="140">
          <xsl:if test="$NEWS='true'">
            ...
            <tr>
              ...
              <td valign="top" bgcolor="#FFFFFF">
                ...
                <table border="0" id = "newsTable" width="100%" cellspacing="0" cellpadding="0">
                    <!--
                    <tr>
                      <td valign="top" height="5" colspan="3"><img src="/static/images/s.gif" height="5"/></td>
                    </tr>
                    -->
                    <!--
                    <tr>
                     ...
                     -->
                      ...
                      <td valign="top" width="2"><img src="/static/images/s.gif" width="2"/></td>
                    ...
                    <!--
                    <tr>
                        <td valign="top" colspan="3" height="6"><img src="/static/images/s.gif" height="6"/></td>
                    </tr>
                    -->
                    ...
                    <!--
                    <tr>
                        <td valign="top" colspan="3" height="5"><img src="/static/images/s.gif"/></td>
                    </tr>
                    -->
                </table>
                <!-- End of Tiny table for news features -->
                </td><td valign="top" bgcolor="#3173B5" width="1"><img src="/static/images/spacer.gif" border="0" width="1" /></td></tr>
            ...
            <td valign="top" bgcolor="#3173B5" width="1"><img src="/static/images/s.gif" width="1"/></td></tr>
          <tr>
            <td valign="top" colspan="3" bgcolor="#3173B5" height="1"><img src="/static/images/s.gif" height="1"/></td>
          </tr>
        </table>
      ...
      <td valign="top" width="10" bgcolor="#FFFFFF"><img src="/static/images/s.gif" width="10"/></td>
      <td valign="top" align="right" width="100%">
        <!-- START OF TABLE FOR SEARCH FORM -->
          <table border="0" align="right" width="100%" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <tr>
                <td valign="top" height="20" colspan="3"><img src="/static/images/s.gif" height="20"/></td></tr>
              <tr>
              ...
              <tr>
                <td valign="top" colspan="3" bgcolor="#C3C8D1" height="8"><img src="/static/images/s.gif" height="8"/></td></tr>
              <tr>
                <td valign="top" width="4" bgcolor="#C3C8D1"><img src="/static/images/s.gif" width="4"/></td>
              ...
              <tr>
                <td valign="top" width="4" bgcolor="#C3C8D1"><img src="/static/images/s.gif" width="4"/></td>
                <td valign="top" width="15" bgcolor="#C3C8D1"><img src="/static/images/s.gif" width="15"/></td>
              ...
              <tr>
                <td valign="top" colspan="3" bgcolor="#C3C8D1" height="8"><img src="/static/images/s.gif" height="8"/></td>
              </tr>
              <tr>
                <td valign="top" width="4" bgcolor="#C3C8D1"><img src="/static/images/s.gif" width="4"/></td>
                <td valign="top" colspan="2">
                  <table border="0" width="100%" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      <td valign="top" width="15"><img src="/static/images/s.gif" width="15"/></td>
                      <td valign="top" bgcolor="#C3C8D1">
                        <table border="0" cellspacing="0" cellpadding="0">
                          ...
                          <tr>
                            <td height="4"><img src="/static/images/spacer.gif" height="4"/></td>
                          </tr>
                          <tr>
                            <td valign="top">
                    ...
                    <tr>
                      ...
                      <td valign="top" colspan="2">
                        <A CLASS="MedBlackText" onClick="return searchValidation()"><input name="search" value="Search" type="image" src="/static/images/search_orange1.gif" border="0"/></A>&#160; &#160;
        ...
        <td valign="top" align="right" width="5" bgcolor="#C3C8D1"><img src="/static/images/s.gif" width="5"/></td>
        ...
        <td valign="top" align="right" width="120" bgcolor="#C3C8D1">
          <div id="browseindexes">
            ...
            <table border="0" width="130" align="right" cellspacing="0" cellpadding="0">
              <tr>
                <td valign="top" height="20" colspan="5"><img src="/static/images/s.gif" height="20"/></td>
              </tr>
              <tr>
                <td valign="top" bgcolor="#3173B5" height="15" colspan="5">
                  &#160; <a CLASS="LgWhiteText"><b>Browse Indexes</b></a> &#160;
                  <a href="javascript:makeUrl('Browse_Indexes.htm')"><img src="/static/images/help_white.gif" border="0"/></a>
                </td>
              </tr>
              <tr>
                <td width="1" bgcolor="#3173B5"><img src="/static/images/s.gif" width="1"/></td>
                <td width="4" bgcolor="#FFFFFF"><img src="/static/images/s.gif" width="4"/></td>
              ...
              <tr><td valign="top" colspan="5" height="1" bgcolor="#3173B5"><img src="/static/images/s.gif" height="1"/></td></tr>
            </table>
            <!-- End of Right most table for lookup -->
          </div>
        </td>
        <td valign="top" width="5" bgcolor="#C3C8D1"><img src="/static/images/s.gif" width="5"/></td>
      </tr>
       <tr><td valgn="top" colspan="4" height="15" bgcolor="#C3C8D1"><img src="/static/images/s.gif" height="15"/></td></tr>
       ...
       <tr><td valign="top" colspan="4" bgcolor="#C3C8D1">
        ...
        <tr><td valign="top" width="1" bgcolor="#000000"><img src="/static/images/s.gif" width="1"/></td>
        <td valign="top">
        <table border="0" width="100%" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
        <tr><td valign="top" bgcolor="#000000" height="1" colspan="3"><img src="/static/images/s.gif" height="1"/></td></tr>
        ...
        <tr><td valign="top" bgcolor="#000000" height="1" colspan="3"><img src="/static/images/s.gif" height="1"/></td></tr>
        <tr><td valign="top" width="4"><img src="/static/images/s.gif" width="4"/></td>
        <td valign="top" width="100%">
        <!-- Small table to put the Treatment Codes in columns -->
        <table border="0" width="99%" cellspacing="0" cellpadding="0">
          <tr>
            <td valign="top" colspan="12"><img src="/static/images/s.gif" height="2"/></td>
          </tr>
          <xsl:if test="(//LEGEND)">
              <tr>
        ...
        <td valign="top" width="4"><img src="/static/images/s.gif" width="4"/></td></tr>
        <tr><td valign="top" bgcolor="#000000" height="1" colspan="3"><img src="/static/images/s.gif" height="1"/></td></tr>
        </table>
        </td>
       ...
       <tr><td valign="top" colspan="4" height="8" bgcolor="#C3C8D1"><img src="/static/images/s.gif" height="8"/></td></tr>
      ...
      <xsl:if test="$TIPS='true'">
         ...
         <table border="0" width="100%" cellspacing="0" cellpadding="0">
           ...
           <!-- table for Help tips -->
             <table border="0" width="100%" cellspacing="0" cellpadding="0">
              <tr><td valign="top" colspan="3" height="10"><img src="/static/images/s.gif" height="10"/></td></tr>
              <tr><td valign="top" width="1" bgcolor="#3173B5"><img src="/static/images/s.gif" width="1"/></td>
                  <td valign="top">
                <table border="0" width="100%" cellspacing="0" cellpadding="0">
                   <tr><td valign="top" bgcolor="#3173B5" height="1" colspan="3"><img src="/static/images/s.gif" height="1"/></td></tr>
                   <tr><td valign="top" height="10" bgcolor="#3173B5" colspan="3"><a CLASS="LgWhiteText"><b>&#160; Search Tips</b></a></td></tr>
                   <tr><td valign="top" height="15" colspan="3"><img src="/static/images/s.gif" height="15"/></td></tr>
                   <tr><td valign="top" width="4"><img src="/static/images/s.gif" width="4"/></td>
                         <td valign="top">
                         <table border="0" width="100%" cellspacing="0" cellpadding="0">
                         <tr><td colspan="2">
                     ...
                     <tr><td width="10"></td><td><a CLASS="MedBlackText">wom?n retrieves woman or women<br/><br/></a></td></tr>
                         ...
                         <tr><td colspan="3" height="8"><img src="/static/images/s.gif" height="8"/></td></tr>
                   <tr><td valign="top" bgcolor="#3173B5" height="1" colspan="3"><img src="/static/images/s.gif" height="1"/></td></tr>
                 </table></td>
                   <td valign="top" width="1" bgcolor="#3173B5"><img src="/static/images/s.gif" width="1"/></td></tr>
              <tr><td valign="top" height="8" colspan="3"><img src="/static/images/s.gif" height="8"/></td></tr>
             </table>
            </td></tr>
            </table>
            </center>
