                ...
                <xsl:value-of select="//NEWS-TEXT" disable-output-escaping="yes"/>
                   ...
                   <!--
                    ...
                    <tr>
                     ...
                     </td><td valign="top" bgcolor="#3173B5" width="1"><img src="/static/images/s.gif" border="0" width="1"/></td></tr>
                <tr><td valign="top" colspan="3" bgcolor="#3173B5" height="1"><img src="/static/images/s.gif" border="0" height="1"/></td></tr>
                <tr><td valign="top" colspan="3" height="20"><img src="/static/images/s.gif" border="0" height="20"/></td></tr>
            ...
            <table border="0" width="100%" cellspacing="0" cellpadding="0">
              <tr>
                <td valign="top" bgcolor="#C3C8D1">
                  ...
                  <FORM name="quicksearch" action="/search/results/quick.url?CID=quickSearchCitationFormat" METHOD="POST"  onSubmit="return searchValidation()" >

                    <!-- Start of table for search form -->
                    <table border="0" cellspacing="0" cellpadding="0" width="500" bgcolor="#C3C8D1">
                      <tr>
                        <td valign="top" width="500" colspan="5" ><img src="/static/images/s.gif" height="20"/></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td valign="top" width="500" colspan="5" ><img src="/static/images/s.gif" height="8"/></td>
                      </tr>
                      <tr>
			    ...
			    <img src="/static/images/blue_help1.gif" border="0"/>
                      ...
                      <tr>
                        <td valign="top" colspan="5" ><img src="/static/images/s.gif" height="4"/></td>
                      </tr>
                      <tr>
                        <td valign="top" width="4" ><img src="/static/images/s.gif" width="4"/></td>
                        <td valign="top" width="15" ><img src="/static/images/s.gif" width="15"/></td>
...
-->
                    ...
                    <table border="0" cellspacing="0" cellpadding="0" width="470" bgcolor="#C3C8D1">
                      <tr>
                        <td valign="top" width="470" colspan="5" ><img src="/static/images/s.gif" height="4"/></td>
                      </tr>
                      <tr>
                        <td valign="top" height="2"><img src="/static/images/s.gif" height="2"/></td>
                        <td valign="top" colspan="4" height="2" bgcolor="#3173B5" width="100%"><img src="/static/images/s.gif" height="2"/></td>
                      </tr>
                      <tr>
                        <td valign="top" width="470" colspan="5" ><img src="/static/images/s.gif" height="4"/></td>
                      </tr>
				    ...
				    <img src="/static/images/blue_help1.gif" border="0"/>
                              ...
                              <xsl:if test="(boolean(bit:hasBitSet($USERMASK,1)) or boolean(bit:hasBitSet($USERMASK,2)))">
                                <tr>
                                  <td valign="top" ><img src="/static/images/s.gif" height="4"/></td>
                                </tr>
                                <tr>
                                  <td>
                                    <a CLASS="MedBlackText">
				...
				<img src="/static/images/blue_help1.gif" border="0"/>
				  ...
				  <img src="/static/images/blue_help1.gif" border="0"/>
                        ...
                        <td valign="top" width="233" >
                          ...
                          <input type="image" src="/static/images/search_orange1.gif" name="search" value="Search" border="0"/>
                          </a>&#160; &#160;
                      ...
                      <tr>
                        <td valign="top" width="100%">
                          ...
                          <table border="0" width="100%" cellspacing="0" cellpadding="0">
                            ...
                            <tr><td valign="top" width="1" bgcolor="#3173B5"><img src="/static/images/s.gif" width="1"/></td>
                              <td valign="top">
                                <table border="0" width="100%" cellspacing="0" cellpadding="0">
                                  ...
                                  <tr><td valign="top" width="4"><img src="/static/images/s.gif" width="4"/></td><td valign="top">
                                  <table border="0" width="100%" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                              <td valign="top" height="8" colspan="3"><img src="/static/images/s.gif" height="8"/></td>
                            </tr>
                          </table>
...
<SCRIPT LANGUAGE="Javascript" SRC="/static/js/QuickSearchForm.js?v=19"/>
