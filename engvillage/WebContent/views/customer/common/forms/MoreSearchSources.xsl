...
<xsl:template name="REMOTE-DBS">
    ...
    <table border="0" cellspacing="0" cellpadding="0">
        <xsl:for-each select="//DATABASES/DATABASE">
            <xsl:choose>
                ...
                <xsl:when test="($LOCATION = 'Referex' or $LOCATION='USPTO' or $LOCATION='CRC ENGnetBASE')">
                    <tr><td valign="top" height="4" colspan="3"><img src="/static/images/s.gif" border="0" height="4" /></td></tr>
                    <tr>
        ...
        <tr><td valign="top" width="2"><img src="/static/images/s.gif" border="0" width="2"/></td></tr>
