...
>
    ...
    <xsl:template match="EBOOK-SEARCH">
        ...
        <SCRIPT LANGUAGE="JavaScript" SRC="/static/js/ReferexSearch_V8.js"/>
        ...
        <table border="0" width="99%" cellspacing="0" cellpadding="0">
            <tr>
                <td valign="top" width="140">
                    ...
                    <xsl:if test="$NEWS='true'">
                        ...
                        <table border="0" width="140" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                <td valign="top" bgcolor="#3173B5" width="1"><img src="/static/images/s.gif" border="0" width="1"/></td>
                                <td valign="top" bgcolor="#FFFFFF">
                                    <!-- Tiny table for news features -->
                                    <table border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td valign="top" height="5" colspan="3"><img src="/static/images/s.gif" border="0" height="5"/></td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td valign="top" width="2"><img src="/static/images/s.gif" border="0" width="2"/></td>
                                        </tr>
                                    </table>
                            ...
                            <tr>
                                <td valign="top" colspan="3" bgcolor="#3173B5" height="1"><img src="/static/images/s.gif" border="0" height="1"/></td>
                            </tr>
                            <tr>
                                <td valign="top" colspan="3" height="20"><img src="/static/images/s.gif" border="0" height="20"/></td>
                            </tr>
                                    ...
                                    <table border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr>
                                            <td valign="top" width="3">
                                                <img src="/static/images/s.gif" border="0" width="3"/>
                                            </td>
                                            <td valign="top">
                ...
                <td valign="top" bgcolor="#FFFFFF"><img src="/static/images/s.gif" border="0" width="10"/></td>
                    ...
                    <table border="0" width="100%" cellspacing="0" cellpadding="0">
                        <tr>
                            <td align="left" valign="top" bgcolor="#C3C8D1">
                                ...
                                <FORM name="quicksearch" action="/search/results/quick.url" METHOD="POST" onSubmit="return searchValidation();" >
                                    ...
                                    <table border="0" cellspacing="0" cellpadding="0" width="500" bgcolor="#C3C8D1">
                                        <tr>
                                            <td valign="top" width="100%" colspan="5" ><img src="/static/images/s.gif" height="20"/></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td valign="top" width="100%" colspan="5" ><img src="/static/images/s.gif" height="8"/></td>
                                        </tr>
                                        <tr>
                                    ...
                                    <table border="0" cellspacing="0" cellpadding="0" width="470" bgcolor="#C3C8D1">
                                        ...
                                        <tr>
                                            ...
                                            <td valign="top" width="233" >
                                                <br/>
                                                <input type="image" src="/static/images/search_orange1.gif" name="search" value="Search" alt="Search" border="0"/>
                                                &#160; &#160;
                                                <a href="/controller/servlet/Controller?CID=ebookSearch&amp;database={$SELECTED-DB}">
                                                    <img src="/static/images/reset_orange1.gif" alt="Reset" border="0"/>
                                                </a>
                                            </td>
                                        </tr>
                                        <tr>
                        ...
                        <tr>
                            <td valign="top" bgcolor="#C3C8D1"><img src="/static/images/s.gif" border="0" height="5"/></td>
                        </tr>
                        <tr>
                            <td align="center" valign="top" bgcolor="#C3C8D1">
                                <table border="0" width="97%" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                        <td bgcolor="#148BA9"><img src="/static/images/s.gif" border="0" width="1"/></td>
                                        <td valign="top" width="100%">
                                            <table border="0" width="100%" cellspacing="0" cellpadding="0" bgcolor="#F5F5F5">
                                                            ...
                                                            <xsl:if test="$curPos &lt; 4">
                                                                ...
                                                                <td valign="top">
                                                                    <table border="0" cellspacing="0" cellpadding="0" width="100%">
                                                                        <tr>
                                                                            <td height="5">
                                                                                <img src="/static/images/s.gif" height="5"></img>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td valign="top">
                                                ...
                                                <tr>
                                                    <td colspan="2" height="10"><img src="/static/images/s.gif" height="10"/></td>
                                                </tr>
                                        ...
                                        <td width="1" bgcolor="#148BA9"><img src="/static/images/s.gif" border="0" width="1"/></td>
                                    </tr>
                                    <tr>
                                        <td height="1" colspan="3" bgcolor="#148BA9"><img src="/static/images/s.gif" border="0" height="1"/></td>
                                    </tr>
                                    <tr>
                                        <td colspan="3"><img src="/static/images/s.gif" border="0" height="10"/></td>
                                    </tr>
                                </table>
