    ...
    <xsl:choose>
      ...
      <xsl:when test="($SEARCH-TYPE='Quick')">
        <table border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td valign="top" bgcolor="#FFFFFF" width="1"><img src="/static/images/s.gif" width="100"/></td>
            <td valign="top">
            ...
            <td valign="top" bgcolor="#FFFFFF" width="1"><img src="/static/images/s.gif" width="180"/></td>
          </tr>
        </table>
      </xsl:when>
      ...
      <xsl:when test="($SEARCH-TYPE='TagSearch')">
        <table border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td valign="top">
              <form name="searchtagsform" action="/search/results/tags.url?EISESSION=$SESSIONID&amp;CID=tagSearch&amp;searchtype=TagSearch&amp;database={$DATABASE}" METHOD="POST" >
                <table>
                  <tr>
                    <td valign="top"><a class="MedBlackText">
                      <input type="text" size="20" name="searchtags"/></a>
                      <img src="/static/images/s.gif" height="20"/>
                      <a><input type="image" src="/static/images/search_orange1.gif" name="edit" value="Edit" border="0"/></a>
                    </td>
                  </tr>
                </table>
              </form>
