...
<center>
  ...
  <table border="0" width="99%" cellspacing="0" cellpadding="0" bgcolor="#C3C8D1">
    <tr ><td height="24" bgcolor="#C3C8D1" ><img src="/static/images/s.gif" /></td></tr>
  </table>
                  ...
                  <table border="0" cellspacing="0" cellpadding="0" width="100%" >
                      ...
                      <!-- iterate through the loop to display folder names -->
                          ...
                          <xsl:if test="function-available('java:encode')">
                            <xsl:value-of select="java:encode(FOLDER-NAME)"/>
                    			...
                    			<tr>
                    				...
                    				<td valign="top" width="15"><img src="/static/images/folderclosed.gif" border="0"/></td>
                    				<td valign="top" width="3" ><img src="/static/images/spacer.gif" border="0" width="3"/></td>
                    				<td valign="top" >
                    				...
                    				<td valign="top" width="15" ><img src="/static/images/spacer.gif" border="0" width="15"/></td>
                    				<td valign="top" >
                    	...
                    	<FORM name="folder" action="/controller/servlet/Controller?CID=addPersonalFolder&amp;database={$DATABASE}" METHOD="POST" onSubmit="return validate(folder)">
                    		<tr><td valign="top"  height="14" colspan="10"><img src="/static/images/spacer.gif" height="10"/></td></tr>
                    		<tr>
                            ...
                            &#160;<input type="image" src="/static/images/sav.gif" name="submit" value="Submit" alt="Save" /> &#160; &#160;
                            &#160;<input type="image" src="/static/images/cancel.gif" name="cancel" value="Cancel" alt="return to My Profile"  onclick="javascript:document.location='/controller/servlet/Controller?EISESSION={$SESSION-ID}&amp;CID=myprofile&amp;database={$DATABASE}';return false;"/> &#160; &#160;
  				                  <input type="image" src="/static/images/res.gif" name="reset" value="Reset" alt="Reset" onclick="javascript:reset();return false;"/> &#160; &#160;
                    			</td>
                    		</tr>
                    	</FORM>
                    	</xsl:if>
