		...
		<![CDATA[
			...
			<SCRIPT type="TEXT/JAVASCRIPT" language="javascript">
				...
				function validateLogin(personallogin)
				{
					...
					{
						 window.alert ("You must enter an email address(username)");
		...
		<tr>
		  ...
		  <td valign="top" width="60%">
			<table border="0" cellspacing="0" cellpadding="0">
				<tr><td colspan="3" height="10"><img src="/static/images/s.gif" height="10"/></td></tr>
				<xsl:choose>
				...
				<xsl:otherwise>
				<tr><td valign="top" colspan="3">
					<a class="MedBlackText">You must login to your personal account to save searches, save records, and create Email Alerts.  </a>
				</td></tr>
				</xsl:otherwise>
				</xsl:choose>
				<tr><td colspan="3" height="15"><img src="/static/images/s.gif" height="15"/></td></tr>
				<tr><td valign="middle" align="right"><a CLASS="MedBlackText"><label for="txtUsr">Email address:</label> </a></td><td width="5"><img src="/static/images/s.gif" width="5"/></td><td valign="top"><input id="txtUsr" type="text" name="email" size="20"/></td></tr>
				<tr><td colspan="3" height="5"><img src="/static/images/s.gif" height="5"/></td></tr>
				<tr><td valign="middle" align="right"><a CLASS="MedBlackText"><label for="txtPwd">Password:</label> </a></td><td width="5"><img src="/static/images/s.gif" width="5"/></td><td valign="top"><input id="txtPwd" type="password" name="password" size="20"/></td></tr>
				<tr><td colspan="3" height="5"><img src="/static/images/s.gif" height="5"/></td></tr>
				<tr><td colspan="2"></td><td valign="top"><input type="image" src="/static/images/login.gif" alt="Login" border="0"/></td></tr>
				<tr><td colspan="3" height="20"><img src="/static/images/s.gif" height="20"/></td></tr>
		  ...
		  <td width="100"><img src="/static/images/s.gif" width="100"/></td>
