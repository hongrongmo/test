                        ...
                        <table border="0" cellspacing="0" cellpadding="0" width="100%">
                          ...
                          <tr>
                            ...
                            <td align="right" valign="middle" bgcolor="#3173B5">
                              <a title="Most Recent Bulletins" href="/controller/servlet/Controller?CID=bulletinSearch&amp;queryStr={$ENCODED-QSTR}&amp;EISESSION={$SESSION-ID}&amp;database={$SELECTED-DB}"><img src="/static/images/rec.gif" border="0"/></a>&#160;
                            </td>
                            <td width="20" align="right" >
                              <img src="/static/images/s.gif" width="20" />
                            </td>
                            ...
                            <td valign="top" align="left" colspan="2">
                              <table border="0" cellspacing="0" cellpadding="0" width="100%">
                                ...
                                <tr>
                                  ...
                                  <img src="/static/images/s.gif" height="8"/>
                                  </td>
                                </tr>
                                <tr>
                                  <td>
