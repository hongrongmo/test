<xsl:stylesheet
  ...
  <xsl:variable name="HAS-ELT">
         <xsl:value-of select="//DOC/HAS-ELT"/>
  </xsl:variable>
...
<xsl:template match="DOC">
  ...
  <head>
    ...
    <SCRIPT TYPE="text/javascript" LANGUAGE="Javascript" SRC="/static/js/Robohelp.js"/>
      ...
      <script type="text/javascript" language="javascript">
	    ...
	    var radioLength = document.search.database.length;

	    var check = false;	
	    
	    if(radioLength==undefined)
	    {
	    	check=document.search.database.checked;
	    }
	    for(var i = 0; i &lt; radioLength; i++) 
	    {
		if(document.search.database[i].checked) 
		{
			check=true;
		}
	    }	
      ...
      <td valign="top" bgcolor="#C3C8D1">
        <table border="0" cellspacing="0" cellpadding="0" width="625" bgcolor="#C3C8D1">
          <form name="search" method="post" action="/controller/servlet/Controller" onsubmit="return validate()">
            ...
            <tr><td valign="top" height="15" colspan="6"><img src="/static/images/s.gif" border="0" height="15"/></td></tr>
            <tr><td valign="top" width="4"><img src="/static/images/s.gif" border="0" width="4"/></td><td valign="top" colspan="2"><a CLASS="SmBlueTableText"><b>SELECT DATABASE</b></a></td><td valign="top" colspan="3" align="left"><a CLASS="SmBlueTableText"><b><label for="txtTrm">ENTER TERM</label></b></a></td></tr>
            <tr><td valign="top" width="4"><img src="/static/images/s.gif" border="0" width="4"/></td><td valign="top" width="15"><img src="/static/images/s.gif" border="0" width="15"/></td>
            ...
            <xsl:choose>
                <xsl:when test="($HAS-CPX='true')">
                    <xsl:choose>
                        ...
                        <xsl:when test="($DATABASE='2048') and ($HAS-EPT='true')">
			    <a CLASS="MedBlackText">
				<input id="rdEpt" type="radio" name="database" value="2048"/>
			    </a>
                        </xsl:when>  
                         <xsl:when test="($DATABASE='1024') and ($HAS-ELT='true')">
			    <a CLASS="MedBlackText">
            ...
            <xsl:choose>
                ...
                <td valign="top" width="15"><img src="/static/images/s.gif" border="0" width="15"/></td><td valign="top"><input id="txtTrm" type="text" name="term" size="29" value="{$TERM}"/></td></tr>            
            <tr><td valign="top" colspan="6" bgcolor="#C3C8D1" height="4"><img src="/static/images/s.gif" border="0" height="4"/></td></tr>
            <tr>
            ...
            <tr>
                <td valign="top" width="4" colspan="3"><img src="/static/images/s.gif" border="0" width="4"/></td>
		...
		<img src="/static/images/blue_help1.gif" border="0"/>
               ...
               </td><td valign="top" align="left"><input type="image" src="/static/images/submit1.gif" border="0"/></td>
            </tr>
