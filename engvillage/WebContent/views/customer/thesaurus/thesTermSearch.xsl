        ...
        <xsl:when test="($TERM != '')">
            ...
            <table border="0" width="90%" cellspacing="0" cellpadding="0" bgcolor="#CEEBFF">
                ...
                <tr><td valign="top" width="1" bgcolor="#000000"><img src="/static/images/spacer.gif" border="0" width="1"/></td>
                    ...
                    <td valign="top" width="1" bgcolor="#000000"><img src="/static/images/spacer.gif" border="0" width="1"/></td></tr>
                <tr><td valign="top" height="1" bgcolor="#000000" colspan="3"><img src="/static/images/spacer.gif" border="0" height="1"/></td></tr>
            </table>
            </center>
            </td></tr>
            <tr><td valign="top" bgcolor="#C3C8D1" height="5"><img src="/static/images/spacer.gif" border="0" height="5"/></td></tr>
...
<xsl:template match="TREC" mode="SUGGEST">
    ...
    <tr>
        <td valign="top" width="25" height="1"><img src="/static/images/spacer.gif" border="0" width="25" height="1"/></td>
        <td valign="top">
            <xsl:choose>
...
<xsl:template match="SEARCH/PAGE">
    ...
    <tr><td valign="top" height="2" colspan="4"><img src="/static/images/spacer.gif" border="0" height="2"/></td></tr>
    <tr>
        <td valign="top" width="55" height="1"><img src="/static/images/spacer.gif" border="0" width="55" height="1"/></td><td valign="top" width="400"><a CLASS="SmBlackText"><u><b>Terms</b></u></a></td><td valign="top" width="8" align="left"><img src="/static/images/spacer.gif" border="0" width="8"/></td><td valign="top" align="left"><a CLASS="SmBlackText"><u><b>Select</b></u></a></td><td valign="top" width="8" align="left"><img src="/static/images/spacer.gif" border="0" width="8"/></td>
        <!-- Explode Commented as of now -->
        <td valign="top" align="left"><a CLASS="SmBlackText"><img src="/static/images/spacer.gif" border="0" height="1" width="50"/></a></td>
...
<xsl:template match="SUGGEST/PAGE">
    ...
    <tr><td valign="top" width="25" height="1"><img src="/static/images/spacer.gif" border="0" width="25" height="1"/></td><td valign="top">&#160;&#160;&#160;&#160;&#160;&#160;<input type="image" src="/static/images/newsearch1.gif" border="0"/></td></tr>
    <tr><td valign="top" colspan="4" height="4"><img src="/static/images/spacer.gif" border="0" height="4"/></td></tr>
</xsl:template>
...
<xsl:template match="CU" mode="HIT">
    ...
    <tr>
    <td valign="top" width="55" height="1"><img src="/static/images/spacer.gif" border="0" width="55" height="1"/></td><td valign="top"><a CLASS="RollLink" href="/controller/servlet/Controller?CID=thesFullRec&amp;term={$MT}&amp;database={$DATABASE}">
    <xsl:value-of select="." disable-output-escaping="yes"/></a></td>
    <td valign="top" width="8" align="left">
    <img src="/static/images/spacer.gif" border="0" width="8"/></td>
    <td valign="top" align="left">
    <input type="checkbox" name="selectUnselect" onclick="parent.clipFrame.addRemoveFromClipBoard('{$MTP}')" value="{$MTP}"/>
    </td><td valign="top" width="8"><img src="/static/images/spacer.gif" border="0" width="8"/></td>
    <td valign="top"></td>
...
<xsl:template match="LE" mode="HIT">
    ...
    <tr><td valign="top" width="55" height="1"><img src="/static/images/spacer.gif" border="0" width="55" height="1"/></td><td valign="top"><a CLASS="RollLink" href="/controller/servlet/Controller?CID=thesFullRec&amp;term={$MT}&amp;database={$DATABASE}"><i>
    <xsl:value-of select="." disable-output-escaping="yes"/></i></a></td><td valign="top" width="8" align="left"><img src="/static/images/spacer.gif" border="0" width="8"/></td>
    <td valign="top" align="left">
    </td>
...
<xsl:template match="PR" mode="HIT">
    ...
    <tr>
    <td valign="top" width="55" height="1"><img src="/static/images/spacer.gif" border="0" width="55" height="1"/></td><td valign="top"><a CLASS="RollLink" href="/controller/servlet/Controller?CID=thesFullRec&amp;term={$MT}&amp;database={$DATABASE}"><i>
    <xsl:value-of select="." disable-output-escaping="yes"/></i>
    <xsl:if test="(//DOC/DATA/HIT/TREC/STATUS!='N')">*</xsl:if>
    </a></td><td valign="top" width="8" align="left"><img src="/static/images/spacer.gif" border="0" width="8"/></td><td valign="top" align="left"><xsl:if test="(//DOC/DATA/HIT/TREC/STATUS!='N')"><input type="checkbox" name="selectUnselect" onclick="parent.clipFrame.addRemoveFromClipBoard('{$MTP}')" value="{$MTP}"/></xsl:if></td><td valign="top" width="8"><img src="/static/images/spacer.gif" border="0" width="8"/></td>
