  ...
  <xsl:variable name="COMPMASK">
    ...
    <br/>
        ...
        <xsl:if test="DEDUPABLE='true'">
          <a class="DecLink" href="/controller/servlet/Controller?CID=dedupForm&amp;database={$DATABASE}&amp;SEARCHID={$QUERY-ID}&amp;COUNT=1&amp;SEARCHTYPE={$SEARCH-TYPE}&amp;RESULTSCOUNT={$RESULTS-COUNT}">Remove Duplicates</a>
        ...
        <xsl:if test="($RSS-LINK='true') and not(($SEARCH-TYPE='Book') or $COMPMASK='131072')">
          <a class="MedBlackText">&#160; - &#160;</a>
          <a href="#" onClick="window.open('/controller/servlet/Controller?CID=displayRSSQuery&amp;database={$DATABASE}&amp;term1={java:encode($I-QUERY)}','newwindow','width=700,height=500,toolbar=no,location=no,scrollbars,resizable');return false;"><img style="vertical-align: middle; border:0px;" src="/static/images/rss.gif" /></a>
          <xsl:text>  </xsl:text><a href="javascript:makeUrl('RSS_Feature.htm')"><img style="vertical-align:middle; border:0px;" src="/static/images/blue_help.gif" /></a>
          <xsl:text>  </xsl:text><a href="#" id="mapToggleAnchor"><img id="mapToggleImg" style="vertical-align:middle; border:0px;" src="/static/images/s.gif" /></a>
        </xsl:if>

  <div id="map" style="clear:both;display:none; width:620px;">
    <br/>
    <img style="width: 20px; height: 1px" src="/static/images/s.gif" /><img style="width: 16px; height: 16px" src="/static/images/red-pin.png" /><a class="SpLink" >Click on a pin to refine search results</a>
...
<xsl:template name="RESULTS-MANAGER">
  ...
  <SCRIPT LANGUAGE="Javascript" SRC="/static/js/CitationResults_V7.js"/>
  <SCRIPT LANGUAGE="Javascript" SRC="/static/js/Robohelp.js"/>

    <!-- Results manager -->
    <table border="0" width="99%" cellspacing="0" cellpadding="0">
        <tr><td valign="top" height="4" colspan="3"><img src="/static/images/s.gif" height="4" /></td></tr>
        <tr><td valign="top">

        <table border="0" width="100%" cellspacing="0" cellpadding="0" align="center">
            <tr><td valign="top" bgcolor="#3173B5" height="1" colspan="3"><img src="/static/images/s.gif" height="1" /></td></tr>
            <tr><td valign="top" width="1" bgcolor="#3173B5"><img src="/static/images/s.gif" width="1" /></td><td valign="top">
	...
	<xsl:variable name="NEWSEARCH-NAV">
		<xsl:value-of select="/PAGE/PAGE-NAV/NEWSEARCH-NAV"/>
            ...
            <xsl:if test="($CURRENT-VIEW='searchresults')">
                    <tr><td colspan="4" height="4"><img src="/static/images/s.gif" height="4" /></td></tr>
                    <tr>
                      <FORM name="{$LOCATION}selectrangeform">
                       ...
                       <!-- &amp;database={$DEFAULT-DB-MASK}&amp;searchtype=tagSearch -->
                        ...
                        <td valign="top" colspan="3">
                            ...
                            <img align="top" src="/static/images/go.gif" border="0" /></a>
                            <A CLASS="MedBlackText">&#160; - &#160;</A>
                ...
                <FORM name="{$LOCATION}resultsmanagerform">
                    <tr><td valign="top" width="5" height="20"><img src="/static/images/s.gif" width="5" /></td><td width="19" height="16">
                    ...
                    <td valign="top" width="5" height="20"><img src="/static/images/s.gif" width="5" /></td>
                    </tr>
                </FORM>

                    <tr><td valign="top" colspan="4" height="4"><img src="/static/images/s.gif" height="4" /></td></tr>
                    <tr><td valign="top" width="5" height="20"><img src="/static/images/s.gif" width="5" /></td><td valign="top">&#160; </td><td valign="top" height="20" colspan="2">&#160; &#160; &#160; &#160; &#160; &#160; &#160; &#160; &#160; &#160; &#160; &#160;
            ...
            <xsl:if test="($CURRENT-VIEW='searchresults')">
              ...
              <A href="javascript:viewFormat('$SESSIONID','{$DATABASE}',document.{$LOCATION}resultsmanagerform, '{$RESULTS-NAV}', '{$NEWSEARCH-NAV}')">
                    <img src="/static/images/vs.gif" border="0" /></A>&#160; &#160;
            ...
            <xsl:if test="($CURRENT-VIEW='selectedset')">
              ...
              <img src="/static/images/removeall.gif" border="0"/></A>
            ...
            <xsl:if test="($CURRENT-VIEW='savedrecords')">
                ...
                <xsl:variable name="SESSION-DATABASE-ID">
                  <xsl:value-of select="//DBMASK"/>
                                ...
                                <img src="/static/images/updatefolder.gif" border="0"/></A>&#160; &#160;
            ...
            </td><td valign="top" width="1" bgcolor="#3173b5"><img src="/static/images/s.gif" width="1" /></td></tr>
            <tr><td valign="top" bgcolor="#3173b5" height="1" colspan="3"><img src="/static/images/s.gif" height="1" /></td></tr>
        </table>
