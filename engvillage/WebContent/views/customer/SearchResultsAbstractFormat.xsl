...
<!--  <xsl:output method="html" indent="no" /> -->
  ...
  <xsl:template match="PAGE">
    ...
    <html>
      <head>
        ...
        <SCRIPT LANGUAGE="Javascript" SRC="/static/js/citedby_V1.js"/>
            ...
            <tr>
              <td valign="top">
                ...
                <xsl:apply-templates select="ABSTRACT-DETAILED-RESULTS-MANAGER">
                  <xsl:with-param name="FORMAT">ABSTRACT</xsl:with-param>
                </xsl:apply-templates>
  ...
  <xsl:template match="PAGE-ENTRY">
    ...
    <tr>
      <td valign="top" align="right">
        <xsl:variable name="IS-SELECTED">
          <xsl:value-of select="//PAGE-RESULTS/PAGE-ENTRY/IS-SELECTED" disable-output-escaping="yes" />
        </xsl:variable>
      ...
      <td valign="top" width="3">
        <img src="/static/images/s.gif" border="0" width="3" name="image_basket" />
      </td>
      <td valign="top">
    ...
    <xsl:if test="(string(//LOCALHOLDINGS) or ($CHECK-CUSTOM-OPT ='true') or string(//LHL))">
      <tr>
        <td colspan="4"><img src="/static/images/s.gif" border="0" height="15"/></td>
    ...
    <xsl:choose>
      <xsl:when test="($CHECK-CUSTOM-OPT ='true')">
        <tr>
          <td colspan="4">
            <img src="/static/images/s.gif" border="0" height="30" />
          </td>
          <td align="left" colspan="3">
            <a title="Full-text" onclick="window.open('/controller/servlet/Controller?CID=FullTextLink&amp;docID={$DOC-ID}','newwindow','width=500,height=500,toolbar=no,location=no,scrollbars,resizable');return false">
              <img id="ftimg" src="/static/images/av.gif" alt="Full-text" />
            </a>
          </td>
        </tr>
      </xsl:when>
