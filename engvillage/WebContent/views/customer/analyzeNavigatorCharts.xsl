      ...
      <center>
        <table border="0" width="99%" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td valign="middle" align="right"><a href="javascript:window.close();"><img src="/static/images/close.gif" border="0"/></a></td>
          </tr>
          <tr>
            <td valign="top" height="2" bgcolor="#3173B5" colspan="3"><img src="/static/images/s.gif" border="0"/></td>
          </tr>
        </table>
      </center>
