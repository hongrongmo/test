...
<xsl:param name="LOCATION"/>
    <table border="0" width="99%" cellspacing="0" cellpadding="0" >
      <tr>  
      	<td colspan="2"> 
      		<img width="8" height="7" src="/static/images/s.gif" border="0" />   
      	</td> 
      </tr>
      <tr> 
      <td width="50%"> 
      	<img width="18" height="1" src="/static/images/s.gif" border="0" />
	  <xsl:choose>
	 ...
	 <img width="7" height="1" src="/static/images/s.gif" border="0" />
	 <xsl:choose>
