...
>
    ...
    <xsl:include href="common/PageResults.xsl" />
    ...
    <xsl:template match="FOOTER">
        <xsl:text disable-output-escaping="yes">
            <![CDATA[</table></center><br/><center><TABLE cellSpacing="0" cellPadding="0" border="0" width="99%"><TR><TD><CENTER><A class="SmBlackText">&#169; ]]>
	    </xsl:text>
	    	<!-- INCLUDE YEAR  -->
