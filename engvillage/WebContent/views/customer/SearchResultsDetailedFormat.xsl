...
<xsl:template match="PAGE">
    ...
    <head>
        ...
        <SCRIPT LANGUAGE="Javascript" SRC="/static/js/Autocomplete.js"/>
        <script language="JavaScript" type="text/javascript" src="/static/js/citedby_V1.js"></script>
    ...
    <xsl:template match="PAGE-ENTRY">
      ...
      <tr>
        <td colspan="7"><img src="/static/images/s.gif" border="0" height="10"/></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td valign="top"><img src="/static/images/s.gif" border="0" width="3" name="image_basket"/></td>
        <td valign="top"><a CLASS="MedBlackText"><xsl:value-of select="$INDEX" />.</a></td>
        <td valign="top"><img src="/static/images/s.gif" border="0" width="4"/></td>
...
<!-- end -->
      <xsl:if test="(string(//LOCALHOLDINGS) or string(//FULLTEXT) or string(//LHL))">
        <tr>
            <td colspan="4" ><img src="/static/images/s.gif" height="15" border="0"/></td>
            <td bgcolor="#C3C8D1" colspan="3">
              <a CLASS="MedBlackText"><b>&#160; Full-text and Local Holdings Links</b></a>
            </td>
        </tr>
        <tr>
          <td colspan="7" ><img src="/static/images/s.gif" border="0"/></td>
        </tr>
      </xsl:if>
        ...
        <xsl:if test="($LOCALHOLDINGS='true')">
          <tr>
            <td colspan="4"><img src="/static/images/s.gif" border="0" width="3"/></td>
        ...
        <xsl:choose>
          ...
          <tr>
            <td colspan="4" ><img src="/static/images/s.gif" border="0" height="30"/></td>
            <td align="left" colspan="3">
              <a title="Full-text" onclick="window.open('/controller/servlet/Controller?CID=FullTextLink&amp;docID={$DOC-ID}','newwindow','width=500,height=500,toolbar=no,location=no,scrollbars,resizable');return false"><img id="ftimg" src="/static/images/av.gif" alt="Full-text" /></a>
            </td>
          </tr>
          </xsl:when>
          <xsl:otherwise>
            <tr>
              <td colspan="7"><img src="/static/images/s.gif" border="0" height="30"/></td>
            </tr>
          </xsl:otherwise>
        </xsl:choose>
