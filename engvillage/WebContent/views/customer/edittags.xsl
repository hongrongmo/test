         ...
         <table border="0" cellspacing="0" cellpadding="0">
			...
			<td valign="top" colspan="1"><a class="MedBlackText"> 
				...
				<xsl:text> </xsl:text><input type="text" size="80" name="publictags" value = "{$PUBLIC-TAGS}" /></a>
                 ...
                 <tr>
	          <td height="12" bgcolor="#FFFFFF" colspan="2"><img src="/static/images/s.gif" height="12"/></td>
                </tr>     
             </xsl:if>
		...
		<xsl:for-each select="GROUP-TAGS/GROUP-TAG">
		  ...
		  <td height="12" bgcolor="#FFFFFF" colspan="2"><img src="/static/images/s.gif" height="12"/></td>
              ...
              <tr>
	           ...
	           <xsl:text>  </xsl:text><a><input type="image" src="/static/images/savechanges_button.gif" name="edit" value="Edit" border="0"/></a>
                 </td>
              </tr>
              </table>
