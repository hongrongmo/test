<xsl:stylesheet
  ...
  xmlns:book="java:org.ei.books.BookDocument"
	...
	exclude-result-prefixes="java html xsl DD custoptions book"
>
...
-->
		...
		<tr>
			<td valign="top" colspan="5" height="25"><img src="/static/images/spacer.gif" border="0" height="8"/></td>
		</tr>
		<tr>
			<td valign="top" align="left">
				<A href="/controller/servlet/Controller?CID=deleteFromSelectedSet&amp;viewType=citationSelectedSet&amp;docid={$DOC-ID}&amp;basketsize={$RESULTS-COUNT}&amp;handle={$INDEX}&amp;DATABASETYPE={$RESULTS-DATABASE}&amp;searchresults={$ENCODED-RESULTS-NAV}&amp;newsearch={$ENCODED-NEWSEARCH-NAV}"><img src="/static/images/remove.gif" border="0"/></A>
			</td>
	...
	<xsl:if test="(($CHECK-CUSTOM-OPT ='true') or ($LOCALHOLDINGS-CITATION='true'))" >
        <tr>
          <td valign="bottom" colspan="4" height="30"><img src="/static/images/spacer.gif" border="0" height="30"/></td>
