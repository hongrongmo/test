   ...
   // </xsl:comment>
	...
	<center>
		...
		<table border="0" width="99%" cellspacing="0" cellpadding="0">
			<tr>
				<td valign="top" width="1" bgcolor="#FFFFFF"><img src="/static/images/s.gif" border="0" width="1"/></td>
				<td valign="top" width="100%"><img src="/static/images/s.gif" border="0"/></td>
					<xsl:apply-templates>
...
<xsl:template match="TAGGROUPS">
	...
	<!-- Tag Search -->
	<td valign="bottom" width="2"><img src="/static/images/s.gif" width="2" border="0"/></td>
	<td valign="bottom" align="right">
		<a TARGET="{$TARGET}" href="/tagsgroups/display.url?CID=tagsLoginForm&amp;database={$ENCODED-DATABASE}&amp;searchtype=TagSearch">
		<xsl:choose>
			<xsl:when test="($LINK='Tags') or ($LINK='TagSearch') ">
				<img src="/static/images/tagsgroups_g.gif" border="0" alt="Tag Search" />
			</xsl:when>
			<xsl:otherwise>
				<img src="/static/images/tagsgroups_b.gif" border="0" alt="Tag Search" />
			</xsl:otherwise>
		</xsl:choose>
		</a>
	</td>
	...
	<td valign="bottom" align="right">
		...
		<xsl:choose>
			<xsl:when test="($LINK='Easy')">
				<img src="/static/images/simple_g.gif" border="0" alt="Easy Search" />
			</xsl:when>
			<xsl:otherwise>
				<img src="/static/images/simple_b.gif" border="0" alt="Easy Search" />
			</xsl:otherwise>
		</xsl:choose>
		</a>
	</td>
	...
	<td valign="bottom" align="right">
		...
		<xsl:choose>
			<xsl:when test="($LINK='Quick')">
				<img src="/static/images/advanced_g.gif" border="0" alt="Quick Search" />
			</xsl:when>
			<xsl:otherwise>
				<img src="/static/images/advanced_b.gif" border="0" alt="Quick Search" />
			</xsl:otherwise>
		</xsl:choose>
		</a>
	</td>
	...
	<td valign="bottom" align="right">
		...
		<xsl:choose>
			<xsl:when test="($LINK='Expert')">
				<img src="/static/images/expert_g.gif" border="0" alt="Expert Search" />
			</xsl:when>
			<xsl:otherwise>
				<img src="/static/images/expert_b.gif" border="0" alt="Expert Search" />
			</xsl:otherwise>
		</xsl:choose>
		</a>
	</td>
...
<xsl:template match="BULLETINS">
	...
	<!-- Bulletin Search -->
	<td valign="bottom" width="2"><img src="/static/images/s.gif" width="2"/></td>
	<td valign="bottom" align="right">
		<a TARGET="{$TARGET}" href="/controller/servlet/Controller?CID=bulletinSearch&amp;database=1024">
		<xsl:choose>
			<xsl:when test="($LINK='Bulletins')">
				<img src="/static/images/bu1.gif" border="0" />
			</xsl:when>
			<xsl:otherwise>
				<img src="/static/images/bu2.gif" border="0"/>
			</xsl:otherwise>
		</xsl:choose>
		</a>
	</td>
	...
	<td valign="bottom" align="right">
		...
		<xsl:choose>
			<xsl:when test="($LINK='Thesaurus')">
				<img src="/static/images/thes_g.gif" border="0" alt="Thesaurus" />
			</xsl:when>
			<xsl:otherwise>
				<img src="/static/images/thes_b.gif" border="0" alt="Thesaurus" />
			</xsl:otherwise>
		</xsl:choose>
		</a>
	</td>
	...
	<td valign="bottom" align="right">
		...
		<xsl:choose>
			<xsl:when test="($LINK='Book')">
				<img src="/static/images/ebook_g.gif" border="0" alt="eBook Search" />
			</xsl:when>
			<xsl:otherwise>
				<img src="/static/images/ebook_b.gif" border="0" alt="eBook Search" />
			</xsl:otherwise>
		</xsl:choose>
		</a>
	</td>
	...
	<td valign="bottom" align="right">
		...
		<xsl:choose>
			<xsl:when test="($LINK='referenceServices')">
				<img src="/static/images/ask_g.gif" border="0" alt="Ask an Expert" />
			</xsl:when>
			<xsl:otherwise>
				<img src="/static/images/ask_b.gif" border="0" alt="Ask an Expert" />
			</xsl:otherwise>
		</xsl:choose>
		</a>
	</td>
...
<xsl:template match="HELP">
	...
	<xsl:choose>
		<xsl:when test="($LINK='help')">
			<img src="/static/images/help_g.gif" border="0" alt="Help" />
		</xsl:when>
		<xsl:otherwise>
			<img src="/static/images/help_b.gif" border="0" alt="Help" />
		</xsl:otherwise>
	</xsl:choose>
	</a>
	</td>
