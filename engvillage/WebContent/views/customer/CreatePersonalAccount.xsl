                ...
                <tr>
				  ...
				  <td colspan="3">
					...
					<xsl:if test="($EMAIL-EXISTS='true')">
						<tr>
							<td width="2"><img src="/static/images/s.gif" width="2"/></td><td colspan="3"><a class="RedText">Your email address already exists in the system. Please use login form </a><a class="LgBlueLink" href="/controller/servlet/Controller?CID=personalLoginForm&amp;displaylogin=true&amp;database={$DATABASE}">here</a><a class="RedText">, or enter a different email address.</a>
							</td>
						</tr>
					</xsl:if>
					<!-- end of error message -->
					<tr><td valign="top" height="10" colspan="4"><img src="/static/images/s.gif" border="0" height="10"/></td></tr>
					<tr><td valign="top" width="2"><img src="/static/images/s.gif" border="0" width="2"/></td><td valign="top" colspan="3"><a CLASS="MedBlackText">To obtain your FREE personal account, please complete the form below. Your account will allow you to save searches, save records, and create Email Alerts.</a><br/><font color="red"><b>*</b> <a CLASS="MedBlackText">indicate required fields</a></font></td></tr>
					<tr><td valign="top" height="10" colspan="4"><img src="/static/images/s.gif" border="0" height="10"/></td></tr>
					<tr><td valign="top" width="2"><img src="/static/images/s.gif" border="0" width="2"/></td><td valign="top"><a CLASS="MedBlackText"><font color="C3C8D1"><B>*</B></font>Title: </a></td><td valign="top" width="1"><img src="/static/images/s.gif" border="0"/></td><td valign="top"><a CLASS="MedBlackText">
					...
					<tr><td valign="top" width="2"><img src="/static/images/s.gif" border="0" width="2"/></td><td valign="top"><font color="red"><b>*</b></font><a CLASS="MedBlackText">First Name: </a></td><td valign="top" width="1"><img src="/static/images/s.gif" border="0"/></td>
					...
					<tr><td valign="top" height="4" colspan="4"><img src="/static/images/s.gif" border="0" height="4"/></td></tr>
					<tr><td valign="top" width="2"><img src="/static/images/s.gif" border="0" width="2"/></td><td valign="top"><font color="red"><b>*</b></font><a CLASS="MedBlackText">Last Name: </a></td><td valign="top" width="1"><img src="/static/images/s.gif" border="0"/></td>
						<td valign="top"><a CLASS="MedBlackText">
					...
					<tr><td valign="top" height="4" colspan="4"><img src="/static/images/s.gif" border="0" height="4"/></td></tr>
					<tr><td valign="top" width="2"><img src="/static/images/s.gif" border="0" width="2"/></td><td valign="top"><font color="red"><b>*</b></font><a CLASS="MedBlackText">Email address: </a></td><td valign="top" width="1"><img src="/static/images/s.gif" border="0"/></td>
						<td valign="top"><a CLASS="MedBlackText">
					...
					<tr><td valign="top" height="4" colspan="4"><img src="/static/images/s.gif" border="0" height="4"/></td></tr>
					<tr><td valign="top" width="2"><img src="/static/images/s.gif" border="0" width="2"/></td><td valign="top" colspan="3"><a CLASS="MedBlackText">Specify a password between 6 and 16 characters.</a></td></tr>
					<tr><td valign="top" height="4" colspan="4"><img src="/static/images/s.gif" border="0" height="4"/></td></tr>
					<tr><td valign="top" width="2"><img src="/static/images/s.gif" border="0" width="2"/></td><td valign="top"><font color="red"><b>*</b></font><a CLASS="MedBlackText">Choose a Password: </a></td><td valign="top" width="1"><img src="/static/images/s.gif" border="0"/></td>
						<td valign="top"><a CLASS="MedBlackText">
					...
					<tr><td valign="top" height="4" colspan="4"><img src="/static/images/s.gif" border="0" height="4"/></td></tr>
					<tr><td valign="top" width="2"><img src="/static/images/s.gif" border="0" width="2"/></td><td valign="top"><font color="red"><b>*</b></font><a CLASS="MedBlackText">Confirm password: </a></td><td valign="top" width="1"><img src="/static/images/s.gif" border="0"/></td>
						<td valign="top"><a CLASS="MedBlackText">
					...
					<tr><td valign="top" height="4" colspan="4"><img src="/static/images/s.gif" border="0" height="4"/></td></tr>
					<tr><td valign="top" width="2"><img src="/static/images/s.gif" border="0" width="2"/></td>
					...
					<tr><td valign="top" height="4" colspan="4"><img src="/static/images/s.gif" border="0" height="4"/></td></tr>
					<tr><td valign="top" width="2"><img src="/static/images/s.gif" border="0" width="2"/></td><td valign="top" colspan="3"><input type="image" src="/static/images/sub.gif" border="0" alt="Sends registration"/> &#160; &#160; <a><xsl:attribute name="href">/controller/servlet/Controller?<xsl:value-of select="java:decode(BACKURL)"/></xsl:attribute><img src="/static/images/cancel.gif" border="0" alt="Go back to previous screen"/></a> &#160; &#160; <input type="image" src="/static/images/res.gif" border="0" alt="Clear entered text" name="reset" value="Reset" onClick="javascript:reset();return false;"/></td></tr>
...
<xsl:otherwise>
	...
	<table border="0" width="99%" cellspacing="0" cellpadding="0">
		...
		<tr>
			...
			sent to your email address. Please remember your account email address and password for your future visits.
			</a></td>
		</tr>
		...
		<tr>
			...
			<img src="/static/images/continue_blue.gif" border="0"/>
			</a>
			</td>
		</tr>
	</table>
