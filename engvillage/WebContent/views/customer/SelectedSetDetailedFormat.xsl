...
-->
  ...
  <xsl:template match="PAGE-ENTRY">
    ...
    <tr>
      <td valign="top" colspan="5" height="15"><img src="/static/images/s.gif" border="0" height="15"/></td>
    </tr>
    <tr>
      <td valign="top" align="right">
        <A href="/controller/servlet/Controller?CID=deleteFromSelectedSet&amp;viewType=detailedSelectedSet&amp;docid={$DOC-ID}&amp;basketsize={$RESULTS-COUNT}&amp;handle={$INDEX}&amp;DATABASETYPE={$RESULTS-DATABASE}&amp;searchresults={$ENCODED-RESULTS-NAV}&amp;newsearch={$ENCODED-NEWSEARCH-NAV}"><img src="/static/images/remove.gif" border="0"/></A>
      </td>
      <td valign="top" width="3"><img src="/static/images/s.gif" border="0" width="3"/></td>
      <td valign="top">
        <A CLASS="MedBlackText"><xsl:value-of select="$INDEX" />.</A>
      </td>
      <td valign="top" width="4"><img src="/static/images/s.gif" border="0" width="3"/></td>
    ...
    <xsl:if test="($CHECK-CUSTOM-OPT='true') or ($LHL='true') or ($LOCALHOLDINGS='true')">
      ...
      <xsl:if test="($CHECK-CUSTOM-OPT ='true')" >
        <tr>
          <td valign="top" colspan="4"><img src="/static/images/s.gif" height="30" border="0"/></td>
          <td align="left"><a href="" onclick="window.open('/controller/servlet/Controller?CID=FullTextLink&amp;docID={$DOC-ID}','newwindow','width=500,height=500,toolbar=no,location=no,scrollbars,resizable');return false"><img name='fullDocImageCit'  src="/static/images/av.gif" border="0" /></a></td>
        </tr>
      </xsl:if>

      <xsl:if test="(EI-DOCUMENT/DOC/DB/DBMASK != '131072') and ($LHL='true')">
        <tr>
          <td valign="top" colspan="4" width="3"><img src="/static/images/s.gif" height="30" border="0"/></td>
          <td align="left">
