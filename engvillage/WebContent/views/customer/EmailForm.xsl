  ...
  <SCRIPT LANGUAGE="Javascript" SRC="/static/js/StylesheetLinks.js"/>
	...
	<xsl:choose>
		<xsl:when test="$ERROR-PAGE='true'">
			...
			<td valign="top" colspan="2"><a class="EvHeaderText">Email Records</a></td>
			</tr>
		...
		<xsl:otherwise>
			...
			<table border="0" width="100%" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
				...
				<tr>
					<td valign="top" height="15" colspan="3"><img src="/static/images/spacer.gif" border="0"/></td></tr>
				<tr>
					<td valign="top" width="20"><img src="/static/images/spacer.gif" border="0" width="20"/></td>
					<td valign="top" colspan="2"><a class="EvHeaderText">Email Records</a></td>
				</tr>
				<tr>
					<td valign="top" width="20"><img src="/static/images/spacer.gif" border="0" width="20"/></td>
					<td valign="top"><A CLASS="MedBlackText">Enter the email address where you would like to have your results sent.</A></td>
					<td valign="top" width="10"><img src="/static/images/spacer.gif" border="0" width="10"/></td>
				</tr>

				<tr>
					<td valign="top" height="20" colspan="3"><img src="/static/images/spacer.gif" border="0" height="20"/></td>
				</tr>
				<tr>
					...
					<tr>
						<td valign="top" width="2" bgcolor="#3173B5"><img src="/static/images/spacer.gif" border="0" width="2"/></td>
			...
			<xsl:for-each select="DOCIDS/DOC">
				...
				<table border="0" width="300" cellspacing="0" cellpadding="0">
					<tr><td valign="top" height="10" colspan="3"></td></tr>
					<tr><td valign="top" align="right"><A CLASS="MedBlackText">To: </A></td><td valign="top" width="6">
						<img src="/static/images/spacer.gif" border="0" width="6"/></td><td valign="top"><A CLASS="MedBlackText">
						<input type="text" name="to" size="25"/>
						</A>
						</td>
					</tr>
					<tr><td valign="top" height="3" colspan="3"></td></tr>
