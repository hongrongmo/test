...
pageTracker._trackPageview();
    ...
    <xsl:template match="PAGE-ENTRY">
        ...
        <tr><td colspan="7"><img src="/static/images/s.gif" border="0" height="10"/></td></tr>
        <tr>
            ...
            <td><img src="/static/images/s.gif" border="0" width="3" name="image_basket"/></td>
            <td valign="top"><a CLASS="MedBlackText"><xsl:value-of select="$INDEX" />.</a></td>
            <td><img src="/static/images/s.gif" border="0" width="4"/></td>
