...
<xsl:template match="PAGE">
	...
	<body bgcolor="#FFFFFF" topmargin="0" marginheight="0" marginwidth="0">
		...
		<table border="0" width="99%" cellspacing="0" cellpadding="0">
			...
			<tr><td valign="top" height="5" colspan="2"><img src="/static/images/spacer.gif" border="0" height="5"/></td></tr>
			<tr><td valign="top" height="2" bgcolor="#3173B5" colspan="2"><img src="/static/images/spacer.gif" height="2" border="0"/></td></tr>
			<tr><td valign="top" height="10" colspan="2"><img src="/static/images/spacer.gif" border="0" height="10"/></td></tr>
		</table>
		</center>
		<!-- End of logo table -->
		<center>
