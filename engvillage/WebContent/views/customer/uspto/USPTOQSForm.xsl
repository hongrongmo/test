          ...
          <td valign="top" >
                ...
                <td valign="top" bgcolor="#C3C8D1">
                  <form name="quicksearch" action="/controller/servlet/Controller?CID=usptoQuick" method="post" onSubmit="return searchValidation()">
                    ...
                    <table border="0" cellspacing="0" cellpadding="0" width="470" bgcolor="#C3C8D1">
                      <tr>
                        <td valign="top" height="20" colspan="5"><img src="/static/images/spacer.gif" border="0" height="20" /></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td valign="top" width="4" bgcolor="#C3C8D1"><img src="/static/images/spacer.gif" border="0" width="4" /></td>
                        <td valign="top" width="15" bgcolor="#C3C8D1"><img src="/static/images/spacer.gif" border="0" width="15" /></td>
                        <!-- get search word 1 -->
                        <td valign="top" bgcolor="#C3C8D1">
			...
			<a href="javascript:makeUrl('USPTO_patent_search.htm')">
			    <img src="/static/images/blue_help1.gif" border="0"/>
                      ...
                      <tr>
                        <td valign="top" height="4" colspan="5" bgcolor="#C3C8D1"><img src="/static/images/spacer.gif" border="0" height="4" /></td>
                      </tr>
                      <tr>
                        <td valign="top" width="4" bgcolor="#C3C8D1"><img src="/static/images/spacer.gif" border="0" width="4" /></td>
                        <td valign="top" width="15" bgcolor="#C3C8D1"><img src="/static/images/spacer.gif" border="0" width="15" /></td>
                      ...
                      <tr>
                        <td valign="top" colspan="5" height="8" bgcolor="#C3C8D1"><img src="/static/images/spacer.gif" border="0" height="8" /></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td valign="bottom">&#160;
                          ...
                          <input type="image" src="/static/images/search_orange1.gif" name="search" value="Search" border="0"/></a>&#160; &#160;
                          <a href="javascript:doReset()"><img src="/static/images/reset_orange1.gif" border="0" /></a>
                        </td>
                      </tr>
                      <tr>
                        <td valign="top" colspan="5" height="1"><img src="/static/images/spacer.gif" border="0" height="1" width="455" /></td>
                      </tr>
                    </table>
                </form>
              <!-- end of search form -->
