          ...
          <td valign="top" width="100%">
            <table border="0" cellspacing="0" cellpadding="0">
              <tr>
				...
				<img src="/static/images/s.gif" width="4"/><a class="MedBlackText">To</a><img src="/static/images/s.gif" width="4"/>
			...
			<!-- end ajax updates here -->
                ...
                <input type="radio" name="scope" value="G" checked="checked"/><a class="MedBlackText">Public</a><img src="/static/images/s.gif" width="4"/>
