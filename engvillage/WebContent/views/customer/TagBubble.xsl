...
<xsl:template match="TAG-BUBBLE">
    ...
    <![CDATA[
      <script language="javascript">
        ...
        function flipimg()
        {
          ...
          {
            drawEditTags();
            document.editlink.src="/static/images/tagedit_minus.gif";
            editflag = "2";
          }
          else if (editflag == "2")
          {
            clearEdit();
            document.editlink.src="/static/images/tagedit_plus.gif";
            editflag = "1";
          }
        }
    ...
    <![CDATA[
		...
		document.location = personallogin;
          ...
          function drawEmail()
          {
            ...
            ipLabel.appendChild(document.createTextNode("Email Group"));
 ...
 <div  style="width:215px;" id="citedby_box"/>
        <div>
        <table><tr><td><img src="/static/images/s.gif" height="4"/></td></tr></table>
        </div>
      ...
      <div class="trc">
        <table border="0" style="margin:0px; padding:0px; width:100%">
          ...
          <tr>
			...
			<img src="/static/images/blue_help.gif" alt="Separate each tag with a comma: nanotech, carbon nanotubes, Environmental 101" border="0"/>
	         </a>
                <br/>
		 	...
		 	<option value="6">Login for groups</option>
                ...
                <input style="vertical-align: middle;" alt="Add Tag" type="image" src="/static/images/addtag_button.gif" border="0" width="54" height="19"/>
                  ...
                  <div class="im">
                    <xsl:if test="($PERSONALIZATION='true')">
                      <xsl:if test="(/PAGE/EDIT-TAGS/SET-EDIT)">
                        <a class="SmBlueText" href="self" onclick="javascript:flipimg(); return false;">Edit my tags<img name="editlink" src="/static/images/tagedit_plus.gif"  border="0" /></a>
                      </xsl:if>
                    </xsl:if>
          ...
          <tr>
            <td colspan="3">
            <!--  <div style="display:inline;" class="im"><a href="http://www.2collab.com/bookmark/addremote?url={$ENCODED-LOCATION}&amp;title={$TITLE}{$COLLABDATA}" title="Bookmark and share in 2collab (opens in new window)" class="LgBlueLink" onclick="javascript:window.open(this.href); return false;"><img src="/static/images/2collab_logo.gif" align="absmiddle" border="0" width="37" height="24" />Add to 2collab</a></div>-->
              <div style="display:inline;" class="im"><a title="Save this page to del.icio.us" class="LgBlueLink" href="http://del.icio.us/post" onclick="javascript:window.open('http://del.icio.us/post?v=4&amp;noui&amp;jump=close&amp;url={$ENCODED-LOCATION}&amp;title={$TITLE}', 'delicious', 'toolbar=no,width=700,height=400'); return false;"><img src="/static/images/delicious.small.gif" align="absmiddle" border="0" width="10" height="10" />del.icio.us</a></div>
            </td>
          </tr>
          <!-- edit form ends here -->
          <tr><td colspan="3"><img src="/static/images/s.gif" height="4"/></td></tr>
