  ...
  <xsl:apply-templates select="GLOBAL-LINKS">
	...
	<table border="0" width="99%" cellspacing="0" cellpadding="0">
		<tr>
			...
			<img src="/static/images/myfolders.gif" border="0"/></a></td>
		</tr>
	</table>
                  ...
                  <td colspan="3">
                    <!-- Content Goes Here -->
                      <table border="0" cellspacing="0" cellpadding="0" width="100%" >
                          ...
                          <tr><td valign="top" height="4" colspan="5"><img src="/static/images/s.gif" height="4" border="0"/></td></tr>
                          <tr><td valign="top" width="4"><img src="/static/images/s.gif" border="0"/></td><td valign="top" colspan="4"><a CLASS="MedBlackText">Please enter the new folder name in the appropriate field and click "Save" button to save changes. </a></td></tr>
                          <tr><td valign="top" height="4" colspan="5"><img src="/static/images/s.gif" height="4" border="0"/></td></tr>
                          <tr>
                            <td valign="top" width="4"><img src="/static/images/spacer.gif" border="0"/></td><td valign="top" align="right"><a CLASS="MedBlackText">Current folder name is:</a></td><td width="5"><img src="/static/images/s.gif" width="5"/></td><td valign="top">
                          ...
                          <tr><td valign="top" height="4" colspan="5"><img src="/static/images/s.gif" height="4" border="0"/></td></tr>
                          <tr><td valign="top" width="4"><img src="/static/images/spacer.gif" border="0"/></td><td valign="top" align="right"><a CLASS="MedBlackText">New folder name is:</a></td><td width="5"><img src="/static/images/s.gif" width="5"/></td><td valign="top"><a CLASS="MedBlackText"><input type="text" name="newfoldername" size="28" maxlength="32"/></a></td></tr>
                          <tr><td valign="top" height="4" colspan="5"><img src="/static/images/s.gif" height="4" border="0"/></td></tr>
                          <tr>
                            <td valign="top" width="4"><img src="/static/images/spacer.gif" border="0"/></td>
                            <td valign="top" colspan="2">&#160;</td>
                            <td valign="top">
                              <input alt="Rename" type="image" src="/static/images/sav.gif" name="submit" value="Submit"/> &#160; &#160;
    				                  <input alt="Cancel" type="image" src="/static/images/cancel.gif" name="cancel" value="Cancel" onclick="javascript:document.location='/controller/servlet/Controller?EISESSION={$SESSION-ID}&amp;CID=viewPersonalFolders&amp;database={$DATABASE}';return false;"/> &#160; &#160;
                            </td>
                          </tr>
                          <tr><td valign="top" height="4" colspan="5"><img src="/static/images/s.gif" height="4" border="0"/></td></tr>
                      	</FORM>
