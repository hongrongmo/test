			...
			<div id="content_right">
				<div id="regusers">
					<form target="_top" name="passwordval" method="post" action="/controller/servlet/Controller" onsubmit="javascript:return validForm(passwordval);">
						...
						<input type="image" src="/static/images/login_button.gif" name="login" alt="Log-In"/>
			...
			<dl id="leftside">
				...
				<dd>
					<ul>
						...
						<li>The ability to choose preferred output formats (citation, abstracts or detailed) for Selected Record sets, which can then be viewed, printed, saved, downloaded or emailed.</li>
					</ul>
				</dd>
			</dl>
			<dl id="rightside">
