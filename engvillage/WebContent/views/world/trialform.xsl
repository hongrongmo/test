	...
	<!--                    <li id="nav_about_ei">
	        ...
	        <dl id="footer">
	            ...
	            <dd>
	                ...
	                <ul>
	                    <li class="first_child"><a href="http://www.ei.org/about/copyright.html">Copyright <xsl:value-of select="date:getCurrentYear()"/> Elsevier Inc. All Rights Reserved</a></li>
	                </ul>
	            </dd>
	        </dl>
	    </body>
