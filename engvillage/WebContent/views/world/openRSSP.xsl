<xsl:stylesheet
  ...
  xmlns:date="java:org.ei.util.DateUtil"
  exclude-result-prefixes="xsl DD SU date">
...
<xsl:template match="RSS">
	<rss version="2.0">
  			...
  			<ttl>2880</ttl>
  			<image>
			    http://localhost/static/images/ev2logo5.gif
    			</image>
  			<copyright>Copyright <xsl:value-of select="date:getCurrentYear()"/> Elsevier Inc. All rights reserved.</copyright>
