...
public class FileLogger {
	...
	public static FileLogger getInstance(String fileName, long roll)
			throws IOException {
		if (instance == null) {
			instance = new FileLogger(fileName, roll);
		}

		return instance;
	}

	private FileLogger(String fileName, long roll) throws IOException {
