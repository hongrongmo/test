...
<html:form action='/saveGatewayAccess' onsubmit="return validateGatewayForm(this);">
			...
			<table border="0" cellspacing="0" cellpadding="0" width="600" bgcolor='<bean:write name="Inner"/>'>
				...
				<tr>
					...
					<td valign="top" colspan="2" >
						<html:text  size="60" maxlength="255" name="accessForm" property="credentials.gatewayUrl"/>
					</td>
				</tr>
				<tr>
					<td valign="top" colspan="4" ><html:img height="4" border="0" pageKey="images.spacer"/></td>
				...
				<tr>
					<td valign="middle" colspan="4" >
                        &nbsp;<span class="MedBlackText">Please always give out the following URL to customers for placing on their Gateway, or referring, page(s).
                        </span>
					</td>
				</tr>
				<tr>
					<td valign="middle" colspan="4" >
                        &nbsp;<span class="MedBlackText"><%= Constants.GATEWAY_URL_LINK %></span>
					</td>
				</tr>
				<tr>
					<td valign="top" colspan="4" ><html:img height="4" border="0" pageKey="images.spacer"/></td>
...
<html:javascript formName="gatewayForm" dynamicJavascript="true" staticJavascript="false"/>
