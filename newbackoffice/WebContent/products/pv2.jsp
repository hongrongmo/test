...
<html:form action="/savePv2" onsubmit="return validatePv2Form(this);">
              ...
              <table border="0" cellspacing="0" cellpadding="0" width="600" bgcolor='<bean:write name="Inner"/>'>
                ...
                <tr>
                  <td valign="top" align="right" colspan="2" width="33%">
                    <span class="MedBlackText">Databases</span>:&nbsp;
                  </td>
...
<html:javascript formName="pv2Form" dynamicJavascript="true" staticJavascript="false"/>
