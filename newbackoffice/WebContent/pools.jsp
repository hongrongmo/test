...
BasicDataSource jm = (BasicDataSource) envCtx.lookup(Constants.OFFICE_DBCP_POOL);

out.write("BACKOFFICE");
out.write("<PRE>");
out.write("<br>");
...
out.write("<PRE>");
out.write("<br>      NumActive = " + jm.getNumActive());
out.write("<br>        NumIdle = " + jm.getNumIdle());
out.write("<br>      MaxActive = " + jm.getMaxActive());
out.write("<br>DriverClassName = " + jm.getDriverClassName() );
out.write("<br>       Username = " + jm.getUsername() );
  //out.write("<br>            Url = " + jm.getUrl() );
	//out.write("<br>       Username = " + jm.getUsername() );
  String jdbcURL = jm.getUrl();
  if(jdbcURL != null)
  {
...
BasicDataSource old = (BasicDataSource) envCtx.lookup(Constants.U_ACCESS_DBCP_POOL);
if(old != null)
{
  out.write("<PRE>");
...
/*
BasicDataSource tkn = (BasicDataSource) envCtx.lookup(Constants.TOKEN_DBCP_POOL);
if(tkn != null)
{
  out.write("<PRE>");
  out.write("<br>      NumActive = " + tkn.getNumActive());
  out.write("<br>        NumIdle = " + tkn.getNumIdle());
  out.write("<br>      MaxActive = " + tkn.getMaxActive());
  out.write("<br>DriverClassName = " + tkn.getDriverClassName() );
  //out.write("<br>       Username = " + tkn.getUsername() );
  //out.write("<br>            Url = " + tkn.getUrl() );
  jdbcURL = tkn.getUrl();
  if(jdbcURL != null)
  {
    out.write("<br>            Url = " + jdbcURL.substring(jdbcURL.lastIndexOf(".") + 1,jdbcURL.length()) );
