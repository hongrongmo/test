...
public class BdParser {
    ...
    private Iterator<Element> rec;
    private Hashtable<String, String> recTable = null;
    ...
    private int affid = 0;
    private static Hashtable<String, String> contributorRole = new Hashtable<String, String>();
    {
    ...
    private static Hashtable<String, String> descriptorsTypeTable = new Hashtable<String, String>();
    {
    ...
    public void setRecordTable(Hashtable<String, String> recTable) {
    ...
    public Hashtable<String, String> getRecord(Element cpxRoot) throws Exception {
        ...
        try {
            if (cpxRoot != null) {
                ...
                if (item != null) {
                    ...
                    if (processinfo != null) {
                        List<Element> datesort = processinfo.getChildren("date-sort", aitNamespace);
                    ...
                    if (bibrecord != null) {
                        ...
                        List<Element> itemidList = itemidlist.getChildren("itemid", noNamespace);
                        for (int i = 0; i < itemidList.size(); i++) {
                            ...
                            if (itemid_idtype != null
                                && (itemid_idtype.equals("CPX") || itemid_idtype.equals("GEO") || itemid_idtype.equals("API") || itemid_idtype.equals("APILIT") || itemid_idtype
                                    .equals("CHEM"))) {
                        ...
                        if (head != null) {
                            ...
                            if (citinfo != null) {
                                ...
                                if (authorKeywords != null) {
                                    ...
                                    List<Element> authorKeywordList = authorKeywords.getChildren("author-keyword", noNamespace);
                            ...
                            if (cittitle != null) {
                                List<Element> cittextlst = cittitle.getChildren("titletext", noNamespace);
                            ...
                            if (abstracts != null && abstracts.getChild("abstract", noNamespace) != null) {
                                ...
                                if (abstractData.getChildTextTrim("para", ceNamespace) != null) {
                                    String abstractString = DataLoadDictionary.mapEntity(getMixData(abstractData.getChild("para", ceNamespace).getContent()));
                            ...
                            List<Element> authorgroup = head.getChildren("author-group", noNamespace);
                            BdAuthors ausmap = new BdAuthors();
                            BdAffiliations affmap = new BdAffiliations();
                            this.affid = 0;
                            for (int e = 0; e < authorgroup.size(); e++) {
                                setAuthorAndAffs(ausmap, affmap, (Element) authorgroup.get(e));
                            }
                                ...
                                if (apidescriptorgroup != null) {
                                    ...
                                    if (autoposting != null) {
                                        ...
                                        if (classificationdescription != null) {
                                            List<Element> classdescgroup = classificationdescription.getChildren("classification", noNamespace);
                                            ...
                                            if (classdescgroup != null) {
                                                for (int j = 0; j < classdescgroup.size(); j++) {
                                                    ...
                                                    List<Element> apicc = ell.getChildren("classification-description", noNamespace);
                                        ...
                                        if (apicttop != null) {
                                            List<Element> ctTerms = apicttop.getChildren("autoposting-term", noNamespace);
                                            ...
                                            for (int j = 0; j < ctTerms.size(); j++) {
                                                ...
                                                if (el.getAttribute("CAS-nr") != null
                                                    && (el.getAttributeValue("CAS-nr").equals("y") || el.getAttributeValue("CAS-nr").equals("b"))) {
                                                    isCRN = true;
                                                }
                                                if (!isCRN) {
                                            ...
                                            if (apict != null && apict.toString().length() > 0) {

                                                record.put("APICT", apict.toString());
                                            }

                                            if (apictextended != null && apictextended.toString().length() > 0) {
                                        ...
                                        if (apilt != null) {
                                            List<Element> apiltgroup = apilt.getChildren("API-LT-group", noNamespace);
                                            for (int i = 0; i < apiltgroup.size(); i++) {
                                                Element ltgroup = (Element) apiltgroup.get(i);
                                                List<Element> apilttop = ltgroup.getChildren("autoposting-term", noNamespace);
                                        ...
                                        if (apiapc != null) {
                                            ...
                                            if (apiapc.getChildren("API-term", noNamespace) != null) {
                                                List<Element> l = apiapc.getChildren("API-term", noNamespace);
                                        ...
                                        if (apicrn != null) {
                                            ...
                                            if (apicrn.getChildren("autoposting-term", noNamespace) != null) {
                                                List<Element> l = apicrn.getChildren("autoposting-term", noNamespace);
                                        ...
                                        if (apialc != null) {
                                            ...
                                            if (apialc.getChild("LTM-COUNT", noNamespace) != null || apialc.getChild("LT-COUNT", noNamespace) != null) {
                                        ...
                                        if (apiat != null) {
                                            ...
                                            List<Element> apiltmtop = apiat.getChildren("autoposting-term", noNamespace);
                                        ...
                                        if (apiltm != null) {
                                            ...
                                            List<Element> apiltmgroup = apiltm.getChildren("API-LTM-group", noNamespace);
                                            for (int i = 0; i < apiltmgroup.size(); i++) {
                                                Element egroup = (Element) apiltmgroup.get(i);
                                                List<Element>  apiltmtop = egroup.getChildren("autoposting-term", noNamespace);
    ...
    private void parseTradenamegroup(Element tradenamegroup, Hashtable<String, String> record) throws Exception {
        StringBuffer tradenamegroupBuffer = new StringBuffer();

        if (tradenamegroup != null) {
            List<Element> tradenamesList = tradenamegroup.getChildren("tradenames", noNamespace);
            if (tradenamesList != null) {
                for (int i = 0; i < tradenamesList.size(); i++) {
                    ...
                    if (tradenames != null) {
                        ...
                        List<Element> tradenameList = tradenames.getChildren("trademanuitem", noNamespace);
    ...
    private void parseManufacturergroup(Element manufacturergroup, Hashtable<String, String> record) throws Exception {
        StringBuffer manufacturergroupBuffer = new StringBuffer();

        if (manufacturergroup != null) {
            List<Element> manufacturergroupList = manufacturergroup.getChildren("manufacturers", noNamespace);
            if (manufacturergroupList != null) {
                for (int i = 0; i < manufacturergroupList.size(); i++) {
                    ...
                    if (manufacturers != null) {
                        List<Element> manufacturerList = manufacturers.getChildren("manufacturer", noNamespace);
    ...
    private void parseSequencebanks(Element sequencebanks, Hashtable<String, String>  record) throws Exception {
        StringBuffer sequencebanksBuffer = new StringBuffer();

        if (sequencebanks != null) {
            List<Element> sequencebankList = sequencebanks.getChildren("sequencebank", noNamespace);
            if (sequencebankList != null) {
                for (int i = 0; i < sequencebankList.size(); i++) {
                    ...
                    if (sequencebank != null) {
                        List<Element> sequencenumberList = sequencebank.getChildren("sequence-number", noNamespace);
    ...
    private void parseChemicalgroup(Element chemicalgroup, Hashtable<String, String>  record) throws Exception {
        StringBuffer chemicalgroupBuffer = new StringBuffer();
        String cas_registry_number = null;
        if (chemicalgroup != null) {
            List<Element> chemicalsList = chemicalgroup.getChildren("chemicals", noNamespace);
            if (chemicalsList != null) {
                for (int i = 0; i < chemicalsList.size(); i++) {
                    ...
                    if (chemicals != null) {
                        List<Element> chemicalList = chemicals.getChildren("chemical", noNamespace);
                        for (int j = 0; j < chemicalList.size(); j++) {
                            ...
                            List<Element> casregistrynumberList = chemical.getChildren("cas-registry-number", noNamespace);
    ...
    private void parseCorrespondenceElement(Element correspondence, Hashtable<String, String>  record) throws Exception {
    ...
    private void parseSourceElement(Element source, Hashtable<String, String> record, Element bibrecord) throws Exception {
        if (source != null) {
            ...
            List<Element> translatedsourcetitle = source.getChildren("translated-sourcetitle", noNamespace);
            ...
            // ISSN
            List<Element> issnList = source.getChildren("issn", noNamespace);
            ...
            // ISBN
            List<Element> isbnList = source.getChildren("isbn", noNamespace);
            if (isbnList != null) {
            ...
            if (volisspag != null) {
                ...
                List<Element> pagecountList = volisspag.getChildren("pagecount", noNamespace);
            ...
            // CONTRIBUTORGROUP
            List<Element> contributorgroup = source.getChildren("contributor-group", noNamespace);
            ...
            List<Element> publisherList = source.getChildren("publisher", noNamespace);
    ...
    private String getContributor(int e, List<Element> contributorList) {
    ...
    private void setContributorgroup(Hashtable<String, String> record, List<Element> contributorgroupList) throws Exception {
        StringBuffer contributorBuffer = new StringBuffer();
        ...
        for (int e = 0; e < contributorgroupList.size(); e++) {
            ...
            List<Element> contributorList = contributorgroup.getChildren("contributor", noNamespace);
            List<Element> collaborationList = contributorgroup.getChildren("collaboration", noNamespace);
    ...
    private void setPublisher(Hashtable<String, String> record, List<Element> publisherList) {
    ...
    private void setAdditionalSrcinfo(Hashtable<String, String> record, Element additionalSrcinfo) throws Exception {
        // reportinfo
            ...
            if (conferenceinfo != null) {
                ...
                if (confevent != null) {
                    ...
                    if (confnumber != null && confname != null) {
                        record.put("CONFNAME", DataLoadDictionary.mapEntity(getMixData(confnumber.getContent()) + " " + getMixData(confname.getContent())));
                        ...
                        record.put("CONFNAME", DataLoadDictionary.mapEntity(getMixData(confnumber.getContent())));
                    }
                    ...
                    if (condate != null) {
                        ...
                        if (date_text != null) {
                            ...
                            record.put("CONFDATE", date_text.getText());
                        } else {
                            if (startdate != null) {
                                startdateString = getDateString(startdate.getAttributeValue("year"), startdate.getAttributeValue("month"),
                                    startdate.getAttributeValue("day"));
                            }

                            if (enddate != null) {
                                enddateString = getDateString(enddate.getAttributeValue("year"), enddate.getAttributeValue("month"),
                                    enddate.getAttributeValue("day"));
                            }
                    ...
                    if (confsponsors != null) {
                        List<Element> confsponsorsList = confsponsors.getChildren("confsponsor", noNamespace);
    ...
    private void setConfpublication(Hashtable<String, String> record, Element confpublication) throws Exception {
    ...
    private String getConfAffiliation(Element affiliation) {
        ...
        if (affiliation != null) {
            ...
            List<Element> organizationList = affiliation.getChildren("organization", noNamespace);
    ...
    private String getEditors(Element editors) {
        List<Element> editorList = editors.getChildren("editor", noNamespace);
    ...
    private void setAuthorAndAffs(BdAuthors ausmap, BdAffiliations affs, Element aelement) {
        List<Element> authorlist = aelement.getChildren("author", noNamespace);
        ...
        if (affiliation != null) {
            ...
            List<Element> postalcode = affiliation.getChildren("postal-code", noNamespace);
            ...
            List<Element> organization = affiliation.getChildren("organization", noNamespace);
    ...
    private String auffToStringBuffer(BdAffiliations aufflist, StringBuffer secondAffGroup) {
        StringBuffer bufaffiliations = new StringBuffer();
        new StringBuffer();
        if (aufflist != null && aufflist.getAffmap() != null) {
            Iterator<BdAffiliation> itr = aufflist.getAffmap().keySet().iterator();
            while (itr.hasNext()) {
    ...
    private String auToStringBuffer(BdAuthors auslist, StringBuffer secondAuGroup) {
        StringBuffer bufauthor = new StringBuffer();
        new StringBuffer();
        if (auslist != null && auslist.getCpxaus() != null) {
            Iterator<BdAuthor> itr = auslist.getCpxaus().keySet().iterator();
            while (itr.hasNext()) {
    ...
    private void parseDescriptorgroup(Element descriptorgroup, Hashtable<String, String> record) throws Exception {
        String term1 = "";
        String term2 = "";
        if (descriptorgroup != null) {
            List<Element> descriptorsList = descriptorgroup.getChildren("descriptors", noNamespace);
            for (int i = 0; i < descriptorsList.size(); i++) {
                ...
                Enumeration<String> descriptorsKeys = descriptorsTypeTable.keys();
                while (descriptorsKeys.hasMoreElements()) {
                    ...
                    if (descriptorsType != null && descriptorsType.equals(descriptorsKey)) {
                        List<Element> descriptorList = descriptors.getChildren("descriptor", noNamespace);
    ...
    private void parseClassificationgroup(Element classificationgroup, Hashtable<String, String> record) throws Exception {
        if (classificationgroup != null) {
            List<Element> classificationsList = classificationgroup.getChildren("classifications", noNamespace);
            ...
            for (int i = 0; i < classificationsList.size(); i++) {
                ...
                if (classificationType != null && (classificationType.equals("CPXCLASS") || classificationType.equals("GEOCLASS"))) {
                    List<Element> classificationList = classifications.getChildren("classification", noNamespace);
    ...
    private StringBuffer getMixData(List<?> l, StringBuffer b) {
        ...
        while (it.hasNext()) {
            ...
            if (o instanceof Text) {
                ...
                if (!ats.isEmpty()) {
                    Iterator<Attribute> at = ats.iterator();
                    while (at.hasNext()) {
