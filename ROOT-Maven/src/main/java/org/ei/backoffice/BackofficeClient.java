...
public final class BackofficeClient {
    ...
    public LhlUserInfo getLhlUserInfo(String strCustomerID, String strContractID) throws Exception {
    ...
    public boolean authenticateByIp(String strIpAddress, String strContractID) throws Exception {
    ...
    public boolean authenticateByPassword(String strCustomerID, String strPassword, String strContractID) throws Exception {
    ...
    public boolean sendOrderInfo(LhlUserInfo lhlUserInfo, String docInfo, String attention, String shipInfo, String deliveryValue, String serviceLevel,
        String confirmedEmail, String orderNumber) throws Exception {
        ...
        try {
            ...
            Map<String, String> mapPostData = new Hashtable<String, String>();
    ...
    private String returnResultHttpHeader(String strURL, Map<String, String> mapPostData) {
        ...
        try {
            ...
            if (mapPostData != null) {
                ...
                Iterator<String> itrPostData = mapPostData.keySet().iterator();
                for (boolean blnFirst = true; itrPostData.hasNext(); blnFirst = false) {
                    ...
                    out.print(strKey.concat("=").concat(URLEncoder.encode(strValue, "UTF-8")));
                }
