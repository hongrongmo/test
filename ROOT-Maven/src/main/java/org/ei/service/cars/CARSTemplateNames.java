...
public enum CARSTemplateNames {
    CARS_REGISTER,
	CARS_REG_ID_ASSOCIATION_CONFIRMATION,
	CARS_REG_ID_ASSOCIATION,
	CARS_REG_ID_REDEMPTION,
	CARS_SETTINGS,
    CARS_LOGIN,
    CARS_LOGOUT,
    CARS_EMAIL_SETUP,
	CARS_PATH_CHOICE,
	CARS_FORGOTTEN_PASSWORD,
	CARS_FORGOTTEN_PASSWORD_EMAIL,
	CARS_REGISTRATION_CONFIRMATION_EMAIL,
	CARS_LOGIN_FULL,
	CARS_INACCESSIBLE,
    CARS_CHANGE_PASSWORD,
    CARS_CHANGE_PASSWORD_SUCCESSFUL,
	CARS_INSTITUTION_CHOICE,
	CARS_REGISTER_SUCCESSFUL;
}
