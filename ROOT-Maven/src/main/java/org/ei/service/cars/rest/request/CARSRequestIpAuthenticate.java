...
public class CARSRequestIpAuthenticate extends CARSRequestBase {
     ...
     */
    public CARSRequestIpAuthenticate(HttpServletRequest httprequest, UserSession useSession) throws ServiceException {
