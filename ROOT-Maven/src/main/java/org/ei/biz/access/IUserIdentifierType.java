...
/**
 * This interface is used to define different user identifier types.  The
 * identifiers should be represented by public objects contained within
 * the implementation of this interface.  See the base classes for an
 * example.
 */
public interface IUserIdentifierType {
}
