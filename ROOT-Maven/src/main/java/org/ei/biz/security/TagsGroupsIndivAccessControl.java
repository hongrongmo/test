...
/**
 * This AccessControl object requires that the user be individually authenticated and have access to Tags & Groups.
 */
public class TagsGroupsIndivAccessControl extends IndividualAuthRequiredAccessControl {
    ...
    public boolean isAccessAllowed(IEVWebUser user) {
        ...
        if (!super.isAccessAllowed(user)) {
            authorizationfailure = AuthorizationFailure.INDIVIDUAL_AUTHENTICATION_REQUIRED;
            return false;
        }
        return true;
    }
