...
public class ClassNodeManager {
    ...
    private void openUSPTO() throws InfrastructureException {
        try {
            String usptodir = RuntimeProperties.getInstance().getProperty(RuntimeProperties.USPTO_LUCENE_INDEX_DIR);
    ...
    private void openIPC() throws InfrastructureException {
        try {
            String ipcdir = RuntimeProperties.getInstance().getProperty(RuntimeProperties.IPC_LUCENE_INDEX_DIR);
    ...
    private void openECLA() throws InfrastructureException {
        try {
            String ecladir = RuntimeProperties.getInstance().getProperty(RuntimeProperties.ECLA_LUCENE_INDEX_DIR);
