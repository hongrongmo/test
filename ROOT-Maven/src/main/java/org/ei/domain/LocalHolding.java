...
public class LocalHolding
{
    ...
    private Map<String, String> textzones = null;
    ...
    public LocalHolding(UserSession userSes) {
        propString = userSes.getLocalHoldingKey();
    }
    ...
    public LocalHolding(UserSession userSes,
        int _displayMax)
    {
        this.propString = userSes.getLocalHoldingKey();
    ...
    public static List<LocalHolding> buildFromTextZones(Map<String, String> textzones) {
        ...
        for (int i = 0; i < UserPreferences.TZ_LINK_LABELS.length; i++) {
            ...
            linkLabel = textzones.get(UserPreferences.TZ_LINK_LABELS[i]);
            dynamicUrl = textzones.get(UserPreferences.TZ_DYNAMIC_URLS[i]);
            defaultUrl = textzones.get(UserPreferences.TZ_DEFAULT_URLS[i]);
            imageUrl = textzones.get(UserPreferences.TZ_IMAGE_URLS[i]);
