...
import org.ei.domain.personalization.cars.OpaqueInfo;
import org.ei.domain.personalization.cars.PathChoiceInfo;
import org.ei.domain.personalization.cars.QuickLinkInfo;
import org.ei.domain.personalization.cars.ScirusSourceInfo;
...
public class EVWebUser implements IEVWebUser,Serializable{
    ...
    /**
     * The userid should be the legacy user profile id that the
     * system uses for personalization.  WebUserId is used for all other
     * aspects of the user id
     */
    @Override
     ...
     * @return
     */
    public boolean getIndividuallyAuthenticated(){return isIndividuallyAuthenticated();}
    ...
    public void setEnableXtrnlSubscribedEntitlements(
        boolean isEnableXtrnlSubscribedEntitlements) {
    ...
    public void setPreference(String key, boolean value) {
        if (this.userPreferences == null) { throw new IllegalStateException("UserPreferences object has not been created!"); }
	...
	/**
	 * Get the user's stored user prefs. This will return a default new instance of userpreferences if there is none.
	 * This is ok. We don't really want to store default user preferences. Only when they make a change do we want to update it.
	 */
