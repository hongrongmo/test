...
import org.ei.biz.books.AmazonS3BookPartFetcher;
...
public class PageDetailViewAction extends SearchResultsAction implements IBizBean {
    ...
    public String getToc() {
        try {
            ...
            IBookPartFetcher fetcher = new AmazonS3BookPartFetcher();
            return fetcher.getBookPart(this.results.get(0).getIsbn13(), "_toc.html");
        } catch (Exception e) {
    ...
    public String getCloud() {
        try {
            ...
            IBookPartFetcher fetcher = new AmazonS3BookPartFetcher();
            return fetcher.getBookPart(this.results.get(0).getIsbn13(), "_cloud.html");
