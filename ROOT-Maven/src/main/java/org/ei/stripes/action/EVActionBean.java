...
public abstract class EVActionBean implements ActionBean, ISecuredAction {
    ...
    private CloudWatchStopwatch requeststopwatch = null;
    private CloudWatchStopwatch actionstopwatch = null;
    ...
    private void setTimestamp() {
        starttime = new Date();
        this.actionstopwatch = new CloudWatchStopwatch();
        this.actionstopwatch.addDimension("IP", HttpRequestUtil.getIP(this.getRequest()));
    }
    ...
    private void init() {
        ...
        this.requeststopwatch = new CloudWatchStopwatch("REQUEST");
        this.requeststopwatch.addDimension("IP", HttpRequestUtil.getIP(this.getRequest()));
    }
    ...
    public void setSessionCookie() {
        ...
        if (this.actionstopwatch != null) {
            this.actionstopwatch.addDimension("Class", this.getClass().getSimpleName());
            this.actionstopwatch.addDimension("Event", this.getContext().getEventName());
            this.actionstopwatch.stop("ACTION");
        }
