...
public class ThesaurusSearchResultsAdapter extends BizXmlAdapter {
	private final static Logger log4j = Logger.getLogger(ThesaurusSearchResultsAdapter.class);
