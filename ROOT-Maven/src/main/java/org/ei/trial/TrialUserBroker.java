...
public class TrialUserBroker {
    ...
    public void addTrialUser(TrialUser tu) throws TrialException {
    ...
    public Collection<TrialUser> getTrialAccount(java.sql.Date startDate, java.sql.Date endDate) throws Exception {
        Connection conn = null;
        PreparedStatement pstmt = null;
        ResultSet rs = null;
        Collection<TrialUser> allTrialAccount = new ArrayList<TrialUser>();
        ...
        try {
            ...
            if (startDate == null || endDate == null) {
                ...
                pstmt = conn
                    .prepareStatement("SELECT a.*,to_char(a.time_stamp,'yyyy-mm-dd,hh:mi:ss') time FROM TRIAL_USER a WHERE a.TIME_STAMP>=? and a.TIME_STAMP<=? ORDER BY a.TIME_STAMP DESC");
