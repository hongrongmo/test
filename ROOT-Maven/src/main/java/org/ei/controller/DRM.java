...
public class DRM extends HttpServlet {
    ...
    public void init() throws ServletException {
        ...
        try {
            ...
            throw new ServletException("Unable to initialize SessionCache");
        }
        ...
        try {
            ...
            if (requestType != null) {
                ...
                if (requestType.equalsIgnoreCase("DocPerm")) {
                    ...
                    IEVWebUser user = getUser(sesID, ipaddress, referrerURL, username, password);
                    ...
                    if (cartridges.indexOf(serviceID.toLowerCase()) > -1 && docIsLocal.equalsIgnoreCase("no")) {
                        ...
                        Hashtable<String, String> logProperties = new Hashtable<String, String>();
    ...
    public IEVWebUser getUser(SessionID sesID, String ipaddress, String referrerURL, String username, String password) {
    ...
    private void log(HttpServletRequest request, Hashtable<String, String> props) {
        ...
        try {
            if (this.logClient != null) {
                ...
                this.logClient.setcust_id(((String) props.get("custid")));
