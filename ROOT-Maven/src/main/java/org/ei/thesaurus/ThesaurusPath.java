...
import org.ei.stripes.action.search.ThesaurusAjaxAction;
...
public class ThesaurusPath
{
    ...
    public void addStep(String context,
        ...
        if (ThesaurusAction.SEARCH.equals(context)) {
            linkBuffer.append(ThesaurusAjaxAction.THES_TERMSEARCH_URL + "?");
        } else if (ThesaurusAction.BROWSE.equals(context)) {
            linkBuffer.append(ThesaurusAjaxAction.THES_BROWSE_URL + "?");
        } else if (ThesaurusAction.FULL.equals(context)) {
            linkBuffer.append(ThesaurusAjaxAction.THES_FULLREC_URL + "?");
        }
