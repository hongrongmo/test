 ...
 * 
 * Usage pattern is FeedbackForm feedbackForm = new FeedbackForm();
 ...
 * 
 * Create a FeedbackForm object named say feedbackkForm; FeedbackComponent fc=
 * ComponentFactory.getFeedbackComponent(Class pointer); fc.init();
...
public class FeedbackComponent {
	...
	/**
	 * Loads the configuration information and return the value for the named
	 * property.
	 **/
