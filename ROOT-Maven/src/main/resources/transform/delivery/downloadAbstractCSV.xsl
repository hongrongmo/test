...
<xsl:template match="/">
   	<xsl:variable name="dynamicHeader" >
   		...
   		<xsl:if test="(PAGE/PAGE-RESULTS/PAGE-ENTRY/EI-DOCUMENT//PD_YR | PAGE/PAGE-RESULTS/PAGE-ENTRY/EI-DOCUMENT//UPD | PAGE/PAGE-RESULTS/PAGE-ENTRY/EI-DOCUMENT//PPD | PAGE/PAGE-RESULTS/PAGE-ENTRY/EI-DOCUMENT//PPD_YR)">EVLABELPublication dateEVLABEL,</xsl:if>
   		...
   		<xsl:if test="PAGE/PAGE-RESULTS/PAGE-ENTRY/EI-DOCUMENT//YR | PAGE/PAGE-RESULTS/PAGE-ENTRY/EI-DOCUMENT//PYR | PAGE/PAGE-RESULTS/PAGE-ENTRY/EI-DOCUMENT//BYR">EVLABELPublication yearEVLABEL,</xsl:if>
...
<xsl:template match="PAGE/PAGE-RESULTS/PAGE-ENTRY/EI-DOCUMENT">
	...
	<xsl:variable name="dynamicRow" >
    	...
    	<xsl:if test="contains($headerString, 'EVLABELSponsorEVLABEL')">
       		<xsl:choose>
		        <xsl:when test="RSP">"<xsl:apply-templates select="RSP" ></xsl:apply-templates>",</xsl:when>
		        <xsl:when test="SP">"<xsl:apply-templates select="SP" ></xsl:apply-templates>",</xsl:when>
		        <xsl:otherwise>"",</xsl:otherwise>
	      	</xsl:choose>
    	</xsl:if>
		...
		<xsl:if test="contains($headerString, 'EVLABELVolume and IssueEVLABEL')">
			<xsl:choose>
		        <xsl:when test="VO">"<xsl:apply-templates select="VO" ></xsl:apply-templates>",</xsl:when>
		        <xsl:otherwise>"",</xsl:otherwise>
	      	</xsl:choose>
		</xsl:if>
		...
		<xsl:if test="contains($headerString, 'EVLABELPublication dateEVLABEL')">
		  <xsl:choose>
			...
			<xsl:when test="PPD_YR">"<xsl:apply-templates select="PPD_YR" />",</xsl:when>
		    <xsl:otherwise>"",</xsl:otherwise>
	      </xsl:choose>
		</xsl:if>
		...
		<xsl:if test="contains($headerString, 'EVLABELPublication yearEVLABEL')">
			<xsl:choose>
		        ...
		        <xsl:when test="PYR">"<xsl:apply-templates select="PYR" ></xsl:apply-templates>",</xsl:when>
		...
		<xsl:if test="contains($headerString, 'EVLABELAbstractEVLABEL')">
			<xsl:choose>
				...
				<xsl:when test="BAB">"<xsl:apply-templates select="BAB" />",</xsl:when>
				<xsl:otherwise>"",</xsl:otherwise>
		    </xsl:choose>
		</xsl:if>
