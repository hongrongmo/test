    ...
    <xsl:template match="AN"> <!-- accessnumber -->
    	...
    	<tr>
			...
			<tr>
			   ...
			   <a href="javascript:window.open('/engresources/aip_help.html','newwind','width=310,height=300,scrollbars=yes,resizable,statusbar=yes');void('');"><img src="/static/images/i3.gif" border="0" style="vertical-align:top" /></a></td>
			</tr>
			<tr>
...
-->
  ...
  <!-- ???????  -->
   ...
   <xsl:template match="ABS">
     <a CLASS="MedBlackText"><xsl:value-of select="ibfab:getHTML(hlight:addMarkupCheckTagging(.))" disable-output-escaping="yes"/></a>
   </xsl:template>
  ...
  <xsl:template match="IMAGE">
    ...
    <td valign="top" align="middle"><a href="javascript:window.open('{$figureUrl}','newwind','width=650,height=600,scrollbars=yes,resizable,statusbar=yes');void('');"><img src="{$figureUrl}" alt="{$cap}" border="1" width="100" height="100"/></a>
    <br/><a class="SmBlackText"><xsl:value-of select="$cap" disable-output-escaping="yes"/></a></td><td valign="top" width="15"></td>
  </xsl:template>

   <xsl:template match="SOURCE">
       <xsl:if test="@NO"><sup><xsl:value-of select="@NO"/><xsl:text>.</xsl:text></sup></xsl:if><xsl:apply-templates /><xsl:if test="boolean(contains(@DOI,'10'))">, DOI:</xsl:if><a CLASS="SpLink" href="javascript:window.open('http://dx.doi.org/{@DOI}','newwind','width=650,height=600,scrollbars=yes,resizable,statusbar=yes');void('');"><xsl:value-of select="@DOI"/></a><br/>
    </xsl:template>
            ...
            <td valign="top" align="left">
            	...
            	<input type="hidden" id="istag{$DOCID}" name="istag{$DOCID}"  value='{$SEARCH-CONTEXT}' disable-output-escaping = "yes"/>
                	...
                	<a href="" class="SmBlueText" onclick="javascript:flipEncImg('{$DOCID}','longlt','{$DOCID}'); return false;">
   					<img id="longltOpenClose{$DOCID}" src="/static/images/encLinkedOpen.gif"  border="0"  />
   					<img src="/static/images/s.gif" border="0" width="5"/>
   					<img id="longlt{$DOCID}" src="/static/images/encPlus.gif"  border="0" />
   					</a>
            ...
            <td valign="top" align="left">
            	...
            	<div class="lstdiv" id="lstdiv{$DOCID}">
                	<input type="hidden" name="lstfield{$DOCID}" id="lstfield{$DOCID}" disable-output-escaping = "yes"/>
   					...
   					<img id="lstOpenClose{$DOCID}" src="/static/images/encLinkedOpen.gif"  border="0"  />
   					<img src="/static/images/s.gif" border="0" width="5"/>
   					<img id="lst{$DOCID}" src="/static/images/encPlus.gif"  border="0" />
   					</a>
            ...
            <td valign="top" align="left">
            	...
            	<div class="mltdiv" id="mltdiv{$DOCID}">
                	<input type="hidden" name="mltfield{$DOCID}" id="mltfield{$DOCID}" disable-output-escaping = "yes"/>
   					...
   					<img id="mltOpenClose{$DOCID}" src="/static/images/encMltOpen.gif"  border="0"  />
   					<img src="/static/images/s.gif" border="0" width="5"/>
   					<img id="mlt{$DOCID}" src="/static/images/encPlus.gif"  border="0" />
   					</a>
            ...
            <td valign="top" align="left">
          	...
          	<input type="hidden" name="atmfield{$DOCID}" id="atmfield{$DOCID}" disable-output-escaping = "yes"/>
   			<a href="" class="SmBlueText" onclick="javascript:flipEncImg('{$AT}','atm','{$DOCID}'); return false;">
   				<img id="atmOpenClose{$DOCID}" src="/static/images/encTemplatesOpen.gif"  border="0" />
   				<img src="/static/images/s.gif" border="0" width="5"/>
   				<img id="atm{$DOCID}" src="/static/images/encPlus.gif"  border="0" />
   			</a>
