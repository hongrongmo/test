...
<xsl:stylesheet
	...
	<!--
	This xsl file will display the list of detailed results  in an PDF format.
	Author: kamaramx
	-->
	<!-- <xsl:output method="text" indent="no" encoding="iso-8859-1" /> -->
	<xsl:output encoding="UTF-8" indent="no" method="xml" standalone="no" omit-xml-declaration="no"/>
