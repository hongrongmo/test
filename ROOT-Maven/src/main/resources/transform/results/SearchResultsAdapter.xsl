...
>
	...
	<xsl:variable name="PHYSICAL-QUERY"><xsl:value-of select="//SESSION-DATA/PHYSICAL-QUERY"/></xsl:variable>
	...
	<xsl:template match="/PAGE">
	    ...
	    <xsl:value-of select="actionbean:setPhysicalquery($actionbean,$PHYSICAL-QUERY)"/>
		...
		<xsl:value-of select="actionbean:setCitedbyflag($actionbean,//CITEDBY-FLAG)"/>
		<xsl:value-of select="actionbean:setShowpatentshelp($actionbean, boolean('true'=//SHOW-PATENTS-HELP))"/>
