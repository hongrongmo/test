	...
	function downloadSavedRecords(sessionid,folderid,formvalue)
	{
		...
		window.open("/delivery/download/display.url?folderid="+folderid+"&displayformat="+displaytype,'NewWindow','status=yes,resizable,scrollbars,width=600,height=400');
	}
   ...
   //EMAIL FORM.(emailSelectedRecords,emailSelectedFormatResults.jsp)
	...
	function emailSavedRecordsFormat(sessionid,folderid,formvalue)
	{
		...
		new_window=window.open("/delivery/email/display.url?folderid="+folderid+"&displayformat="+displaytype,'NewWindow','status=yes,resizable,scrollbars,width=600,height=400');
	...
	function printSavedRecords(sessionid,folderid,formvalue)
	{
		...
		window.open("/delivery/print/display.url?folderid="+folderid+"&displayformat="+displaytype,'NewWindow','status=yes,resizable,scrollbars,width=600,height=400');
	}
