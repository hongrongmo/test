...
TINY.box=function(){
	...
	return{
		...
		psh:function(c,a,w,h){
			if(typeof c=='object'){b.appendChild(c)}else{$(b).empty();$(b).append(c)}
		...
		esc:function(e){e=e||window.event; if(e.keyCode==27 && v.clickmaskclose){TINY.box.hide()}},
