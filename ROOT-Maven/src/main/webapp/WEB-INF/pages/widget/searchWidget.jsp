...
body{
    ...
    <div id="container">
        ...
        <div id="searchcontents" class="shadowbox" role="search" aria-labeledby="Expert Search"> <!-- gray box -->
        	...
        	<c:choose>
        		<c:when test="${mask == 1}">
        			<img width="250px"alt="Engineering Village - The information discovery platform of choice for the engineering community" src="/static/images/searchwidget/cpx.jpg"/>
        		</c:when>
        		<c:when test="${mask == 2}">
        			<img width="230px"alt="Engineering Village - The information discovery platform of choice for the engineering community" src="/static/images/searchwidget/inspec.jpg"/>
        		</c:when>
        		<c:when test="${mask == 3}">
					<img width="250px"alt="Engineering Village - The information discovery platform of choice for the engineering community" src="/static/images/searchwidget/cpx_inspec.jpg"/>        		
        		</c:when>
        		<c:otherwise>
        			<img width="250px"alt="Engineering Village - The information discovery platform of choice for the engineering community" src="/static/images/EV-logo.gif"/>	
        		</c:otherwise>        		
        	</c:choose>
