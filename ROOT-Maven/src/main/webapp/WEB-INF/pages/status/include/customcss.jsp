<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" session="false"%>
    <style type="text/css">
        ...
        .usageframe {border:none; overflow: none; height: 450px; width: 850px; scrolling:auto; padding: 0; margin: 0}

        #usagemenu ul {list-style-type: none; padding: 3px 10px 3px 10px;}
        #usagemenu ul li {}
        #usagemenu ul li a {text-decoration: none}
        #usagemenu ul li a:hover {background-color: activeborder;}
        #usagemenu ul li a.active {background-color: black; color: white}

        #performancelinks {text-align: left;margin: 1em 0 1em 0;list-style-type: none; padding: 3px 10px 3px 10px; font-weight: bold}
        #performancelinks li.perftab {display:inline; float:left}
        #performance iframe {border:none; overflow: none; height: 450px; width: 770px; scrolling:no}
    </style>
