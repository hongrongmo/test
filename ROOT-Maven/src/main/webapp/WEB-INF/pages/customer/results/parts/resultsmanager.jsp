	...
	<c:otherwise>
        ...
        <ul id="outputtools" class="horizlist">
            ...
            <li class="print"><a id="printlink" title="Print selections"  aria-labelledby="viewlink"
                href="">Print</a> |</li>
            <li class="download" id="downloadli"><a id="oneclickDL"href="#" title="Download selections" style="display:none"></a><a id="downloadlink" aria-labelledby="viewlink" title="Download selections" href="">Download</a>
