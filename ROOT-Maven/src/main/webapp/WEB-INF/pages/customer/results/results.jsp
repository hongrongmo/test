...
<stripes:layout-component name="SkipToNavigation">
	<a class="skiptonavlink" href="#cbresult1" title="Skip to First Result">Skip to First Result</a>
	<a class="skiptonavlink" href="#limittobtn" title="Skip to Refine Results">Skip to Refine Results</a>
</stripes:layout-component>
