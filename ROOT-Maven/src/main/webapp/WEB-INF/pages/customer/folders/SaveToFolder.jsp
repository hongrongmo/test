        ...
        <c:choose>
            ...
            <tr>
              <td valign="top" width="4"><img src="/static/images/s.gif" border="0" width="4"/></td>
                ...
                <input type="submit" name="cancel" value="Cancel" title="Cancel action" onclick="javascript:document.location='/back/service.url?feature=SAVETOFOLDER';return false;"> &#160; &#160;
                        </td>
                        <td valign="top" width="4"><img src="/static/images/s.gif" border="0" width="4"/></td>
                </tr>
            </c:when>
