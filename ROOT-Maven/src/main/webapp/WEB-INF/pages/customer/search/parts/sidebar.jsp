...
<c:if test="${not empty actionBean.moresourceslinks}">
	...
	<div  class="sidebarbox" id="knovelbox">
        ...
        <ul id="knovelsidebar">
			...
			<li class="knovelUnit"><a href="http://tools.knovel.com/uc?kpromoter=engineeringvilalge-unitconverter" class="knovelLink" title="Unit Converter">Unit Converter</a></li>
        </ul>
        </div>
    </div>
<div class="clear"></div>