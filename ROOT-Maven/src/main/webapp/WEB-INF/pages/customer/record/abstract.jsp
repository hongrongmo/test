...
<stripes:layout-render name="/WEB-INF/pages/layout/standard.jsp">
	...
	<stripes:layout-component name="SkipToNavigation">
		<a class="skiptonavlink" href="#abstractTabLink" title="Skip to Abstract Tab">Skip to Abstract Tab</a><br/>
		<a class="skiptonavlink" href="#cbresult_${actionBean.results[0].doc.docid}" title="Skip to record">Skip to record</a><br/>
	</stripes:layout-component>
