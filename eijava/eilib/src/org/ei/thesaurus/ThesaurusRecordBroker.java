...
public class ThesaurusRecordBroker
{
            ...
            throws ThesaurusException
    {
        ...
        try
        {
            ...
            while(rs.next())
            {
                ...
                ThesaurusRecordID id = new ThesaurusRecordID(rs.getInt("t_id"),
                                   ...
                                   int endIndex)
    {
        ...
        {
            if(originalArray[t].equals(recID))
            {
                return i;
            }
            i++;
                                 ...
                                 boolean useRecordID)
    {
        ...
        for(int i=beginIndex; i<=endIndex; i++)
        {
            ...
            else
            {
                ...
                String ns = sUtil.replace(id.getMainTerm().toLowerCase(),
                              "'",
                              "''",
