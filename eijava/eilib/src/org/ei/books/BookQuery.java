...
public class BookQuery
{
    ...
    private List catCodes;
    private String queryID;
    private Perl5Util perl = new Perl5Util();
    private static String[] AUTOSTEM_ARRAY = {"AB"};
    private static Hashtable displayMappings = new Hashtable();
    private static Hashtable colMappings = new Hashtable();
    ...
    public void setQuery(String queryAsString)
    {
        ...
        List termsAndCats = new ArrayList();
    ...
    {
        /*
        BookQuery q = new BookQuery("Test");
        ...
        System.out.println(q.getPhysicalQuery());
        System.out.println("111:"+ q.getSearchQuery());
        System.out.println(q.toString());

        BookQuery q1 = new BookQuery("Test");
        q1.setQuery(q.toString());
        ...
        throws ParseException
    {
        ...
        BooleanQuery queryTree = (BooleanQuery)parser.parse(this.physicalQuery);
    ...
    public void setQuery(String term1,
                         String field1,
                         String term2,
                         String field2,
                         String term3,
     ...
     * @param list
     */
    public void setCatCodes(List catCodes) {
        this.catCodes = catCodes;
    }
