...
public class AthensService extends HttpServlet
{
    ...
    public void printErrorMessage(String message, PrintWriter out)
    {
        ...
        out.println("<br>");
        out.println("<TABLE WIDTH='100%' CELLSPACING='0' CELLPADDING='0' BORDER='0'><TR><TD><CENTER><A CLASS='MedBlueLink' HREF='/controller/servlet/Controller?CID=ncAboutEI'>About Ei</A> |<a CLASS='MedBlueLink' href='/controller/servlet/Controller?CID=ncAboutEV'>About Engineering Village 2</a> |<A CLASS='MedBlueLink' HREF='/controller/servlet/Controller?CID=ncFeedback'>Feedback</A>&nbsp;|&nbsp;<A CLASS='MedBlueLink' HREF='/controller/servlet/Controller?CID=ncPrivacyPolicy'>Privacy Policy</A><br><A CLASS='SmBlackText'>&copy; 2006 Elsevier Inc. All rights reserved., </A></CENTER></TD></TR></TABLE>");
        out.println("</body>");
        out.println("</html>");
    }
