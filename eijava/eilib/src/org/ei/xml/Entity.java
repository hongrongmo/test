    ...
    static {
        ...
        **/
        ...
        /**
        		...
        		**/
        isotable.setProperty("À", "A");
        isotable.setProperty("Â", "A");
        isotable.setProperty("Ä", "A");
        isotable.setProperty("Æ", "AE");
        isotable.setProperty("È", "E");
        isotable.setProperty("Ê", "E");
        isotable.setProperty("Ì", "I");
        isotable.setProperty("Î", "I");
        isotable.setProperty("Ð", "D");
        isotable.setProperty("Ò", "O");
        isotable.setProperty("Ô", "O");
        isotable.setProperty("Ö", "O");
        isotable.setProperty("Ø", "O");
        isotable.setProperty("Ú", "U");
        isotable.setProperty("Ü", "U");
        isotable.setProperty("Þ", "THORN");
        isotable.setProperty("à", "a");
        isotable.setProperty("â", "a");
        isotable.setProperty("ä", "a");
        isotable.setProperty("æ", "ae");
        ...
        isotable.setProperty("ü", "u");
        isotable.setProperty("þ", "thorn");
        isotable.setProperty("Á", "A");
        isotable.setProperty("Ã", "A");
        isotable.setProperty("Å", "A");
        isotable.setProperty("Ç", "C");
        isotable.setProperty("É", "E");
        isotable.setProperty("Ë", "E");
        isotable.setProperty("Í", "I");
        isotable.setProperty("Ï", "I");
        isotable.setProperty("Ñ", "N");
        isotable.setProperty("Ó", "O");
        isotable.setProperty("Õ", "O");
        isotable.setProperty("×", "");
        isotable.setProperty("Ù", "U");
        isotable.setProperty("Û", "U");
        isotable.setProperty("Ý", "Y");
        isotable.setProperty("ß", "ss");
        isotable.setProperty("á", "a");
        isotable.setProperty("ã", "a");
        isotable.setProperty("å", "a");
        isotable.setProperty("ç", "c");
