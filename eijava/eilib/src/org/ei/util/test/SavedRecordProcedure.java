...
/*
	SavedRecord_viewListOfFolder(userID varchar2,accessDate varchar2) is
	SavedRecord_viewRecordInFolder(folderID varchar2,accessDate varchar2) is
*/
