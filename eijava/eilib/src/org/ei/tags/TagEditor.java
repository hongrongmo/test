...
public class TagEditor
{
    ...
    private String oTagNames;
    private String nTagNames;
    ...
    private TagBroker broker = new TagBroker();


    public TagEditor(Map requestMap,
            		 String userID,
            		 String custID,
            		 String docID)
    	throws Exception
	...
	private void parseRequest() throws Exception
	{
		...
		while (ritr.hasNext())
		{
		   ...
		   if (paramName.indexOf(TagEditGroup.PREFIX) == 0 &&
								 !paramName.endsWith(TagEditGroup.POSTFIX))
		   {
	...
	private void addTags(TagBroker broker,
						 String[] addtags,
						 int scope,
						 String groupID,
						 String userID,
...
//			System.out.println("Adding tags:"+addtags[i]);
	...
	private void delTags(TagBroker broker,
						 String deltags[],
						 int scope,
						 String groupID,
						 String userID,
