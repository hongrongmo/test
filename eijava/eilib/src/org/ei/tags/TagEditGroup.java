...
public class TagEditGroup
{
	...
	private String oTagGroup;
    private String nTagGroup;
    private String key;
    private String label;
    private String [] oTags;
    private String [] nTags;
    private Hashtable deleteTags;
    private Hashtable addTags;
	private ArrayList oTagArray = new ArrayList();
    ...
    public TagEditGroup(String puserID,
            		    String customerID,
            		    String docID)
    {
		this.userID = puserID;
	...
	public void fillGroup(String paramName,
						  String [] paramValue)
	{
    ...
    public void setLabel(int scope ,
    					 TagGroup tgroup)
    {
	...
	public void setHInputName(String scope,
	                          String groupID)
	{
	    if (scope == String.valueOf(Scope.SCOPE_GROUP))
	    {
	        this.hinputName = PREFIX.concat(scope).
	        					     concat(IDELIM).
	        					     concat(groupID).
	        					     concat(POSTFIX);
	    }
	...
	public void setAddDeleteTags(Hashtable addTags,
								 Hashtable deleteTags)
	{
		this.addTags = addTags;
		this.deleteTags = deleteTags;
	}

	public void edit(TagBroker broker)
		throws Exception
	{
		Iterator aitr = this.addTags.keySet().iterator();
		while (aitr.hasNext())
		{
		...
		Iterator ditr = this.deleteTags.keySet().iterator();
		while (ditr.hasNext())
		{
    ...
    public void editAdd(String tagName,
    					TagBroker broker)
    	throws Exception
    {
        Tag addtag = new Tag();
    ...
    public void fillTag(Tag addtag,
            		    String tagName)
    {
    ...
    public void editDelete(String tagName,
    					 TagBroker broker)
    	throws Exception
    {
//        System.out.println("--DELETE seting groupID--"+this.groupID);
        broker.deleteTag(tagName,
                  		 Integer.parseInt(this.scope),
                  		 this.userID,
                  		 this.custID,
                  		 this.groupID,
                  		 this.docID);
