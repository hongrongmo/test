...
public class TagBroker
{
    ...
    public String autocompleteTags(String tag,
    							   int scope,
    							   String groupID,
      							   String customerID,
      							   String userID)
    	throws Exception
    {
        ...
        try
        {
            ...
            {
                qbuf = new StringBuffer("SELECT * FROM CONSOLIDATED_TAGS WHERE COUNT>0 AND TAG_SEARCH LIKE '" + tag.toUpperCase() + "%'  AND SCOPE = 2 AND USER_ID = '");
            	qbuf.append(userID);
            	qbuf.append("'");
            }
            else if (scope == Scope.SCOPE_INSTITUTION)
            {
				...
				qbuf = new StringBuffer("SELECT * FROM CONSOLIDATED_TAGS WHERE COUNT>0 AND TAG_SEARCH LIKE '" + tag.toUpperCase() + "%'  AND SCOPE = 4 AND CUSTOMER_ID = '");
			...
			{
				qbuf = new StringBuffer("SELECT * FROM CONSOLIDATED_TAGS WHERE COUNT>0 AND TAG_SEARCH LIKE '" + tag.toUpperCase() + "%'  AND SCOPE = 3 AND GROUP_ID = '");
				qbuf.append(groupID);
				qbuf.append("'");
			}
    ...
    public Tag[] getConsolidatedTags(int count,
    								 int scope,
    								 String userID,
    								 String customerID,
	...
	public PageEntry getPageEntry(String tag,
								  int scope,
								  String userID,
								  String customerID,
								  String groupID,
		...
		throws Exception
	{
		...
		List pageEntries = peb.buildPageEntryList(docs);
	...
	public List getDocIDs(String tag,
						  int scope,
						  String userID,
						  String customerID,
						  String groupID,
	...
	public Tag[] getTags(String docID,
						 String userID,
						 String customerID,
						 Comparator comp)
		throws Exception
	...
	public Tag[] getTags(TagGroup group)
	throws Exception
	{
		ConnectionBroker broker = null;
		Connection con = null;
	...
	private Tag fillTag(ResultSet rset,
						TagGroup group,
    ...
    public String[] getUserTagNames(int scope,
    								String userID,
    								String customerID,
    								String groupID)
    	throws Exception
    ...
    public void updateTagName(String oldtag,
    						  String newtag,
    						  String userID,
    						  String customerID,
    						  String groupID,
    ...
    private void addConsolidatedTag(Tag tag, Operation operation, Connection con)
    	throws Exception
    {
    ...
    private void updateConsolidatedTag(String tagSearch,
    								   int scope,
    								   String userID,
    								   String groupID,
    								   String customerID,
    ...
    private String getConsolidatedTagID(Tag tag)
    	throws Exception
    {
		int scope = tag.getScope();
		String searchTag = tag.getTagSearchValue();
