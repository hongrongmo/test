...
public class EditGrouper
{
    ...
    private LinkedHashMap editGroups = new LinkedHashMap();

    public static final Hashtable groupLabels = new Hashtable();
    ...
    public EditGrouper(String puserID,
            		   String customerID,
            		   String docID)
        throws Exception
    {
...
//					System.out.println(eGroup.getGroupID());
	...
	private String setKey(String scope,
						  String groupID)
	{
    ...
    public StringBuffer jsElemComposer(String inputLabel,
            					       String inputName,
            					       StringBuffer inputValue)
    {
    ...
    public StringBuffer jsDrawSubmitBtn()
    {
	    ...
	    jsbtn.append("\n btnimg.setAttribute(\"type\", \"image\");");
	    jsbtn.append("\n btnimg.setAttribute(\"src\", \"/engresources/tagimages/savechanges_button.gif\");");
	    jsbtn.append("\n btnimg.setAttribute(\"value\", \"Save\");");
	    jsbtn.append("\n btnimg.setAttribute(\"style\", \"vertical-align: middle;\");");
	    jsbtn.append("\n btnimg.setAttribute(\"width\", \"90\");");
	    jsbtn.append("\n btnimg.setAttribute(\"height\", \"19\");");
	    jsbtn.append("\n btnimg.setAttribute(\"alt\", \"Save Changes\");");
	    ...
	    throws Exception
    {
        ...
        Iterator itr = editGroups.keySet().iterator();
        ...
        while (itr.hasNext())
        {
            ...
            jsElemComposer(egroup.getLabel(),
                    	   egroup.getKey(),
				           egroup.getTagNames());
