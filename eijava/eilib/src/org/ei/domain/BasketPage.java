...
/**
*
*	This class has all the methods  required for the Basketpage,
* 	get  the documents in the basket from the particular page,
* 	size of the page which contain how many documents,xml string of the page
* 	and adding of the document to the page.
*
**/
	...
	implements XMLSerializable
{
	...
	* @ param : BasketEntry object.
	* @ return : BasketEntry object.
	*/
	...
	/**
	* This method takes list of BasketEntry and adds each BasketEntry
	* to the List.
	* @ param : List of BasketEntry.
	*/

	public void addAll(List basketEntryList)
		throws IOException
	{
	...
	/**
	* jam - 9/25/2002
	* Added int member m_intPageIndex.   This value is set by DocumentBasket.pageAt()
	* when the page is created and filled with BasketEntries
	* This will ensure correct numbering of BasketEntries when in bulk mode.
	*
	* When not in bulk mode, basket entries are numbered using their positions
	* Removing and then adding entries changes the DocumentBasketHitIndex property
	* and we will reset it when looping through a page.
	* See toXML()
	*/
