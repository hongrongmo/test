...
public abstract class SortField implements Comparable
{
  ...
  public String getDefaultSortDirection() { return Sort.UP; }
  public String[] getAvailableSortDirections() { return new String[]{Sort.UP,Sort.DOWN}; }
