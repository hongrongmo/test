		   ...
		   XMLSerializable
{
	...
	*/
    	...
    	public BasketEntry(DocID oDocId , Query oQuery )
	...
	**/
	...
	public BasketEntry(DocID oDocId,Query oQuery,int iDBasketHitIndex)
		throws InvalidArgumentException
	{
			setDocID(oDocId);
			setQuery(oQuery);
	...
	public BasketEntry(DocID oDocId,Query oQuery,EIDoc oEIDoc,int iDBasketHitIndex)
		throws InvalidArgumentException
	{
			setDocID(oDocId);
			setQuery(oQuery);
	...
	public void setDocumentBasketHitIndex( int iDBasketHitIndex)
		throws InvalidArgumentException
	{
