		   ...
		   XMLSerializable
{
	...
	*/
    	...
    	public FolderEntry(DocID oDocId)
	...
	**/
	...
	public FolderEntry(DocID oDocId,String sFolderEntryHitIndex)
		throws InvalidArgumentException
		{
			setDocID(oDocId);
	...
	public FolderEntry(DocID oDocId,EIDoc oEIDoc,String sFolderEntryHitIndex)
		throws InvalidArgumentException
	{
			setDocID(oDocId);
			setEIDoc(oEIDoc);
	...
	/**
	* jam - 9/24/2002
	* Added new constructor which also takes display index as argument
	*/

	/**
	* This constructor takes DocID ,EIDoc, FolderHitIndex and DisplayIndex as  arguments
	*/
	public FolderEntry(DocID oDocId,EIDoc oEIDoc,String sFolderEntryHitIndex, int intDisplayIndex)
		throws InvalidArgumentException {
			setDocID(oDocId);
			setEIDoc(oEIDoc);
			setFolderEntrytHitIndex(sFolderEntryHitIndex);
	...
	/**
	* jam - 9/24/2002
	* Added int member m_intDisplayIndex.   This value can be set by outer loop
	* while walking the contents of a Folder Page to ensure correct sequential
	* numbering.
	*
	* FolderEntry.getFolderEntryHitIndex() is not proper for number
	* folder contents in result set
	*/
	...
	public void setFolderEntrytHitIndex(String sFolderHitIndex)
		throws InvalidArgumentException
	{
	...
	*/
	...
	/**
	  *The equals method which compares two FolderEntry objects
	  * based on comparable method implementation
	  */
	...
	public boolean equals(Object obj)
	{
   	...
   	/** This method will compare two objects of FolderEntry
   	  * on basis of HitIndex
   	  */

	public int compareTo(Object obj) throws ClassCastException
		{
			FolderEntry paramBEntry = (FolderEntry) obj;
			String  paramBHitIndex = paramBEntry.getFolderEntryHitIndex();
	        String  localBHitIndex  = this.getFolderEntryHitIndex();
	        return localBHitIndex.compareTo(paramBHitIndex);
	}

	/**
	* set localHolding to instance variable.
	* @ param : localHolding.
	*/
