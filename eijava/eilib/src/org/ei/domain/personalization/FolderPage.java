	...
	implements XMLSerializable
{
   ...
   */
	...
	* @ param : FolderEntry object.
	* @ return : FolderEntry object.
	*/
	...
	/**
	* This method takes list of FolderEntry and adds each FolderEntry
	* to the List.
	* @ param : List of FolderEntry.
	*/

   	public void addAll(List aFolderEntryList)
   		throws IOException
   	{
	...
	/**
	* jam - 9/24/2002
	* modified class to set the Display Index as each folder entry is retreived
	* for proper sequential numbering when displaying contents in bulk mode.
	*
	*/
