...
public class PageEntry implements Comparable, XMLSerializable
{
	...
	*/
	...
	public PageEntry(EIDoc doc , boolean isSelected)
	...
	* @return : true - if the document is already in the document basket
	*           false - if the document is not present in the document basket.
	*/
	...
	*/
	...
	/**
	* This method returns the boolean value by comparing the
	* objects.
	...
	* Method is implemented to get Sorted PageEntry list.
