...
public interface LocalHoldingLinker
{
    ...
    public static final String[] localHoldingFields = {AULAST,AUFIRST ,AUFULL,ISSN,ISBN1,ISBN2,ISSN9,CODEN, TITLE,STITLE,ATITLE,CTITLE, VOLUME,ISSUE,SPAGE,EPAGE,PAGES,YEAR,ANUMBER,DOI,ARTNUM,EISSN};
