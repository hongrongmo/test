    ...
    implements XMLSerializable
{
    ...
    public ClassificationID(String classCode,
                            Database database)
    {
        this.classCode = classCode;
        this.database = database;
        if(classCode.indexOf("(") == 0 &&
           classCode.indexOf(")") == (classCode.length() - 1))
        {
            this.optional = true;
    ...
    public boolean equals(Object o)
    {
        ...
        if(c.isInstance(o))
        {
            ...
            if(id.getClassCode().equals(classCode) &&
               id.getDatabase().getID().equals(database.getID()))
            {
                b = true;
            }
            else
