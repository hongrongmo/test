...
public class ChinaLinkBuilder
{
	...
	private List credlist = new ArrayList();

	private Map pubIdUrlHash = new Hashtable();
	...
	public Map getCredUrls()
	{
		Map mapCredUrls = new Hashtable();
	  	Iterator itr = pubIdUrlHash.keySet().iterator();
	  	while(itr.hasNext())
	  	{
