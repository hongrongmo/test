...
public class InspecArchiveAbstractHandler
                 ...
                 Attributes attrs)
    {
        ...
        else if(raw.equals("uidlink"))
        {
            ...
            if(!skip)
            {
                ...
                if(tables)
                {
                    htmlbuf.append("<a CLASS=\"SpLink\" href=\"/controller/servlet/Controller?CID=expertSearchCitationFormat&database=2&startYear=1884&endYear=2005&yearselect=yearrange&searchWord1=");
                }
                state = LINK_NODE;
        ...
        else if(raw.equals("entry"))
        {
            if(!skip)
            {
                ...
                if(align == null && entryNum <= colsIndex)
                {
                    Col col = cols[entryNum];
                    align = col.align;
                }
                */
