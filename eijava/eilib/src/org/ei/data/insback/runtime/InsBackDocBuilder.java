    ...
    implements DocumentBuilder
{
    ...
    private static final Key[] CITATION_KEYS = {Keys.DOCID,Keys.TITLE,Keys.EDITORS,Keys.AUTHORS,Keys.INVENTORS, Keys.REPORT_NUMBER,Keys.NO_SO, Keys.PUBLISHER,Keys.I_PUBLISHER, Keys.SOURCE,Keys.PATASSIGN, Keys.PATAPPNUM, Keys.PATNUM, Keys.PATCOUNTRY, Keys.PAPER_NUMBER, Keys.p_PAGE_RANGE,Keys.PAGE_RANGE_pp, Keys.VOLISSUE, Keys.TRANSLATION_SERIAL_TITLE, Keys.SERIAL_TITLE, Keys.ABBRV_SERIAL_TITLE, Keys.ISSUE_DATE,Keys.LANGUAGE,Keys.DOI,Keys.CODEN, Keys.ISSN, Keys.IMAGES,Keys.COPYRIGHT,Keys.COPYRIGHT_TEXT};
    private static final Key[] ABSTRACT_KEYS = {Keys.DOCID,Keys.TITLE,Keys.EDITORS,Keys.AUTHORS,Keys.INVENTORS,Keys.EDITOR_AFFS, Keys.AUTHOR_AFFS,Keys.VOLISSUE,Keys.NO_SO, Keys.SOURCE,Keys.REPORT_NUMBER,Keys.PATASSIGN, Keys.PATNUM, Keys.PATCOUNTRY, Keys.SERIAL_TITLE,Keys.TRANSLATION_SERIAL_TITLE,Keys.ABBRV_SERIAL_TITLE,  Keys.ISSUE_DATE,Keys.LANGUAGE, Keys.p_PAGE_RANGE, Keys.PAGE_RANGE_pp,Keys.PUBLISHER,Keys.I_PUBLISHER, Keys.PROVIDER , INS_CONTROLLED_TERMS, Keys.UNCONTROLLED_TERMS, Keys.CONFERENCE_NAME, Keys.CONF_DATE, Keys.MEETING_LOCATION, Keys.SPONSOR, Keys.PAPER_NUMBER, Keys.PAGE_COUNT, Keys.PUB_PLACE,Keys.CONF_CODE,Keys.COUNTRY_OF_PUB,Keys.DOI, Keys.ABSTRACT2,Keys.IMAGES,Keys.COPYRIGHT,Keys.COPYRIGHT_TEXT};
    private static final Key[] DETAILED_KEYS = {Keys.ACCESSION_NUMBER, Keys.TITLE, Keys.TITLE_TRANSLATION, Keys.AUTHORS,Keys.INVENTORS, Keys.EDITORS,Keys.PATASSIGN, Keys.PATNUM, Keys.NO_SO, Keys.ISSUING_ORG, Keys.REPORT_NUMBER, Keys.AUTHOR_AFFS, Keys.EDITOR_AFFS, Keys.SOURCE, Keys.SERIAL_TITLE, Keys.ABBRV_SERIAL_TITLE, Keys.VOLUME, Keys.ISSUE,Keys.PUBLICATION_DATE,  Keys.ISSUE_DATE, Keys.PAP_NUMBER, Keys.PAGE_RANGE, Keys.LANGUAGE,  Keys.ASOURCES, Keys.TRANSLATION_SERIAL_TITLE, Keys.TRANSLATION_ABBREVIATED_SERIAL_TITLE, Keys.TRANSLATION_PUBLICATION_DATE, Keys.TRANSLATION_PAGES, Keys.TRANSLATION_COUNTRY_OF_PUB, Keys.TSOURCES, Keys.DOC_TYPE, Keys.PATCOUNTRY, Keys.COUNTRY_OF_PUB, Keys.CONFERENCE_NAME, Keys.CONF_DATE, Keys.MEETING_LOCATION, Keys.CONF_CODE, Keys.SPONSOR, Keys.PUB_PLACE, Keys.PUBLISHER,  Keys.PUB_LOCATION, Keys.ABSTRACT2,Keys.OTHER_INFO,Keys.IMAGES,Keys.CONTROLLED_TERMS, Keys.UNCONTROLLED_TERMS, Keys.CLASS_CODES, Keys.ORIGINAL_CONTROLLED_TERMS, Keys.ORIGINAL_CLASS_CODES, Keys.TREATMENTS, Keys.DISCIPLINES, Keys.DOI, Keys.DOCID, Keys.COPYRIGHT,Keys.COPYRIGHT_TEXT, Keys.PROVIDER };


    private static final Key[] RIS_KEYS = {Keys.RIS_TY, Keys.RIS_LA,Keys.RIS_M1, Keys.RIS_N1, Keys.RIS_Y1, Keys.RIS_Y2,Keys.RIS_AUS, Keys.RIS_A2, Keys.RIS_SE, Keys.RIS_T1, Keys.RIS_T2, Keys.RIS_AD, Keys.RIS_BT, Keys.RIS_JO, Keys.RIS_EDS, Keys.RIS_VL, Keys.RIS_IS, Keys.RIS_PY, Keys.RIS_AN, Keys.RIS_SP, Keys.RIS_EP, Keys.RIS_MD,Keys.RIS_CY, Keys.RIS_PB,Keys.RIS_AB2, Keys.RIS_CVS, Keys.RIS_FLS, Keys.RIS_DO};

    private static final Key[] XML_KEYS = {Keys.DOCID,Keys.COPYRIGHT,Keys.COPYRIGHT_TEXT, Keys.ACCESSION_NUMBER,Keys.TITLE,Keys.EDITORS,Keys.AUTHORS,Keys.INVENTORS, Keys.REPORT_NUMBER,Keys.NO_SO, Keys.PUBLISHER, Keys.SOURCE,Keys.PATASSIGN, Keys.PATAPPNUM, Keys.PATNUM, Keys.PATPUBDATE, Keys.PAPER_NUMBER,Keys.PAGE_RANGE, Keys.p_PAGE_RANGE,Keys.PAGE_RANGE_pp, Keys.PAGE_COUNT, Keys.VOLISSUE, Keys.TRANSLATION_SERIAL_TITLE, Keys.SERIAL_TITLE, Keys.ABBRV_SERIAL_TITLE, Keys.ISSUE_DATE,Keys.LANGUAGE, Keys.CONTROLLED_TERMS, Keys.ISBN, Keys.I_PUBLISHER, Keys.DOI,Keys.CODEN, Keys.ISSN, Keys.IMAGES};
        ...
        try
        {
            ...
            while(rset.next())
            {
                ...
                if(rset.getString("FIG") != null) {
                     ...
                     ht.put(Keys.IMAGES,
                            new Images(Keys.IMAGES, rset.getString("FIG")));
                 }
        ...
        try
        {
            ...
            while(rset.next())
            {
                   ...
                   (strRTYPE.equals("61")||strRTYPE.equals("62")||strRTYPE.equals("63")))
                {
                    ...
                    if(rset.getString("FTTJ") != null) {
                        ht.put(Keys.TRANSLATION_SERIAL_TITLE, new XMLWrapper(Keys.TRANSLATION_SERIAL_TITLE,StringUtil.replaceNullWithEmptyString(rset.getString("FTTJ"))));
                    }
                    if(rset.getString("TTJ") != null) {
                        ht.put(Keys.TRANSLATION_ABBREVIATED_SERIAL_TITLE, new XMLWrapper(Keys.TRANSLATION_ABBREVIATED_SERIAL_TITLE,StringUtil.replaceNullWithEmptyString(rset.getString("TTJ"))));
                    }

                    if(rset.getString("TDATE") != null) {
                        ht.put(Keys.TRANSLATION_PUBLICATION_DATE, new XMLWrapper(Keys.TRANSLATION_PUBLICATION_DATE,StringUtil.replaceNullWithEmptyString(rset.getString("TDATE"))));
                    }
                    ...
                    if(rset.getString("CPUBT") != null) {
                        ht.put(Keys.TRANSLATION_COUNTRY_OF_PUB, new XMLWrapper(Keys.TRANSLATION_COUNTRY_OF_PUB,StringUtil.replaceNullWithEmptyString(rset.getString("CPUBT"))));
                    }
                ...
                if(rset.getString("SORG") != null) {
                    ht.put(Keys.SPONSOR,new XMLWrapper(Keys.SPONSOR ,StringUtil.replaceNullWithEmptyString(StringUtil.replaceNullWithEmptyString(rset.getString("SORG")))));
                }
                ...
                if(!strRTYPE.equals("08")) {
                    ...
                    if(!strPartNo.equals(StringUtil.EMPTY_STRING)) {
                        if(perl.match("/(\\d+)/", strPartNo)) {
                            ht.put(Keys.PAP_NUMBER,new XMLWrapper(Keys.PAP_NUMBER,perl.group(0).toString()));
                        }
                    }
                }
                ...
                {
                    ht.put(Keys.ORIGINAL_CONTROLLED_TERMS,
                           new OCVS(ORIGINAL_INS_CONTROLLED_TERMS, rset.getString("OCVS")));
                }

                // OCLS
                if (rset.getString("OCLS") != null)
                {
                    ht.put(Keys.ORIGINAL_CLASS_CODES,
                           new OCLS(ORIGINAL_INS_CLASS_CODES, rset.getString("OCLS")));
                }
        ...
        try {
            ...
            while(rset.next())
            {
              ...
              //  ht.put(Keys.PROVIDER, new XMLWrapper(Keys.PROVIDER, PROVIDER_TEXT));
                ...
                {
                    ht.put(Keys.DOI,
                           new XMLWrapper(Keys.DOI, StringUtil.replaceNullWithEmptyString(rset.getString("DOI"))));
                }
            ...
            while(rset.next())
            {
                   ...
                   (strRTYPE.equals("61")||strRTYPE.equals("62")||strRTYPE.equals("63")))
               {
                    ...
                    if(rset.getString("VOL") !=null || rset.getString("ISS") !=null)
                    {
                        ...
                        (strRTYPE.equals("40")) ||
                        (strRTYPE.equals("50") && (strFJT.equals(StringUtil.EMPTY_STRING))) ||
                        (strRTYPE.equals("60") && (strFJT.equals(StringUtil.EMPTY_STRING))))
                {
                    if(strTHLP != null && (!strTHLP.equals(StringUtil.EMPTY_STRING))) {
                        ht.put(Keys.SOURCE, new XMLWrapper(Keys.SOURCE, strTHLP));
                ...
                if (rset.getString("PARTNO") != null) {
                    ...
                    ht.put(Keys.PAPER_NUMBER,
                           new XMLWrapper(Keys.PAPER_NUMBER, partNo));
                }
