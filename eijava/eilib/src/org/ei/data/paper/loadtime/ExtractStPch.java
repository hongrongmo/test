...
public class ExtractStPch
{
        ...
        throws Exception
    {
        ...
        try
        {
            ...
            {
                pstmt1  = con.prepareStatement(" select st,sn from paper_master where (st is not null) and load_number >= "+load_number_begin+" and load_number <= "+load_number_end);
                System.out.println("\n\nQuery: "+" select st,sn from paper_master where (st is not null) and load_number >= "+load_number_begin+" and load_number <= "+load_number_end);
            }
