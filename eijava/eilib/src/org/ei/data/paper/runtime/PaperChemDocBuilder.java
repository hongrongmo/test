...
import org.ei.domain.DetailedBuilder;
...
public class PaperChemDocBuilder implements DocumentBuilder
{
	...
	private static final Key[] CITATION_KEYS = {
	        Keys.DOCID,
	        Keys.PATAPPNUM,
	        Keys.PATENT_NUMBER,
	        Keys.PATNUM,
	...
	private static final Key[] ABSTRACT_KEYS = {
	        ...
	        Keys.PAPER_NUMBER,
	        Keys.SOURCE,
	        Keys.PUBLICATION_YEAR_PAPER,
	        Keys.PUBLICATION_DATE_PAPER,
          Keys.ISSUE_DATE,
	        Keys.PAGE_RANGE,
	...
	private static final Key[] XML_KEYS = { Keys.ISSN , Keys.MAIN_HEADING , Keys.NO_SO , Keys.MONOGRAPH_TITLE , Keys.PUBLICATION_YEAR  , Keys.CONTROLLED_TERM , Keys.ISBN , Keys.AUTHORS , Keys.DOCID , Keys.SOURCE , Keys.NUMVOL , Keys.EDITOR_AFFS , Keys.EDITORS , Keys.PUBLISHER , Keys.VOLUME , Keys.AUTHOR_AFFS , Keys.PROVIDER , Keys.ISSUE_DATE , Keys.COPYRIGHT_TEXT , Keys.DOI  , Keys.PUBLICATION_DATE , Keys.TITLE , Keys.LANGUAGE , Keys.PAGE_RANGE , Keys.PAPER_NUMBER , Keys.COPYRIGHT , Keys.ISSUE , Keys.ACCESSION_NUMBER , PAPER_CONTROLLED_TERMS};
        ...
        throws Exception
    {
        ...
        try
        {
            ...
            while(rset.next())
            {
                ...
                if (strTitle != null &&
                        !strTitle.trim().equals(StringUtil.EMPTY_STRING))
                {
              ...
              // AU or EDS
                if (rset.getString("AU") != null)
                {
                  ...
                  /*if(rset.getString("AF") != null) {
                        ht.put(EIDoc.AUTHOR_AFF,StringUtil.replaceNullWithEmptyString(rset.getString("AF")));
                    } */
                }
                else
                {
                    	...
                    	rset.getString("PN") != null )
                    	{
                         	...
                         	rset.getString("SOURC") == null)
                         {
                            ...
                            if(rset.getString("VO") != null)
                            {
                                ...
                                {
                                    ht.put(Keys.VOLUME,
                                        new Volume(StringUtil.replaceNullWithEmptyString(rset.getString("VO")),perl));
                                }
                            }
                ...
                if(rset.getString("PA") != null)
                {
                    ...
                    if (!pa.equals(StringUtil.EMPTY_STRING))
                    {
                        ht.put(Keys.PAPER_NUMBER,
                     	   new XMLWrapper(Keys.PAPER_NUMBER,pa ));
                    }
                }
                        ...
                        (!rset.getString("LA").equalsIgnoreCase("ENGLISH")))
                {
                    ...
                    if (!la.equals(StringUtil.EMPTY_STRING))
                    {
                        ht.put(Keys.LANGUAGE,
                        	   new XMLWrapper(Keys.LANGUAGE ,la));
                    }
                }
                //CF
                        ...
                        (rset.getString("MC") !=null ))
                {
                    ...
                    if (!cfname.equals(StringUtil.EMPTY_STRING))
                    {
                        ht.put(Keys.CONFERENCE_NAME,
                                new XMLWrapper(Keys.CONFERENCE_NAME ,cfname));
                    }
                }
                ...
                if (rset.getString("FL") != null)
                {
                    ...
                    if (!fl.equals(StringUtil.EMPTY_STRING))
                    {
                        ht.put(Keys.UNCONTROLLED_TERMS,
                                new XMLMultiWrapper(Keys.UNCONTROLLED_TERMS, setElementData(fl)));
                    }
                }
                    ...
                    if(perl.match("/(\\d+)/", strREFs))
                    {
                        ...
                        if (!refs.equals(StringUtil.EMPTY_STRING))
                        {
                            ht.put(Keys.NUMBER_OF_REFERENCES,
                                    new XMLWrapper(Keys.NUMBER_OF_REFERENCES, refs ));
                        }
                    }
                }
                ...
                while(rset.next()) {
                    ...
                    if(rset.getString("AN") != null)
                    {
                        ht.put(Keys.ACCESSION_NUMBER,
                                new XMLWrapper (Keys.ACCESSION_NUMBER, rset.getString("AN")));
                    }
                    ...
                    if(rset.getString("TT") != null)
                    {
                        ...
                        if (!tt.equals(StringUtil.EMPTY_STRING) )
                        {
                            ht.put(Keys.TITLE_TRANSLATION,
                        	   new XMLWrapper(Keys.TITLE_TRANSLATION,tt));
                        }
                    }
                    ...
                    {
                            ht.put(Keys.PRIORITY_INFORMATION, new XMLMultiWrapper(Keys.PRIORITY_INFORMATION, setElementData(((formatPriorityInfo(StringUtil.replaceNullWithEmptyString(rset.getString("PRIOR_NUM"))))))));
...
//                       }
                    ...
                    if (rset.getString("DT") != null)
                    {
                        ...
                        if (!dt.equals(StringUtil.EMPTY_STRING))
                        {
                            ht.put(Keys.DOC_TYPE,
                         	   new XMLWrapper(Keys.DOC_TYPE,dt ));
                        }
                    }
                    ...
                    if (rset.getString("CC") != null)
                    {
                        ...
                        if (!cc.equals(StringUtil.EMPTY_STRING))
                        {
                            ht.put(Keys.CONF_CODE,
                               new XMLWrapper(Keys.CONF_CODE, cc));
                        }
                    }
                    ...
                    if (lstTokens.size()>0)
                    {
                        ...
                        if (!pub.equals(StringUtil.EMPTY_STRING))
                        {
                            ht.put(Keys.PUBLISHER,
                                new XMLWrapper(Keys.PUBLISHER,pub));
                        }
				    }
                    lstTokens = null;
                    ...
                    if (rset.getString("AT") != null)
                    {
                        ...
                        {
                            ht.put(Keys.ABSTRACT_TYPE,
                                new XMLWrapper(Keys.ABSTRACT_TYPE,aty));
                        }
                    }
            ...
            throws Exception
    {
            ...
            try
            {
                ...
                while(rset.next())
                {
                    ...
                    {
                        ht.put(Keys.RIS_FLS,
                             new XMLMultiWrapper(Keys.RIS_FLS,setElementData(fls)));
                    }
        ...
        throws Exception
    {
        ...
        try
        {
            ...
            while(rset.next())
            {
                ...
                if (rset.getString("AU") != null)
                {
                	Contributors authors = new Contributors(Keys.AUTHORS,getContributors(StringUtil.replaceNullWithEmptyString(rset.getString("AU")),Keys.AUTHORS));
                	ht.put(Keys.AUTHORS, authors);
                ...
                if("PA".equalsIgnoreCase(strDocType))
                {
                    ...
                    if((rset.getString("ASSIG") != null))
                    {
                        ...
                        List lstAsg = convertString2List(StringUtil.substituteChars(rset.getString("ASSIG")));
                                ...
                                rset.getString("SOURC") == null)
                        {
                            ...
                            // add 'v' or 'n'
                                ...
                                if(rset.getString("VO") != null)
                                {
                                    strVolIss = strVolIss.concat(replaceVolumeNullWithEmptyString(rset.getString("VO")));
                                    if (strVolIss != null &&
                                            !strVolIss.trim().equals(StringUtil.EMPTY_STRING))
                                    {
             ...
             try
             {
                 ...
                 while(rset.next())
                 {
                     ...
                     ht.put(Keys.COPYRIGHT_TEXT, new XMLWrapper(Keys.COPYRIGHT_TEXT,
                             PaperChemDocBuilder.PAPER_TEXT_COPYRIGHT));
