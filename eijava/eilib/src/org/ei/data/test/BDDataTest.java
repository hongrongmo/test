...
public class BDDataTest
{
	...
	public void updateMID(Connection con, String year)
	{
		...
		String sql1= "select m_id,ex,do from cpx_master where ex=?";
		String sql2= "select m_id,ex,do from cpx_doi where do=?";
		String sql3= "update "+tableName+" set m_id =? where accessnumber=? or doi=?";
		StringBuffer updateBuffer = new StringBuffer("update "+tableName+" set m_id ='");
	...
	public void updateMIDWithIVIP(Connection con, String year)
	{
		...
		String sql1= "select accessnumber from "+tableName+" where accessnumber=? or doi=?";
		String sql2= "select accessnumber from "+tableName+" where doi=?";
		String sql3= null;
		ResultSet cpxData = null;
		FileWriter out = null;
		PreparedStatement stmt = null;
		...
		try
		{
			...
			while(rs.next())
			{
				accessionNumber = rs.getString("ex");
				doi = rs.getString("do");
	...
	public void checkData(Connection con, String year)
	{
		...
		String sql1= "select * from cpx_master where ex=? or do=?";
