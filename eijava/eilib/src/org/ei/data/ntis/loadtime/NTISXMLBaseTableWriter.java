			...
			for(int j=0; j<baseTableFields.length; j++)
			{
				...
				if(record != null)
				{
					...
					else if(bf.equals("CAT"))											//CAT
					{
						...
						String[] catArray = value.split(NTISParser.AUDELIMITER);
					...
					else if(bf.equals("IC"))											//IC
					{
						...
						if(value!=null)
						{
							if(value.indexOf(NTISParser.AUDELIMITER)>-1)
							{
								value = value.replaceAll(NTISParser.AUDELIMITER,"/");
							}
						...
						{
							String[] countryArray = value.split(NTISParser.AUDELIMITER);
						...
						if(value!=null && value.length()>0)
						{
							String[] languageArray = value.split(NTISParser.AUDELIMITER);
					...
					else if(bf.equals("SO"))										//SO
					{
						...
						if(value!=null && value.length()>0)
						{
							String[] secondaryAuthorArray = value.split(NTISParser.AUDELIMITER);
						...
						String[] sponsorAuthorArray = value.split(NTISParser.AUDELIMITER);
					...
					else if(bf.equals("PA1"))											//PA1
					{
						...
						String[] pa1Array = value.split(NTISParser.AUDELIMITER);
						for(int i=0;i<pa1Array.length;i++)
						{
							...
							else if((pa2Buffer.length()+singlePa1.length())<3999)
							{
								...
								{
									pa2Buffer.append(NTISParser.AUDELIMITER);
								}
							}
							else if((pa3Buffer.length()+singlePa1.length())<3999)
							{
								...
								if(i<pa1Array.length-1)
								{
									pa3Buffer.append(NTISParser.AUDELIMITER);
								}
							}
							else if((pa4Buffer.length()+singlePa1.length())<3999)
							{
								...
								if(i<pa1Array.length-1)
								{
									pa4Buffer.append(NTISParser.AUDELIMITER);
								}
							}
							else if((pa5Buffer.length()+singlePa1.length())<3999)
							{
								...
								if(i<pa1Array.length-1)
								{
									pa5Buffer.append(NTISParser.AUDELIMITER);
								}
							}
					...
					else if(bf.equals("CT"))										//CT
					{
						...
						if(value!=null && value.length()>0)
						{
							...
							{
								ctBuffer.append(NTISParser.AUDELIMITER);
							}
					...
					else if(bf.equals("TNUM"))											//TNUM
					{
						...
						if(value!=null && value.length()>0)
						{
							String[] taskNumberArray = value.split(NTISParser.AUDELIMITER);
					...
					else if(bf.equals("DES"))											//DES
					{
						...
						if(value!=null && value.length()>0)
						{
							value="Descriptors: "+value.replaceAll(NTISParser.AUDELIMITER,", ");
						}
					...
					else if(bf.equals("IDE"))											//IDE
					{
						...
						if(value!=null && value.length()>0)
						{
							value="Identifiers: "+value.replaceAll(NTISParser.AUDELIMITER,", ");
						}
