			...
			if(ntisRoot != null)
			{
				...
				if(record!= null)
				{
					...
					for(int i=0;i<categoryCodeList.size();i++)
					{
						...
						{
							categoryCodeBuffer.append(AUDELIMITER);
						}
					}
					...
					for(int i=0;i<sourceCodeList.size();i++)
					{
						...
						{
							sourceCodeBuffer.append(AUDELIMITER);
						}
					}
					...
					for(int i=0;i<countryCodeList.size();i++)
					{
						...
						{
							countryCodeBuffer.append(AUDELIMITER);
						}
					}
					...
					for(int i=0;i<languageCodeList.size();i++)
					{
						...
						{
							languageCodeBuffer.append(AUDELIMITER);
						}
					}
					...
					for(int i=0;i<mediaList.size();i++)
					{
						...
						{
							mediaBuffer.append(AUDELIMITER);
						}
					}
					...
					for(int i=0;i<secondaryAuthorList.size();i++)
					{
						...
						{
							secondaryAuthorBuffer.append(AUDELIMITER);
						}
					}
					...
					for(int i=0;i<sponsorAuthorList.size();i++)
					{
						...
						{
							sponsorAuthorBuffer.append(AUDELIMITER);
						}
					}
					...
					for(int i=0;i<personalAuthorList.size();i++)
					{
						...
						{
							personalAuthorBuffer.append(AUDELIMITER);
						}
					}
					...
					for(int i=0;i<reportNumberList.size();i++)
					{
						...
						{
							reportNumberBuffer.append(AUDELIMITER);
						}
					}
					...
					for(int i=0;i<orderNumberList.size();i++)
					{
						...
						{
							orderNumberBuffer.append(AUDELIMITER);
						}
					}
					...
					for(int i=0;i<grantNumberList.size();i++)
					{
						...
						{
							grantNumberBuffer.append(AUDELIMITER);
						}
					}
					...
					for(int i=0;i<contractNumberList.size();i++)
					{
						...
						{
							contractNumberBuffer.append(AUDELIMITER);
						}
					}
					...
					for(int i=0;i<projectNumberList.size();i++)
					{
						...
						{
							projectNumberBuffer.append(AUDELIMITER);
						}
					}
					...
					for(int i=0;i<taskNumberList.size();i++)
					{
						...
						{
							taskNumberBuffer.append(AUDELIMITER);
						}
					}
					...
					for(int i=0;i<monitorAgencyNumberList.size();i++)
					{
						...
						{
							monitorAgencyNumberBuffer.append(AUDELIMITER);
						}
					}
					...
					for(int i=0;i<descriptorList.size();i++)
					{
						...
						{
							descriptorBuffer.append(AUDELIMITER);
						}
					}
					...
					for(int i=0;i<identifierList.size();i++)
					{
						...
						{
							identifierBuffer.append(AUDELIMITER);
						}
					}
