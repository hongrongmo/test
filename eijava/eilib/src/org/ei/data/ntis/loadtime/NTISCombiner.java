	...
	extends Combiner
{
    	...
    	throws Exception
    {
        ...
        try
        {
            ...
            String q = "select LOAD_NUMBER,M_ID,AN,TI,TN,PN,AB,IC,SU,DES,IDE,SO,PA1,PA2,PA2,PA3,PA4,PA5,RD,RN,CAT,VI,XP,AV,MAA1,MAA2,CT,PR,HN from " + Combiner.TABLENAME + " where load_number like '" + year + "%'";
