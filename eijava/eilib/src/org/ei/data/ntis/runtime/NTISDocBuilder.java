...
* a List of EIDocs from a List of DocIds.The input is
* list of docids come from NTISSearchControl
*
*/
public class NTISDocBuilder implements DocumentBuilder
{
    public static String NTIS_TEXT_COPYRIGHT = "Compiled and Distributed by the NTIS, U.S. Department of Commerce.  It contains copyrighted material.  All rights reserved. 2007";
    ...
    private static final Key NTIS_CORPORATE_SOURCE_CODES = new Key(Keys.CORPORATE_SOURCE_CODES, "Author affiliation codes");
    ...
    private static final Key[] CITATION_KEYS = {Keys.DOCID,Keys.TITLE,Keys.AUTHORS, Keys.PERFORMER , Keys.NO_SO, Keys.RSRCH_SPONSOR, Keys.PAGE_RANGE ,Keys.PUBLICATION_YEAR,Keys.LANGUAGE,  Keys.RN_LABEL,Keys.COPYRIGHT,Keys.COPYRIGHT_TEXT};
    private static final Key[] ABSTRACT_KEYS = {Keys.DOCID,Keys.TITLE,Keys.AUTHORS, Keys.PERFORMER ,Keys.NO_SO, Keys.AUTHOR_AFFS,  Keys.RSRCH_SPONSOR,Keys.PUBLICATION_YEAR, Keys.PATFILDATE, Keys.PAGE_RANGE, Keys.PUBLISHER, Keys.PROVIDER ,Keys.LANGUAGE, Keys.CONTROLLED_TERMS, Keys.UNCONTROLLED_TERMS, Keys.ABSTRACT, Keys.RN_LABEL,Keys.COPYRIGHT,Keys.COPYRIGHT_TEXT};
    private static final Key[] DETAILED_KEYS = {Keys.ACCESSION_NUMBER,Keys.TITLE, Keys.TITLE_ANNOTATION,Keys.AUTHORS, Keys.PERFORMER, Keys.CORPORATE_SOURCE_CODES, Keys.RSRCH_SPONSOR, Keys.RN_LABEL, Keys.PATFILDATE, Keys.PATENT_ISSUE_DATE, Keys.PUBLICATION_DATE , Keys.PAGE_RANGE, Keys.LANGUAGE, Keys.COUNTRY, Keys.DOC_TYPE, Keys.NOTES, Keys.ABSTRACT, Keys.AVAILABILITY, Keys.PRICES, Keys.CONTRACT_NUMBERS, Keys.PROJECT_NUMBER, Keys.TASK_NUMBER, Keys.MONITORING_AGENCIES, Keys.JOURNAL_ANNOUNCEMENT, Keys.CONTROLLED_TERMS, Keys.UNCONTROLLED_TERMS, Keys.CLASS_CODES,Keys.DOCID, Keys.COPYRIGHT,Keys.COPYRIGHT_TEXT};
    private static final Key[] RIS_KEYS = {Keys.RIS_AD , Keys.RIS_AN , Keys.RIS_AUS , Keys.RIS_AV , Keys.RIS_CVS , Keys.RIS_CY , Keys.RIS_FLS , Keys.RIS_IS , Keys.RIS_LA , Keys.RIS_N1 , Keys.RIS_N2 , Keys.RIS_PB , Keys.RIS_PY , Keys.RIS_SP , Keys.RIS_T1 , Keys.RIS_T2 , Keys.RIS_TY , Keys.RIS_U1 , Keys.RIS_U3 , Keys.RIS_U4 , Keys.RIS_U5,  Keys.BIB_TY};
    private static final Key[] XML_KEYS = {Keys.DOCID,Keys.PROVIDER,Keys.COPYRIGHT,Keys.COPYRIGHT_TEXT,Keys.TITLE, Keys.ACCESSION_NUMBER, Keys.NO_SO,Keys.AUTHORS, Keys.PERFORMER, Keys.RSRCH_SPONSOR, Keys.PUBLICATION_YEAR, Keys.PAGE_COUNT, Keys.RN_LABEL, Keys.ACCESSION_NUMBER, Keys.LANGUAGE, Keys.CONTROLLED_TERMS};
...
/*
    ...
    static
    {
        ...
        m_labels.put("TA","Title annotation");
        m_labels.put("AUS","Authors");
  ?????      m_labels.put("PF","Author affiliation");
        m_labels.put("CAC","Author affiliation codes");
        m_labels.put("RSP","Sponsor");
        ...
        m_labels.put("CO","Country of origin");
        m_labels.put("DT","Document type");
        m_labels.put("SU","Notes");
        m_labels.put("AB","Abstract");
        m_labels.put("AV","Availability");
        m_labels.put("PS",PROVIDER+" price code");
        m_labels.put("CTS","Contract number");
        m_labels.put("PNUM","Project number");
        m_labels.put("TNUM","Task number");
        m_labels.put("AGS","Monitoring agency");
        m_labels.put("VI","Journal announcement");
...
*/
    ...
    */
            ...
            try
            {
                ...
                while(rset.next())
                {
                    ...
                    ht.put(Keys.COPYRIGHT,new XMLWrapper(Keys.COPYRIGHT,
                                            NTISDocBuilder.NTIS_HTML_COPYRIGHT));
                    ht.put(Keys.COPYRIGHT_TEXT, new XMLWrapper(Keys.COPYRIGHT_TEXT,
                                            NTISDocBuilder.NTIS_TEXT_COPYRIGHT));
                    // get title
    ...
    //AUS
                    ...
                    {
                        String aus = NTISAuthor.formatAuthors(rset.getString("PA1"),
                                                              rset.getString("PA2"),
                                                              rset.getString("PA3"),
                                                              rset.getString("PA4"),
                                                              rset.getString("PA5"),
                        ...
                        if (aus != null)
                        {
                            Contributors authors = new Contributors(Keys.AUTHORS,
                                                                getContributors(aus, Keys.AUTHORS));
                            ht.put(Keys.AUTHORS, authors);
                        }
                    }
                     // get author affiliation: performer and sponsor
                    Map pAndS = NTISData.authorAffiliationAndSponsor(rset.getString("SO"));
        ...
        try
        {
            ...
            while(rset.next())
            {
                ...
                ht.put(Keys.PROVIDER,
                       new XMLWrapper(Keys.PROVIDER, PROVIDER));

                ht.put(Keys.COPYRIGHT,
                        new XMLWrapper(Keys.COPYRIGHT, NTIS_HTML_COPYRIGHT));

                ht.put(Keys.COPYRIGHT_TEXT,
                       new XMLWrapper(Keys.COPYRIGHT_TEXT, NTIS_TEXT_COPYRIGHT));
                ...
                if(rset.getString("DES") != null)
                {
                    ...
                    ht.put(Keys.CONTROLLED_TERMS ,
                           new XMLMultiWrapper(NTIS_CONTROLLED_TERMS, setElementData(descriptors)));
                }
            ...
            while(rset.next()) {
                ...
                if(rset.getString("AN") != null)
                {
                    ...
                    ht.put(Keys.ACCESSION_NUMBER,
                               new XMLWrapper (Keys.ACCESSION_NUMBER, accNum));
                }
                ...
                if(rset.getString("TI") != null)
                {
                    String title = NTISData.formatTitle(rset.getString("TI"));
                    ht.put(Keys.TITLE,
                           new XMLWrapper(Keys.TITLE,title));
                }
                ...
                if(rset.getString("RD") != null)
                {
                    ...
                    if(perl.match("#filed([^,]*),#i",date))
                    {
                        ...
                        ht.put(Keys.PATFILDATE,
                                        new Year(NTISData.formatDate(strPatApp), perl));
                     }
                    ...
                    if(perl.match("#patented([^,]*),#i",date))
                    {
                        ...
                        ht.put(Keys.PATENT_ISSUE_DATE,
                                        new Year(NTISData.formatDate(strPatIss), perl));
                    }
                    ...
                    if(StringUtil.EMPTY_STRING.equals(strPatApp) &&
                            StringUtil.EMPTY_STRING.equals(strPatIss))
                    {
                ...
                if(rset.getString("RN") != null)
                {
                    ...
                    if((rn !=  null) && !(rn.equals(StringUtil.EMPTY_STRING))) {
                        ht.put(Keys.REPORT_NUMBER,
                                            new XMLWrapper(Keys.REPORT_NUMBER, rn));
                    }
                }
                ...
                if(rset.getString("CT") != null)
                {
                    ...
                    {
                        ht.put(Keys.CONTRACT_NUMBERS,
                                        new XMLWrapper(Keys.CONTRACT_NUMBERS, ct));
                    }
                }
                ...
                if(rset.getString("PN") != null)
                {
                    ...
                    {
                        ht.put(Keys.PROJECT_NUMBER,
                                        new XMLWrapper(Keys.PROJECT_NUMBER, pnum));
                    }
                }
                ...
                if(rset.getString("TNUM") != null)
                {
                    ...
                    {
                        ht.put(Keys.TASK_NUMBER,
                                        new XMLWrapper(Keys.TASK_NUMBER, tnum));
                    }
                }
                ...
                if(strAGs != null)
                {
                    ht.put(Keys.MONITORING_AGENCIES,
                                    new XMLWrapper(Keys.MONITORING_AGENCIES, strAGs));
                }
        ...
        throws Exception
    {
        ...
        try
        {
            ...
            while(rset.next())
            {
                ...
                ht.put(Keys.RIS_TY,new XMLWrapper(Keys.RIS_TY,
                                                replaceTYwithRIScode(rset.getString("TN"))));
                  // always article
                ...
                if(rset.getString("AN") != null)
                {
                    ...
                    {
                        ht.put(Keys.RIS_U1,
                                    new XMLWrapper(Keys.RIS_U1,accNum));
                    }
                }
                ...
                if(rset.getString("IDE") != null)
                {
                    ...
                    ht.put(Keys.RIS_FLS,
                            new XMLMultiWrapper(Keys.RIS_FLS, setElementData(ide)));
                }
                ...
                if(rset.getString("RN") != null)
                {
                    ...
                    {
                        ht.put(Keys.RIS_U3,
                                 new XMLWrapper(Keys.RIS_U3,rn));
                    }
                }

                List lst_CT_PN_TNUM = new ArrayList();
                // get contract number
                if(rset.getString("CT") != null)
                {
                    String ct = NTISData.stripOutBracket(rset.getString("CT"));
                ...
                {
                    ht.put(Keys.RIS_U4,
                             new XMLWrapper(Keys.RIS_U4,StringUtil.join(lst_CT_PN_TNUM,", ")));
                }
                lst_CT_PN_TNUM = null;
                ...
                {
                    ht.put(Keys.RIS_U5,
                             new XMLWrapper(Keys.RIS_U5,rset.getString("SU")));
                }

                ht.put(Keys.RIS_N1,
                         new XMLWrapper(Keys.RIS_N1,NTIS_TEXT_COPYRIGHT));
