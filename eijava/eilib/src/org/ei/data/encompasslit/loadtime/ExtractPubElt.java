...
public class ExtractPubElt {
    ...
    //            System.out.println("\n\nQuery: " + " select pub from elt_master where pub is not null ");
                ...
                pstmt1 = con.prepareStatement(" select pub from elt_master where pub is not null and load_number >= " + load_number_begin + " and load_number <= " + load_number_end);
    //            System.out.println("\n\nQuery: " + " select pub from elt_master where pub is not null and load_number >= " + load_number_begin + " and load_number <= " + load_number_end);
            }
