...
public class ECLAClassParser {
    ...
    Map seekMap = new HashMap();
    static Hashtable rootEclaNodes = new Hashtable();
    ...
    public ECLAClassParser(ClassNode rootNode, Map nodeMapper) {
    ...
    public void startCLASS(Attributes al) {
        ...
        if (level != null && level.equals("2")) {
            ...
            Stack st = (Stack) nodeMap.get(String.valueOf(level));
            ...
            Stack st = (Stack) nodeMap.get(String.valueOf("2"));
            level3Node = (ClassNode) st.peek();
            level3Node.addChild(level4Node);

            st = (Stack) nodeMap.get(String.valueOf(level));
    ...
    class SubClassParser {
        ...
        public SubClassParser(ClassNode parentNode, Map nodeMapper) {
            super();
        ...
        public void startCLASS(Attributes al) {
            ...
            try {
                ...
                if (level.equals("5")) {
                    ...
                    Stack st = (Stack) classMap.get(String.valueOf(level));
                    ...
                    st = (Stack) classMap.get(String.valueOf(depth));
