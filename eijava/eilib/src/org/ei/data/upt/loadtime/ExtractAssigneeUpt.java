...
public class ExtractAssigneeUpt
{
        ...
        throws Exception
    {
        ...
        try
        {
            ...
            {
                pstmt1  = con.prepareStatement("select ac,inv,asg,py from upt_master where (asg is not null) and load_number >= "+load_number_begin+" and load_number <= "+load_number_end);
                System.out.println("\n\nQuery: "+" select ac,inv,asg,py from upt_master where (asg is not null) and load_number >= "+load_number_begin+" and load_number <= "+load_number_end);
            }
    ...
    private String[] prepareAssignee(String aString)
        throws Exception
    {
