...
/**
 * The purpose of the class is to handle all SAX events and disptach the request to the
 * appropriate handler.
 */
public class SaxBaseHandler extends DefaultHandler implements ErrorHandler {
    private Vector vTags = null;
    ...
    Hashtable htMethods = new Hashtable();
    ...
    ***********************************************/
    ...
    /**
     * This call back method gets executed when the closing tag for the root node
     * is encountered.
     */
     ...
     *
     * @param oHandler - The object handler.
     * @param sMethodName - The method name.
     * @param clArgs - The method arguments.
     */
