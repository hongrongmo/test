...
public class testExtractCLSCbn
{
    ...
    public void extract(Connection con)
        throws Exception
    {
        ...
        try
        {
            ...
            pstmt1  = con.prepareStatement("select CLASSIFICATION,CLASSIFICATION_DESCRIPTION from geo_master where (classification is not null) and (CLASSIFICATION_DESCRIPTION is not null)");
            System.out.println("\n\nQuery: "+" select classification,classification_description from geo_master where (classification is not null) and (classification_description is not null)");
