...
java org.ei.data.geobase.GeobaseCombiner jdbc:oracle:thin:@206.137.75.51:1521:EI  oracle.jdbc.driver.OracleDriver ap_ev_search ei3it 200601 50000 1500000 geo_master
