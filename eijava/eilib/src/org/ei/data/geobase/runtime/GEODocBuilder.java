    ...
    implements DocumentBuilder
{
    ...
    private static final Key[] ABSTRACT_KEYS = {Keys.DOCID,Keys.TITLE,Keys.EDITORS,Keys.AUTHORS,Keys.EDITOR_AFFS, Keys.AUTHOR_AFFS,Keys.VOLISSUE, Keys.SOURCE, Keys.PUBLICATION_YEAR, Keys.ISSUE_DATE, Keys.MONOGRAPH_TITLE, Keys.PAGE_RANGE,Keys.ARTICLE_NUMBER,Keys.CONFERENCE_NAME, Keys.ISSN, Keys.E_ISSN, Keys.ISBN, Keys.CODEN, Keys.PUBLISHER,Keys.I_PUBLISHER,Keys.CONF_DATE,Keys.SPONSOR, Keys.PROVIDER ,Keys.LANGUAGE, Keys.MAIN_HEADING, Keys.INDEX_TERM, Keys.SPECIES_TERMS, Keys.REGION_CONTROLLED_TERMS, Keys.GLOBAL_TAGS, Keys.PRIVATE_TAGS, Keys.ABSTRACT, Keys.CLASS_CODES, Keys.NUMBER_OF_REFERENCES,Keys.NO_SO, GRFDocBuilder.COORDINATES, Keys.COPYRIGHT,Keys.COPYRIGHT_TEXT };
    private static final Key[] DETAILED_KEYS = {Keys.ACCESSION_NUMBER,Keys.TITLE, Keys.TITLE_TRANSLATION, Keys.AUTHORS, Keys.EDITORS, Keys.AUTHOR_AFFS, Keys.EDITOR_AFFS, Keys.CORRESPONDENCE_PERSON,Keys.SERIAL_TITLE, Keys.ABBRV_SERIAL_TITLE, Keys.VOLUME, Keys.ISSUE, Keys.MONOGRAPH_TITLE, Keys.ISSUE_DATE, Keys.PUBLICATION_YEAR, Keys.PAGE_RANGE, Keys.PAGE_COUNT, Keys.ARTICLE_NUMBER, Keys.LANGUAGE, Keys.ISSN, Keys.E_ISSN, Keys.CODEN, Keys.ISBN, Keys.DOC_TYPE, Keys.SOURCE_COUNTRY, Keys.CONFERENCE_NAME, Keys.CONF_DATE, Keys.MEETING_LOCATION, Keys.CONF_CODE, Keys.SPONSOR, Keys.PUBLISHER, Keys.ABSTRACT, Keys.ABSTRACT_TYPE, Keys.NUMBER_OF_REFERENCES, Keys.MAIN_HEADING, Keys.CONTROLLED_TERMS, Keys.SPECIES_TERMS, Keys.REGION_CONTROLLED_TERMS, Keys.CLASS_CODES, Keys.TREATMENTS, Keys.GLOBAL_TAGS, Keys.PRIVATE_TAGS, Keys.DOI, Keys.DOCID, GRFDocBuilder.COORDINATES, Keys.COPYRIGHT, Keys.COPYRIGHT_TEXT,Keys.PROVIDER};
            ...
            while(rset.next())
            {
                ...
                if(rset.getString("ACCESSION_NUMBER") != null)
                {
                    ht.put(Keys.ACCESSION_NUMBER,
                           new XMLWrapper (Keys.ACCESSION_NUMBER, rset.getString("ACCESSION_NUMBER")));
                }
                ...
                String year = getYear(  rset.getString("SOURCE_PUBLICATIONYEAR"),
                                        rset.getString("SOURCE_PUBLICATIONDATE"),
                ...
                if (rset.getString("AUTHORS") != null)
                {
                    ...
                    if (rset.getString("AUTHOR_AFFILIATION") != null)
                    {
                        ...
                        List affiliationList = getContributorsAff(  Keys.AUTHOR_AFFS,
                                                                    affiliation,
                                                                    affiliationAddress,
                                                                    affiliationCity,
                                                                    affiliationState,
                ...
                if(rset.getString("SOURCE_TITLE") != null ||
                   rset.getString("ABBR_SOURCETITLE") != null ||
                   ...
                   rset.getString("PUBLISHER_NAME") != null )
                {
                    ...
                    else if(    rset.getString("SOURCE_TITLE") == null &&
                                rset.getString("ABBR_SOURCETITLE") == null &&
                                rset.getString("ISSUE_TITLE") != null)
                    {
                ...
                if (rset.getString("CLASSIFICATION") != null)
                {
                    ht.put(Keys.CLASS_CODES,
                           new Classifications(GEO_CLASS_CODES, setElementData(rset.getString("CLASSIFICATION")), this.database));
                }
            ...
            throws Exception
        {
            ...
            try
            {
                ...
                while(rset.next())
                {
                    ...
                    {
                        ht.put(Keys.TITLE,
                               new XMLWrapper(Keys.TITLE,rset.getString("CITATION_TITLE")));
                    }

                    if(rset.getString("TRANSLATED_TITLE") != null)
                    {
                        ht.put(Keys.TITLE_TRANSLATION,
                               new XMLWrapper(Keys.TITLE_TRANSLATION,rset.getString("TRANSLATED_TITLE")));
                    }
                    ...
                    if (rset.getString("AUTHORS") != null)
                    {
                        ...
                        if (rset.getString("AUTHOR_AFFILIATION") != null)
                        {
                            ...
                            List affiliationList = getContributorsAff(Keys.AUTHOR_AFFS,affiliation,affiliationAddress,affiliationCity,affiliationState,affiliationCountry);
                            ht.put(Keys.AUTHOR_AFFS, new Affiliations(Keys.AUTHOR_AFFS, affiliationList));
                        }
                    ...
                    {
                        ht.put(Keys.SOURCE_COUNTRY,
                               new XMLWrapper(Keys.SOURCE_COUNTRY, getCountry(rset.getString("SOURCE_COUNTRY"))));
                    }
                    ...
                    if(rset.getString("SOURCE_PUBLICATIONDATE") != null)
                    {
                        ht.put(Keys.ISSUE_DATE,
                               new XMLWrapper(Keys.ISSUE_DATE,rset.getString("SOURCE_PUBLICATIONDATE")));
                    }
                    ...
                    if (rset.getString("ISSUE_TITLE") != null)
                    {
                        ht.put(Keys.MONOGRAPH_TITLE,
                               new XMLWrapper(Keys.MONOGRAPH_TITLE,rset.getString("ISSUE_TITLE")));
                    }
                    ...
                    if (rset.getString("VOLUME_TITLE") != null)
                    {
                        ht.put(Keys.VOLUME_TITLE,
                               new XMLWrapper(Keys.VOLUME_TITLE ,rset.getString("VOLUME_TITLE")));
                    }
                    ...
                    if (rset.getString("REPORT_NUMBER") != null)
                    {
                        ...
                        ht.put(Keys.REPORT_NUMBER,
                               new XMLWrapper(Keys.REPORT_NUMBER ,rset.getString("REPORT_NUMBER")));
                    }
                    ...
                    if(language != null)
                    {
                        ht.put(Keys.LANGUAGE,
                               new XMLWrapper(Keys.LANGUAGE ,getLanguage(language)));
                    }
                    ...
                    {
                        ht.put(Keys.ISSN,
                               new ISSN(getIssnWithDash(rset.getString("ISSN"))));
                    }
                    ...
                    {
                        ht.put(Keys.CODEN,
                               new XMLWrapper(Keys.CODEN ,rset.getString("CODEN")));
                    }
                    ...
                    {
                        ht.put(Keys.ISBN,
                               new ISBN(firstElement(rset.getString("ISBN"))));
                    }
                    ...
                    if (rset.getString("CONFERENCE_NAME") != null)
                    {
                        ht.put(Keys.CONFERENCE_NAME,
                                new XMLWrapper(Keys.CONFERENCE_NAME ,rset.getString("CONFERENCE_NAME")));
                    }
                    ...
                    if(lstMeetLoc.size() > 0)
                    {
                        ht.put(Keys.MEETING_LOCATION,
                               new XMLWrapper(Keys.MEETING_LOCATION, StringUtil.join(lstMeetLoc,", ")));
                    }
                    ...
                    if (rset.getString("CONFERENCE_CODE") != null)
                    {
                        ht.put(Keys.CONF_CODE,
                               new XMLWrapper(Keys.CONF_CODE, rset.getString("CONFERENCE_CODE")));
                    }
                    ...
                    if (rset.getString("ABSTRACT_SOURCE") != null)
                    {
                        ht.put(Keys.ABSTRACT_TYPE,
                               new XMLWrapper(Keys.ABSTRACT_TYPE,rset.getString("ABSTRACT_SOURCE")));
                    }
                    ...
                    {
                        ht.put(Keys.CLASSIFICATION_SUBJECT,
                               new XMLWrapper(Keys.CLASSIFICATION_SUBJECT ,classificationSubject));
                    }
                    ...
                    if ((rset.getString("DESCRIPTOR_MAINTERM_GDE") != null))
                    {
                        ht.put(Keys.CONTROLLED_TERMS ,
                               new XMLMultiWrapper(Keys.INDEX_TERM, setElementData(rset.getString("DESCRIPTOR_MAINTERM_GDE"))));
                    }
                    ...
                    if ((rset.getString("DESCRIPTOR_MAINTERM_RGI") != null))
                    {
                      ht.put(Keys.REGION_CONTROLLED_TERMS, new XMLMultiWrapper(Keys.REGION_CONTROLLED_TERMS, setElementData(rset.getString("DESCRIPTOR_MAINTERM_RGI"))));
            ...
            throws Exception
    {
            ...
            try
            {
                ...
                while(rset.next())
                {
                    ...
                    {
                        ht.put(Keys.RIS_LA,
                                new XMLWrapper(Keys.RIS_LA,getLanguage(language)));
                    }
                    ...
                    if (rset.getString("AUTHORS") != null)
                    {
                        ...
                        if (rset.getString("AUTHOR_AFFILIATION") != null)
                        {
                            ...
                            String affiliationState = rset.getString("AUTHOR_AFFILIATION_STATE");
                            String affiliationCountry = rset.getString("AUTHOR_AFFILIATION_COUNTRY");
                            List affiliationList = getContributorsAff(  Keys.RIS_AD,
                                                                        affiliation,
                                                                        affiliationAddress,
                                                                        affiliationCity,
                                                                        affiliationState,
                    ...
                    {
                        ht.put(Keys.RIS_CY,
                                new XMLWrapper(Keys.RIS_CY, StringUtil.join(lstMeetLoc,", ")));
                    }
  ...
  /**
            ...
            while(rset.next())
            {
                   ...
                   rset.getString("PUBLISHER_NAME") != null )
                {
                    ...
                    if(rset.getString("SOURCE_VOLUME") != null)
                    {
                        strVolIss = strVolIss.concat(rset.getString("SOURCE_VOLUME"));
                        ht.put(Keys.VOLUME,
                               new Volume(Keys.VOLUME, rset.getString("SOURCE_VOLUME"), perl));
                    }
                        ...
                        rset.getString("ABBR_SOURCETITLE") != null)
                    {
                        ...
                        {
                            ht.put(Keys.SOURCE,
                                    new XMLWrapper(Keys.SOURCE, rset.getString("SOURCE_TITLE")));
                        }
                        else if(rset.getString("ABBR_SOURCETITLE") != null)
                        {
                            ht.put(Keys.SOURCE,
                                       new XMLWrapper(Keys.SOURCE, rset.getString("ABBR_SOURCETITLE")));
                        }
                            ...
                            (rset.getString("ISSUE_TITLE") != null))
                    {
                        ...
                        {
                            ht.put(Keys.SOURCE,
                                       new XMLWrapper(Keys.SOURCE, rset.getString("ISSUE_TITLE")));
                        }
                    }
                    else if (rset.getString("SOURCE_TITLE") == null &&
                                rset.getString("ABBR_SOURCETITLE") == null &&
                ...
                else if (rset.getString("SOURCE_PUBLICATIONYEAR") != null)
                {
                            ...
                            rset.getString("PUBLISHER_NAME") == null)
                    {
                        ...
                        ht.put(Keys.PUBLICATION_DATE,
                                   new Year(rset.getString("SOURCE_PUBLICATIONYEAR"), perl));
                    }
                    else
                    {
                      // else just store the date
                ...
                if(rset.getString("REPORT_NUMBER") != null)
                {
                    ht.put(Keys.PAPER_NUMBER,
                           new XMLWrapper(Keys.PAPER_NUMBER, rset.getString("REPORT_NUMBER")));
                }
                ...
                if(rset.getString("ABBR_SOURCETITLE") != null)
                {
                    ht.put(Keys.ABBRV_SERIAL_TITLE,
                               new XMLWrapper(Keys.ABBRV_SERIAL_TITLE, rset.getString("ABBR_SOURCETITLE")));
                }
                ...
                if(rset.getString("SOURCE_TITLE") != null)
                {
                    ht.put(Keys.SERIAL_TITLE,
                               new XMLWrapper(Keys.SERIAL_TITLE, rset.getString("SOURCE_TITLE")));
                }
                 //BN
                if (rset.getString("ISBN") != null)
                {
    ...
    */
            ...
            throws Exception
        {
            ...
            try
            {
                ...
                while(rset.next())
                {
                    ...
                    // SO
                    if(rset.getString("SOURCE_TITLE") != null || rset.getString("ABBR_SOURCETITLE") != null ||
                       rset.getString("ISSUE_TITLE")  != null || rset.getString("PUBLISHER_NAME") != null )
                    {
                    ...
                    // an MT or VT can accompany the ST (or SE)
                        ...
                        (
                                rset.getString("SOURCE_TITLE") == null &&
                                rset.getString("ABBR_SOURCETITLE") == null &&
                                rset.getString("ISSUE_TITLE") == null)
    ...
    private String removeID(String inputString) throws Exception
    {
   ...
   public List getContributors(String strAuthors,Key key)
   {
     ...
     public List getEditors(String strAuthors,Key key)
     {
         List list = new ArrayList();
     ...
     private Hashtable parseGroupData(String inputData)
     {
        String[] group  = null;
     ...
     public List getEmailList(String emailString) throws Exception
     {
     ...
     public List getContributorsAff(Key key,
                                    String affiliation,
                                    String affiliationAddress,
                                    ...
                                    String affiliationCountry)
    {
        ...
        List list = new ArrayList();
        Hashtable affTable      =  parseGroupData(affiliation);
        Hashtable addressTable  =  parseGroupData(affiliationAddress);
        Hashtable cityTable     =  parseGroupData(affiliationCity);
        Hashtable stateTable    =  parseGroupData(affiliationState);
        Hashtable countryTable  =  parseGroupData(affiliationCountry);

        Enumeration idSet = affTable.keys();
    ...
    */
    ...
    private String  replaceDTNullWithEmptyString(String str)
    {
        ...
        if( !str.equals(StringUtil.EMPTY_STRING))
        {
            if (str.equalsIgnoreCase("ab")){str = "Abstract Report";}
            else if (str.equalsIgnoreCase("ar")){str = "Article";}
            else if (str.equalsIgnoreCase("bk")){str = "Book";}
            else if (str.equalsIgnoreCase("br")){str = "Book Review";}
            else if (str.equalsIgnoreCase("bz")){str = "Business Article";}
            else if (str.equalsIgnoreCase("ch")){str = "Chapter";}
            else if (str.equalsIgnoreCase("cp")){str = "Conference Paper";}
            else if (str.equalsIgnoreCase("cr")){str = "Conference Review";}
            else if (str.equalsIgnoreCase("di")){str = "Dissertation";}
            else if (str.equalsIgnoreCase("ed")){str = "Editorial";}
            else if (str.equalsIgnoreCase("er")){str = "Erratum";}
            else if (str.equalsIgnoreCase("ip")){str = "Article in Press";}
            else if (str.equalsIgnoreCase("le")){str = "Letter";}
            else if (str.equalsIgnoreCase("no")){str = "Note";}
            else if (str.equalsIgnoreCase("pa")){str = "Patent";}
            else if (str.equalsIgnoreCase("pr")){str = "Press Release";}
            else if (str.equalsIgnoreCase("re")){str = "Review";}
            else if (str.equalsIgnoreCase("rp")){str = "Report";}
            else if (str.equalsIgnoreCase("sh")){str = "Short Survey";}
            else if (str.equalsIgnoreCase("wp")){str = "Working Pape";}
            else if (str.equalsIgnoreCase("JA")){str = "Journal article (JA)";}
            else if (str.equalsIgnoreCase("MC")){str = "Monograph chapter (MC)";}
            else if (str.equalsIgnoreCase("MR")){str = "Monograph review (MR)";}
            else if (str.equalsIgnoreCase("CA")){str = "Conference article (CA)";}
        }
        return str;
    }
    ...
    private String  getSourceType(String str)
    {
        ...
        if( !str.equals(StringUtil.EMPTY_STRING))
        {
            if (str.equalsIgnoreCase("b")){str = "Book";}
            else if (str.equalsIgnoreCase("d")){str = "Trade Journal";}
            else if (str.equalsIgnoreCase("j")){str = "Journal";}
            else if (str.equalsIgnoreCase("k")){str = "Book Series";}
            else if (str.equalsIgnoreCase("m")){str = "Multi-volume Reference Works";}
            else if (str.equalsIgnoreCase("p")){str = "Conference Proceeding";}
            else if (str.equalsIgnoreCase("r")){str = "Report";}
        }
        return str;
    }
    ...
    private List getMappingCoordinates(String strMaintermsRegion)
    {
      String[] geobasemaintermsrgi = strMaintermsRegion.split(AUDELIMITER);

      List mapcoords = new ArrayList();
