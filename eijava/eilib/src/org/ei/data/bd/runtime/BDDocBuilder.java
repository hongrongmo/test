    ...
    private List loadDocument(List listOfDocIDs, String dataFormat) throws Exception
	{
		...
		try
        {
        	...
        	while(rset.next())
			{
				...
				formatRIS(buildField(Keys.CHEMICAL_TERMS,setElementData(rset.getString("CHEMICALTERM")),ht), dataFormat,Keys.CHEMICAL_TERMS,Keys.RIS_CVS);
