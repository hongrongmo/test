	...
	implements DocumentBuilder
{
	...
	private static final Key[] DETAILED_KEYS = {Keys.ACCESSION_NUMBER, Keys.TITLE, Keys.VOLUME_TITLE,Keys.TITLE_TRANSLATION, Keys.AUTHORS, Keys.EDITORS, Keys.AUTHOR_AFFS,Keys.CORRESPONDING_EMAIL,Keys.CORRESPONDING_AUTHORS,Keys.CORRESPONDING_AUTHORS_AFF, Keys.EDITOR_AFFS, Keys.SERIAL_TITLE, Keys.ABBRV_SERIAL_TITLE, Keys.VOLUME, Keys.ISSUE, Keys.MONOGRAPH_TITLE, Keys.ISSUE_DATE, Keys.PUBLICATION_YEAR, Keys.PAPER_NUMBER, Keys.PAGE_RANGE,Keys.PAGE_ARTICLE_NUMBER, Keys.LANGUAGE, Keys.ISSN, Keys.CODEN, Keys.ISBN,Keys.ISBN13, Keys.DOC_TYPE, Keys.CONFERENCE_NAME, Keys.CONF_DATE, Keys.MEETING_LOCATION, Keys.CONF_CODE, Keys.SPONSOR, Keys.PUBLISHER, Keys.ABSTRACT, Keys.ABSTRACT_TYPE, Keys.NUMBER_OF_REFERENCES, Keys.MAIN_HEADING, Keys.CONTROLLED_TERMS, Keys.UNCONTROLLED_TERMS, Keys.CLASS_CODES, Keys.TREATMENTS,Keys.GLOBAL_TAGS, Keys.PRIVATE_TAGS, Keys.DOI, Keys.DOCID,Keys.PROVIDER, Keys.MEDIA, Keys.CSESS, Keys.PATNUM, Keys.PATAPPNUM, Keys.PRIORITY_INFORMATION, Keys.PLING, Keys.PCODE, Keys.PATASSIGN, Keys.NUMBER_OF_CLAIMS, Keys.SOURCE, Keys.NUMBER_OF_FIGURES, Keys.NUMBER_OF_TABLES,Keys.SUB_INDEX, Keys.SPECIFIC_NAMES, Keys.SUPPL, Keys.PDFIX, Keys.REPORT_NUMBER_PAPER, Keys.PI,Keys.PAGE_COUNT,Keys.SPECIES_TERMS,Keys.REGION_CONTROLLED_TERMS,Keys.COPYRIGHT, Keys.COPYRIGHT_TEXT};
