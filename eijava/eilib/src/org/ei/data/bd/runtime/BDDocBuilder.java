						...
						!dataFormat.equalsIgnoreCase(Citation.XMLCITATION_FORMAT))
				{
					...
					{						
						...
						if (cvtmjr != null && cvtmjr.length() > 0)
						{
							...
							formatRIS(ht,dataFormat,ELT_MAJOR_TERMS,Keys.RIS_CVM);
