		...
		try
        {
        	...
        	while(rset.next())
			{
				...
				if(!dataFormat.equals(Citation.CITATION_FORMAT) && !dataFormat.equalsIgnoreCase(Citation.XMLCITATION_FORMAT))
				{
					...
					buildField(Keys.PATNO,rset.getString("PATNO"),ht);
				}
