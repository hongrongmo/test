...
//                    lstAsg = AssigneeFilter.filterInventors(lstInv, lstAsg, true);
    ...
    public Classification[] getIPCClssifications(String[] classcodes) throws Exception {
...
//                }
                ...
                if (rset.getString("PRI") != null) {
                    ht.put(Keys.PRIORITY_INFORMATION, new XMLMultiWrapper(Keys.PRIORITY_INFORMATION, setElementData(((formatPriorityInfo(removeSemiColon(rset.getString("PRI"))))))));
