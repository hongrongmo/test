...
public class ExtractAuAffChm
{
        ...
        throws Exception
    {
        ...
        try
        {
            ...
            {
                pstmt1  = con.prepareStatement(" select adr from chm_master where (adr is not null) and load_number >= "+load_number_begin+" and load_number <= "+load_number_end);
                System.out.println("\n\nQuery: "+" select adr from chm_master where (adr is not null) and load_number >= "+load_number_begin+" and load_number <= "+load_number_end);
            }
