...
public class ExtractPubChm
{
        ...
        throws Exception
    {
        ...
        try
        {
            ...
            {
                pstmt1  = con.prepareStatement(" select pub from chm_master where (pub is not null) and load_number >= "+load_number_begin+" and load_number <= "+load_number_end);
                System.out.println("\n\nQuery: "+" select pub from chm_master where (pub is not null) and load_number >= "+load_number_begin+" and load_number <= "+load_number_end);
            }
