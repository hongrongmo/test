...
public class RetrievedData
{
	...
	String delimited29 = String.valueOf(DataParser.delimited29);
	String delimited02 = String.valueOf(DataParser.delimited02);


	public void setItem(Item itemObject, Hashtable dataTable)
	{
		try
		{
	...
	void setProcessInfo(Process_info processInfo,Hashtable dataTable)
	{
	...
	void setItemInfo(Item_info itemInfo,Hashtable dataTable)
	{
	...
	void setHead(Head head,Hashtable dataTable)
	{
		try
		{
	...
	void setCorrespondence(Correspondence correspondence,Hashtable dataTable)
	{
	...
	void setPerson(Person person,Hashtable dataTable,String name)
	{
	...
	void setCitationInfo(Citation_info citationInfo, Hashtable dataTable)
	{
	...
	void setRelatedItem(Related_item relatedItem,Hashtable dataTable)
	{
	...
	void setAbstracts(Abstracts abstracts,Hashtable dataTable)
	{
	...
	void setSource(Source source,Hashtable dataTable,String name)
	{
	...
	void setPublishers(List publishers,Hashtable dataTable)
	{
	...
	void setAffiliation(Affiliation affiliation,Hashtable dataTable,String name,int id)
	{
		...
		if(affOrganization.length()>0)
		{
			...
			{
				dataTable.put(name+"-Affiliation-Organization",dataTable.get(name+"-Affiliation-Organization")+delimited02+id+delimited29+affOrganization.toString());
			}
		}
		...
		if(affAddressPart!=null)
		{
			...
			{
				dataTable.put(name+"-Affiliation-AddressPart",dataTable.get(name+"-Affiliation-AddressPart")+delimited02+id+delimited29+affAddressPart);
			}
		}
		...
		if(affPostalCode!=null)
		{
			...
			{
				dataTable.put(name+"-Affiliation-PostalCode",dataTable.get(name+"-Affiliation-PostalCode")+delimited02+id+delimited29+affPostalCode);
			}
		}
	...
	void setEditor(List editors, Hashtable dataTable,String name)
	{
	...
	void setWebsite(Website website,Hashtable dataTable,String name)
	{
	...
	void setAdditionalSrcinfo(Additional_srcinfo additionalSrcinfo,Hashtable dataTable)
	{
		String sourcetitle				= null;
	...
	void setConferenceinfo(Conferenceinfo conferenceinfo,Hashtable dataTable)
	{
	...
	void setConflocation(Conflocation conflocation,Hashtable dataTable)
	{
	...
	void setConfdate(Confdate confdate,Hashtable dataTable)
	{
	...
	void setConfpublication(Confpublication confpublication,Hashtable dataTable)
	{
	...
	void setEnhancement(Enhancement enhancement,Hashtable dataTable)
	{
	...
	void setToc(Toc toc,Hashtable dataTable)
	{
	...
	void setClassificationgroup(Classificationgroup classificationgroup,Hashtable dataTable)
	{
	...
	void setManufacturergroup(Manufacturergroup manufacturergroup,Hashtable dataTable)
	{
	...
	void setTradenamegroup(Tradenamegroup tradenamegroup,Hashtable dataTable)
	{
	...
	void setSequencebanks(Sequencebanks sequencebanks,Hashtable dataTable)
	{
	...
	void setChemicalgroup(Chemicalgroup chemicalgroup,Hashtable dataTable)
	{
	...
	void setTail(Tail tail, Hashtable dataTable)
	{
	...
	void setRefdItemcitation(Refd_itemcitation refdItemcitation,Hashtable dataTable,String name)
	{
	...
	void setCitationTitle(Citation_title citationTitle,Hashtable dataTable,String name)
	{
				...
				if(titletextOriginal!=null)
				{
					...
					else
					{
						if(titletext!=null)
						{
							...
							{
								dataTable.put(name+"-Citation_title-translated_titletext",dataTable.get(name+"-Citation_title-translated_titletext")+"&&"+titletext);
							}
						}
					}
				}
	...
	void setRefInfo(Ref_info refInfo,Hashtable dataTable,String name)
	{
	...
	void setPatent(Patent patent,Hashtable dataTable)
	{
	...
	void setPublicationdate(Publicationdate publicationdate,Hashtable dataTable,String name)
	{
	...
	void setAuthors(List authors,Hashtable dataTable,String name,int authorGroupID)
	{
		...
		if(indexedName.length()>0)
		{
			...
			{
				dataTable.put(name+"-Authors_indexedName",dataTable.get(name+"-Authors_indexedName")+delimited02+authorGroupID+delimited29+indexedName.toString());
			}
		}
		...
		{
			dataTable.put(name+"-Authors_nameText",dataTable.get(name+"-Authors_nameText")+delimited02+authorGroupID+delimited29+nameText.toString());
		}
		...
		if(emailAddress.length()>0)
		{
			...
			{
				dataTable.put(name+"-Authors_emailAddress",dataTable.get(name+"-Authors_emailAddress")+delimited02+authorGroupID+delimited29+emailAddress.toString());
			}
		}
		...
		if(fullName.length()>0)
		{
			...
			{
				dataTable.put(name+"-Authors_fullName",dataTable.get(name+"-Authors_fullName")+delimited02+authorGroupID+delimited29+fullName.toString());
			}
		}

	}

	void setVolisspag(Volisspag volisspag,Hashtable dataTable,String name)
	{
		String voliss				= null;
		String volissVolume			= null;
		String volissIssue			= null;
	...
	void setHistory(History history, Hashtable dataTable)
	{
	...
	void setDescriptorgroup(Descriptorgroup descriptorgroup,Hashtable dataTable)
	{
	...
	void setContributorGroup(Contributor_group contributorGroup,Hashtable dataTable,String name)
	{
