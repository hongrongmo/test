...
import org.ei.data.xmlDataLoading.*;
...
public class OutputFreeLanguage
{
	...
	public void getResults(FileWriter outputFile, String year, String format)
	{
		...
		ResultSet rs = null;
		String sqlString = "select b.count COUNT, a.* from CPXPARSEDFREELANGUAGE a, (select upper(fls) fls,count(upper(fls)) count from CPXPARSEDFREELANGUAGE group by upper(fls)) b where upper(a.fls)=upper(b.fls) and a.yr='"+year+"' ";
