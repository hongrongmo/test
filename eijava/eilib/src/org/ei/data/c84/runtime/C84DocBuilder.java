...
public class C84DocBuilder implements DocumentBuilder
{
    ...
    private static final Key[] CITATION_KEYS = {Keys.DOCID,Keys.DOI,Keys.TITLE,Keys.EDITORS,Keys.AUTHORS,Keys.SOURCE, Keys.PAGE_RANGE, Keys.VOLISSUE,Keys.PUBLICATION_YEAR, Keys.ISSUE_DATE, Keys.ISSN, Keys.PROVIDER, Keys.PATASSIGN ,Keys.PATNUM ,Keys.PATFILDATE,Keys.PATENT_ISSUE_DATE,Keys.PATCOUNTRY,Keys.NO_SO,Keys.LANGUAGE,Keys.MONOGRAPH_TITLE,Keys.COPYRIGHT,Keys.COPYRIGHT_TEXT};
    private static final Key[] ABSTRACT_KEYS = {Keys.DOCID,Keys.DOI,Keys.COPYRIGHT_TEXT, Keys.COPYRIGHT,Keys.ACCESSION_NUMBER, Keys.TITLE , Keys.AUTHORS , Keys.AUTHOR_AFFS, Keys.EDITORS ,Keys.EDITOR_AFFS, Keys.MAIN_HEADING , Keys.CONTROLLED_TERMS, Keys.GLOBAL_TAGS, Keys.PRIVATE_TAGS, Keys.ABSTRACT, Keys.NUMBER_OF_REFERENCES , Keys.ABSTRACT_TYPE , Keys.LANGUAGE , Keys.NO_SO , Keys.VOLUME , Keys.ISSUE, Keys.VOLISSUE, Keys.SOURCE,  Keys.MONOGRAPH_TITLE, Keys.VOLUME_TITLE , Keys.PUBLISHER,Keys.I_PUBLISHER, Keys.ISSUE_DATE, Keys.PUBLICATION_DATE, Keys.PUBLICATION_YEAR , Keys.PAPER_NUMBER , Keys.PAGE_RANGE, Keys.VOLUME_TITLE, Keys.CONFERENCE_NAME, Keys.CONF_DATE , Keys.SPONSOR , Keys.PUB_LOCATION , Keys.CODEN,Keys.ISBN, Keys.ISSN, Keys.PROVIDER,Keys.REPORT_NUMBER,Keys.PATENT_ISSUE_DATE,Keys.PATASSIGN ,Keys.PATNUM ,Keys.PATFILDATE,Keys.PATCOUNTRY, Keys.COPYRIGHT,Keys.COPYRIGHT_TEXT};
    private static final Key[] DETAILED_KEYS = {Keys.ACCESSION_NUMBER ,Keys.TITLE ,Keys.TITLE_TRANSLATION ,Keys.AUTHORS ,Keys.EDITORS ,Keys.INVENTORS ,Keys.SALUTATION,Keys.PATASSIGN ,Keys.PATNUM ,Keys.PATFILDATE,Keys.PATENT_ISSUE_DATE,Keys.AUTHOR_AFFS ,Keys.EDITOR_AFFS ,Keys.SOURCE ,Keys.SERIAL_TITLE ,Keys.ABBRV_SERIAL_TITLE ,Keys.VOLISSUE ,Keys.VOLUME ,Keys.ISSUE ,Keys.MONOGRAPH_TITLE ,Keys.ISSUING_ORG ,Keys.REPORT_NUMBER ,Keys.ISSUE_DATE ,Keys.PUBLICATION_DATE , Keys.PUBLICATION_YEAR ,Keys.PAP_NUMBER ,Keys.PAPER_NUMBER ,Keys.PAGE_RANGE ,Keys.NUMBER_OF_FIGURES, Keys.LANGUAGE,Keys.ISSN ,Keys.CODEN ,Keys.ISBN ,Keys.DOC_TYPE,Keys.PATCOUNTRY,Keys.CONFERENCE_NAME ,Keys.CONF_DATE ,Keys.MEETING_LOCATION ,Keys.CONF_CODE ,Keys.SPONSOR ,Keys.PUBLISHER ,Keys.PUB_PLACE ,Keys.PUB_LOCATION ,Keys.TRANSLATION_SERIAL_TITLE ,Keys.TRANSLATION_ABBREVIATED_SERIAL_TITLE ,Keys.TRANSLATION_VOLUME ,Keys.TRANSLATION_ISSUE ,Keys.TRANSLATION_PUBLICATION_DATE ,Keys.TRANSLATION_PAGES ,Keys.TRANSLATION_ISSN ,Keys.TRANSLATION_CODEN ,Keys.TRANSLATION_COUNTRY_OF_PUB, Keys.ACRONYM_DEFINITION,Keys.ABSTRACT, Keys.ABSTRACT_TYPE ,Keys.NUMBER_OF_REFERENCES ,Keys.MAIN_HEADING ,Keys.CONTROLLED_TERMS , Keys.UNCONTROLLED_TERMS ,Keys.CLASS_CODES , Keys.GLOBAL_TAGS, Keys.PRIVATE_TAGS,Keys.NUMERICAL_DATA_INDEXING ,Keys.ASTRONOMICAL_OBJECT_INDEXING ,Keys.CHEMICAL_DATA_INDEX ,Keys.TREATMENTS ,Keys.DISCIPLINES   ,Keys.DOI, Keys.DOCID , Keys.COPYRIGHT,Keys.COPYRIGHT_TEXT, Keys.PROVIDER};
    private static final Key[] RIS_KEYS = {Keys.DOCID, Keys.RIS_TY,Keys.RIS_LA, Keys.RIS_N1, Keys.RIS_TI, Keys.RIS_T1, Keys.RIS_BT , Keys.RIS_JO  , Keys.RIS_T3, Keys.RIS_DO, Keys.RIS_AUS, Keys.RIS_AD, Keys.RIS_EDS , Keys.RIS_PY, Keys.RIS_PE, Keys.RIS_PB , Keys.RIS_Y1, Keys.RIS_Y2, Keys.RIS_CY, Keys.RIS_VL, Keys.RIS_IS, Keys.RIS_SP, Keys.RIS_EP, Keys.RIS_SN, Keys.RIS_S1 , Keys.RIS_MD, Keys.RIS_AN ,Keys.RIS_N2,Keys.RIS_KW , Keys.RIS_CVS , Keys.RIS_FLS, Keys.BIB_TY };
    private static final Key[] XML_KEYS = {Keys.ISSN, Keys.PATENT_ISSUE_DATE , Keys.NO_SO, Keys.MONOGRAPH_TITLE, Keys.PUBLICATION_YEAR  , Keys.VOLUME_TITLE , Keys.ISBN, Keys.AUTHORS , Keys.DOCID, Keys.SOURCE  , Keys.NUMVOL  , Keys.EDITOR_AFFS  , Keys.EDITORS , Keys.PUBLISHER, Keys.VOLUME  , Keys.AUTHOR_AFFS  , Keys.PROVIDER, Keys.ISSUE_DATE  , Keys.COPYRIGHT_TEXT, Keys.DOI, Keys.PAGE_COUNT  , Keys.PUBLICATION_DATE  , Keys.TITLE, Keys.LANGUAGE, Keys.PAGE_RANGE  , Keys.PAPER_NUMBER , Keys.PATASSIGN, Keys.PATCOUNTRY, Keys.ISSUE, Keys.COPYRIGHT, Keys.ACCESSION_NUMBER  , Keys.PATNUM  , Keys.CONTROLLED_TERMS  , Keys.PATFILDATE};
...
//    AO TL") ???
    ...
    private static String queryAbstracts="select M_ID,EX,DT,TI,TT,AUS,AF,AM,AC,ASS,AV,AY,ED,EF,EM,EC,ES,EV,EY,ST,SE,VO,ISS,SD,MT,ME,VT,PN,YR,NV,PA,XP,PP,LA,SN,CN,BN,CF,M2,MC,MS,MV,MY,SP,SC,SS,SV,SY,PN,PC,PY,PO,AB,NR,AT,MH,SH,CVS,PS,PV, PE,PM,AD,PD,PU,DO  from c84_master where M_ID IN ";
            ...
            try
            {
                ...
                while(rset.next())
                {
                    ...
                    ht.put(Keys.COPYRIGHT,new XMLWrapper(Keys.COPYRIGHT,
                                            C84DocBuilder.C84_HTML_COPYRIGHT));
                    ht.put(Keys.COPYRIGHT_TEXT, new XMLWrapper(Keys.COPYRIGHT_TEXT,
                                            C84DocBuilder.C84_TEXT_COPYRIGHT));
                    ...
                    if (rset.getString("AUS") != null)
                    {
                        Contributors authors = new Contributors(Keys.AUTHORS,
                                    getContributors(StringUtil.replaceNullWithEmptyString(rset.getString("AUS")),Keys.AUTHORS));
                    ...
                    else
                    {
                        if(rset.getString("ED") != null)
                        {
                            ...
                            if(strED != null &&
                                    !strED.trim().equals(StringUtil.EMPTY_STRING))
                            {
                    ...
                    { // All other citations (same as CPX)
                            ...
                            rset.getString("PN") != null )
                        {
                            ...
                            {
                                ht.put(Keys.VOLUME, new Volume(StringUtil.replaceNullWithEmptyString(rset.getString("VO").replace('n',' ').replace('v',' ' )), perl));
                            }
                        ...
                        else if (rset.getString("YR") != null)
                        {
                            ...
                            rset.getString("ME") == null
                            &&
                            !strYR.equals(StringUtil.EMPTY_STRING)
                            )
                            {
                            ...
                            else if (!strYR.equals(StringUtil.EMPTY_STRING))
                            {
                                ...
                                ht.put(Keys.PUBLICATION_YEAR,
                                   new Year(Keys.PUBLICATION_YEAR,strYR, perl));
                            }
                        }
    ...
    */
                ...
                { // All other citations (same as CPX)
                    ...
                    rset.getString("PN") != null )
                    {
                        ...
                        if(rset.getString("VO") != null)
                        {
                            ...
                            {
                                ht.put(Keys.VOLUME,
                                        new Volume(Keys.VOLUME, strVolIss, perl));
                            }
                                    ...
                                    rset.getString("SE") != null)
                        {
                            ...
                            {
                                ht.put(Keys.SOURCE,
                                    new XMLWrapper(Keys.SOURCE, StringUtil.replaceNullWithEmptyString(rset.getString("ST"))));
                            }
                            else if(rset.getString("SE") != null)
                            {
                                ht.put(Keys.SOURCE,
                                       new XMLWrapper(Keys.SOURCE, StringUtil.replaceNullWithEmptyString(rset.getString("SE"))));
                            }
                            ...
                            if(rset.getString("MT") != null)
                            {
                                ht.put(Keys.MONOGRAPH_TITLE,
                                    new XMLWrapper(Keys.MONOGRAPH_TITLE, StringUtil.replaceNullWithEmptyString(rset.getString("MT"))));
                            }

                            if(rset.getString("VT") != null)
                            {
                                ht.put(Keys.VOLUME_TITLE,
                                       new XMLWrapper(Keys.VOLUME_TITLE,StringUtil.replaceNullWithEmptyString(rset.getString("VT"))));
                            }
                        }
                        else if((rset.getString("ST") == null &&
                                rset.getString("SE") == null) &&
                                ...
                                rset.getString("ME") != null))
                        {
                            ...
                            {
                                ht.put(Keys.SOURCE,
                                           new XMLWrapper(Keys.SOURCE, StringUtil.replaceNullWithEmptyString(rset.getString("MT"))));
                            }
                            else if(rset.getString("ME") != null)
                            {
                                ht.put(Keys.SOURCE,
                                    new XMLWrapper(Keys.SOURCE, StringUtil.replaceNullWithEmptyString(rset.getString("ME"))));
                            }
                        }
    ...
    //Year??
                    ...
                    {
                        ht.put(Keys.NUMVOL,
                           new XMLWrapper(Keys.NUMVOL, StringUtil.replaceNullWithEmptyString(rset.getString("NV"))));
                    }
                    // PA
                    if(rset.getString("PA") != null)
                    {
                    ...
                    if(rset.getString("EX") != null)
                    {
                        ht.put(Keys.ACCESSION_NUMBER,
                               new XMLWrapper (Keys.ACCESSION_NUMBER, StringUtil.replaceNullWithEmptyString(rset.getString("EX"))));
                    }
                     //BN
                    if (rset.getString("BN") != null)
                    {
                    ...
                    if((rset.getString("CF") !=null ) ||
                            (rset.getString("M2") !=null ) ||
                            (rset.getString("MC") !=null ))
                    {
                        ht.put(Keys.CONFERENCE_NAME,
                                new XMLWrapper(Keys.CONFERENCE_NAME ,StringUtil.replaceNullWithEmptyString(rset.getString("CF"))));
                    }
                    ...
                    {
                        ht.put(Keys.CODEN,
                           new XMLWrapper(Keys.CODEN, StringUtil.replaceNullWithEmptyString(rset.getString("CN"))));
                    }
                    ...
                    if(rset.getString("YR") != null)
                    {
                        ht.put(Keys.LINKING_YEAR,
                               new Year(Keys.LINKING_YEAR,
                                        rset.getString("YR"),
                                        perl));
                    }
    ...
    throws Exception
    {
        ...
        try
        {
            ...
            while(rset.next())
            {
                ...
                ht.put(Keys.COPYRIGHT,
                        new XMLWrapper(Keys.COPYRIGHT, C84_HTML_COPYRIGHT));

                ht.put(Keys.COPYRIGHT_TEXT,
                       new XMLWrapper(Keys.COPYRIGHT_TEXT, C84_TEXT_COPYRIGHT));
                ...
                if (mainHeading != null)
                {
                    ht.put(Keys.MAIN_HEADING,
                               new XMLWrapper(CPX_MAIN_HEADING ,StringUtil.replaceNullWithEmptyString(mainHeading)));
                }
                ...
                if ((rset.getString("CVS") != null) || (rset.getString("MH") != null))
                {
                    ht.put(Keys.CONTROLLED_TERMS,new XMLMultiWrapper2(CPX_CONTROLLED_TERMS,
                                                                      setCVS(mainHeading,StringUtil.replaceNullWithEmptyString(rset.getString("CVS")))));
                }
                ...
                if(rset.getString("NR") != null)
                {
                    ...
                    if(perl.match("/(\\d+)/", strREFs))
                    {
                        ht.put(Keys.NUMBER_OF_REFERENCES,
                               new XMLWrapper(Keys.NUMBER_OF_REFERENCES,perl.group(0).toString()));
                    }
                }
                ...
                if (rset.getString("AT") != null)
                {
                    ht.put(Keys.ABSTRACT_TYPE,
                               new XMLWrapper(Keys.ABSTRACT_TYPE,StringUtil.replaceNullWithEmptyString(rset.getString("AT"))));
                }
                ...
                { // All other doctypes (same as CPX)
                    ...
                    if (rset.getString("SP") !=null)
                    {
                        ...
                        {
                            ht.put(Keys.SPONSOR,
                                    new XMLWrapper(Keys.SPONSOR, sponsor));
                        }
                    ...
                    if (rset.getString("PN") != null)
                    {
                        ...
                        if (publocation != null && ! publocation.equals(""))
                        {
                            ht.put(Keys.PUB_LOCATION,
                                    new XMLWrapper(Keys.PUB_LOCATION, publocation));
                        }
                    ...
                    {
                        ht.put(Keys.ISBN,
                               new ISBN(StringUtil.replaceNullWithEmptyString(rset.getString("BN"))));
                    }
                    //SN
                    if(rset.getString("SN") != null)
                    {
                        ht.put(Keys.ISSN,
                               new ISSN(StringUtil.replaceNullWithEmptyString(rset.getString("SN"))));
                    }
        ...
        try
        {
            ...
            while(rset.next())
            {
                ...
                if((rset.getString("TT")  != null) && (rset.getString("TI") != null))
                {
                    ...
                    // swap the TT and TI if they both exist - 1884 only
                    ht.put(Keys.TITLE,
                            new XMLWrapper(Keys.TITLE,StringUtil.replaceNullWithEmptyString(rset.getString("TT"))));

                    ht.put(Keys.TITLE_TRANSLATION,
                            new XMLWrapper(Keys.TITLE_TRANSLATION,StringUtil.replaceNullWithEmptyString(rset.getString("TI"))));
                }
                else if (rset.getString("TI") != null)
                {
                    ht.put(Keys.TITLE,
                            new XMLWrapper(Keys.TITLE,StringUtil.replaceNullWithEmptyString(rset.getString("TI"))));
                }
                else if (rset.getString("TT") != null)
                {
                    ht.put(Keys.TITLE,
                ...
                if (rset.getString("AUS") != null)
                {
                    if("PA".equalsIgnoreCase(strDocType))
                    {
                        Contributors authors = new Contributors(EIDoc.INVENTORS,
                                            getContributors(StringUtil.replaceNullWithEmptyString(rset.getString("AUS")),EIDoc.INVENTORS));
                ...
                { // all other doctypes (just like CPX)
                    if ((rset.getString("ST") != null ||
                        rset.getString("SE") != null))
                    {
                        //  ST
                        ...
                        {
                            ht.put(Keys.ABBRV_MON_MONOGRAPH_TITLE, new XMLWrapper(Keys.ABBRV_MON_MONOGRAPH_TITLE,StringUtil.replaceNullWithEmptyString(rset.getString("ME")) ));
                        }
                        //  VT
                        if (rset.getString("VT") != null)
                        {
                    ...
                    if (rset.getString("PA") != null)
                    {
                        ...
                        ht.put(Keys.PAP_NUMBER,
                                    new XMLWrapper(Keys.PAP_NUMBER, StringUtil.replaceNullWithEmptyString(rset.getString("PA"))));
                    }
                    ...
                    {
                        ht.put(Keys.PAGE_RANGE,
                                            new PageRange(StringUtil.replaceNullWithEmptyString(strPages), perl));
                    ...
                    if(lstMeetLoc.size() > 0)
                    {
                        ...
                        {
                            ht.put(Keys.MEETING_LOCATION,
                                    new XMLWrapper(Keys.MEETING_LOCATION, meetingloc));
                        }
                    ...
                    if (rset.getString("CC") != null)
                    {
                        ...
                        ht.put(Keys.CONF_CODE,
                               new XMLWrapper(Keys.CONF_CODE, StringUtil.replaceNullWithEmptyString(rset.getString("CC"))));
                    }
                    ...
                    if(lstSponsor.size() > 0)
                    {
                        ...
                        {
                            ht.put(Keys.SPONSOR,
                                    new XMLWrapper(Keys.SPONSOR, sponsors));
                        }
                        ...
                        if(lstTokens.size() > 0)
                        {
                            ...
                            if (!publisher.equals(""))
                            {
                                ht.put(Keys.PUBLISHER,
                                        new XMLWrapper(Keys.PUBLISHER,publisher));
                            }
                    ...
                    if (rset.getString("PO") != null)
                    {
                        ht.put(Keys.PUBLICATION_ORDER,
                                new XMLWrapper(Keys.PUBLICATION_ORDER,StringUtil.replaceNullWithEmptyString(rset.getString("PO"))));
                    }
                    // FLS
                    ...
                    if (rset.getString("TR") != null)
                    {
                        ht.put(Keys.TREATMENTS,
                               new Treatments(setTreatments(StringUtil.replaceNullWithEmptyString(rset.getString("TR"))),this.database));
                    }
                }  // "PA".equalsIgnoreCase(strDocType)
    ...
    throws Exception
    {
        ...
        try
        {
            ...
            while(rset.next())
            {
                ...
                {
                    ht.put(Keys.RIS_LA,
                            new XMLWrapper(Keys.RIS_LA,StringUtil.replaceNullWithEmptyString(rset.getString("LA"))));
                }
                ...
                {
                    ht.put(Keys.RIS_DO,
                            new XMLWrapper(Keys.RIS_DO,StringUtil.replaceNullWithEmptyString(rset.getString("DO"))));
                }

                if (rset.getString("AUS") != null)
                {
                    Contributors authors = new Contributors(Keys.RIS_AUS, getContributors(StringUtil.replaceNullWithEmptyString(rset.getString("AUS")), Keys.RIS_AUS));
                ...
                else
                {
                    ...
                    if ((lstMeetLoc != null)&& (lstMeetLoc.size() > 0))
                    {
                        ht.put(Keys.RIS_CY,
                ...
                {
                    ht.put(Keys.RIS_FLS,
                                   new XMLMultiWrapper(Keys.RIS_FLS,setElementData(StringUtil.replaceNullWithEmptyString(rset.getString("FLS")))));
                }
    ...
    */
    ...
    private String  replaceTYwithBIBcode(String str)
    {
        ...
        if(!str.equals(StringUtil.EMPTY_STRING))
        {
            ...
            else if (str.equals("PA")){str = "article";}
            else
            {
                str="article";
            }
    ...
    private String replaceDTNullWithEmptyString(String str)
    {
        ...
        if( !str.equals(StringUtil.EMPTY_STRING))
        {
            ...
            else if (str.equals("PA")){str = "Patent (PA)";}
        }
        return str;
    }
