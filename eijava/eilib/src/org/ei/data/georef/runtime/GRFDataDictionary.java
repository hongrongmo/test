...
public class GRFDataDictionary implements DataDictionary
{
	...
	private static Map doctypes = null;
	private static Map bibliographiccodes = null;
	private static Map languages = null;
	private static Map countries = null;
	private static Map termtypes = null;
	private static Map translatetermtypes = null;
      ...
      if(instance == null)
      {
        synchronized (GRFDataDictionary.class) {
          ...
          doctypes.put("T","Thesis or dissertation");
      	  ...
      	  bibliographiccodes = new Hashtable();
		  ...
		  translatetermtypes = new Hashtable();
