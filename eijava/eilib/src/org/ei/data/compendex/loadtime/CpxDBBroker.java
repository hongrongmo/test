...
public class CpxDBBroker {
    ...
    public CpxDBBroker(String connectionURL,
                             String driver,
                             String username,
                             String password,
                             String masterTable,
                             ...
                             String key,
                             int updateNum) throws Exception
    {
                ...
                if(field != null )
                {
					...
					else if(!field.equals("M_ID"))
					{
						...
						if((recValue == null || (!recValue.replaceAll("; ",";").equals(correctionValue.replaceAll("; ",";")))))
						{
							if(correctionValue.length()==0)
							{
								if((recValue != null) && !(tag.equalsIgnoreCase("AN") || tag.equalsIgnoreCase("DO") || tag.equalsIgnoreCase("EX") || tag.equalsIgnoreCase("YR")))
								{
									if(field.equalsIgnoreCase("CL") || field.equalsIgnoreCase("CLS") || field.equalsIgnoreCase("CVS") || field.equalsIgnoreCase("FLS") || field.equalsIgnoreCase("MH"))
									{
										strLog.append("****** Alert ******\n");
									}
