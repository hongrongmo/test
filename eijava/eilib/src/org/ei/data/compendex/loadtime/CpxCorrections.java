...
public class CpxCorrections {
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        if(args.length < 10)
        {
            System.out.println("Usage: org.ei.data.compendex.CpxCorrections [url(jdbc:oracle:thin:@SERVER:PORT:SID)] [Driver (oracle.jdbc.driver.OracleDriver)] [user name] [password] [source table] [update table]  [properties file] [Correction file]  [Log file] [Update Number] [type (QA|BACKUP)] [ADD file]");
            System.exit(1);
        }
        String url = args[0];
        ...
        CpxCorrections cor = new CpxCorrections(url,driver,username,password,
                                                masterTable,updateTable,backupTable,propFile,
                                                updateNum,qaFlag);
    ...
    public CpxCorrections(String url,String driver,String username,String password,
                          String masterTable,String updateTable,String backupTable,
