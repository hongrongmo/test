...
public class CompendexCombiner
    extends CombinerTimestamp
{
        ...
        throws Exception
    {
        ...
        try
        {
            ...
            rs = stmt.executeQuery("select ar,ay,ac, ab, m_id, do, vo, iss, xp,af, ex, an, aus, bn, cal, cc, cf, cls, cn, cvs, dt, ed, ef, ey, fls, id, la, lf, mc, me, mh, ms, mt, mv, my, m2, pn, se, sh, sn, sp, st, ti, tt, tr, vt, SUBSTR(yr,1,4) yr, load_number from " + Combiner.TABLENAME + " where yr ='" + year + "' AND load_number != 0 and load_number < 1000000");
    ...
    public void writeCombinedByTimestampHook(Connection con, long timestamp) throws Exception
    {
            ...
            try
            {
                ...
                this.writer.begin();
                stmt = con.createStatement();
                rs = stmt.executeQuery("select ar,ay,ac, ab, m_id, do, vo, iss, xp,af, ex, an, aus, bn, cal, cc, cf, cls, cn, cvs, dt, ed, ef, ey, fls, id, la, lf, mc, me, mh, ms, mt, mv, my, m2, pn, se, sh, sn, sp, st, ti, tt, tr, vt, SUBSTR(yr,1,4) yr, load_number from " + Combiner.TABLENAME + " where update_number =" + timestamp +" AND load_number != 0 and load_number < 1000000");
        ...
        throws Exception
    {
        ...
        try
        {
            ...
            this.writer.begin();
            stmt = con.createStatement();
            rs = stmt.executeQuery("select ar,ay,ac, ab, m_id, do, vo, iss, xp,af, ex, an, aus, bn, cal, cc, cf, cls, cn, cvs, dt, ed, ef, ey, fls, id, la, lf, mc, me, mh, ms, mt, mv, my, m2, pn, se, sh, sn, sp, st, ti, tt, tr, vt, SUBSTR(yr,1,4) yr, load_number from " + Combiner.TABLENAME + " where load_number =" + weekNumber +" AND load_number != 0 and load_number < 1000000");
