        ...
        try
        {
            ...
            while(rset.next())
            {
                ...
                ht.put(Keys.COPYRIGHT,
                        new XMLWrapper(Keys.COPYRIGHT, CPX_HTML_COPYRIGHT));
                ...
                String strPages=getPage(rset.getString("XP"),
                                        rset.getString("PP"),
                                        rset.getString("AR"),
                                        rset.getString("SN"),
                                        rset.getString("DO"),
                ...
                if (rset.getString("PN") != null)
                {
                    ...
                    ht.put(Keys.PUB_LOCATION,
                           new XMLWrapper(Keys.PUB_LOCATION,StringUtil.join(lstPL,", ")));
                }
                ...
                while(rset.next())
                {
                    ...
                    if (rset.getString("CF") != null)
                    {
                        ht.put(Keys.CONFERENCE_NAME,
                                new XMLWrapper(Keys.CONFERENCE_NAME ,rset.getString("CF")));
                    }
                    //  MD
                    if (rset.getString("M2") != null)
                    {
                    ...
                    if (rset.getString("CC") != null)
                    {
                        ht.put(Keys.CONF_CODE,
                               new XMLWrapper(Keys.CONF_CODE, rset.getString("CC")));
                    }
                    ...
                    {
                        ht.put(Keys.SPONSOR,
                               new XMLWrapper(Keys.SPONSOR, StringUtil.join(lstSponsor,", ")));
                    }
                    ...
                    if (rset.getString("PO") != null)
                    {
                        ht.put(Keys.PUBLICATION_ORDER,
                                new XMLWrapper(Keys.PUBLICATION_ORDER,rset.getString("PO")));
                    }
                    //  AB
...
//                  ht.put(EIDoc.PROVIDER,this.PROVIDER);
                    ...
                    */
                    ...
                    ht.put(Keys.RIS_FLS,
                             new XMLMultiWrapper(Keys.RIS_FLS,setElementData(rset.getString("FLS"))));

                    //DO
                    if(rset.getString("DO") != null)
                    {
                        ht.put(Keys.RIS_DO,
                               new XMLWrapper(Keys.RIS_DO, rset.getString("DO")));
                    }
            ...
            while(rset.next())
            {
                   ...
                   rset.getString("PN") != null )
                {
                    ...
                    if(rset.getString("VO") != null)
                    {
                        strVolIss = strVolIss.concat(replaceVolumeNullWithEmptyString(rset.getString("VO")));
                        ht.put(Keys.VOLUME,
                               new Volume(Keys.VOLUME, rset.getString("VO"), perl));
                    }
