    ...
    */
    public int sendit() throws IOException {
        ...
        try {
            ...
            if (cust_id > 0)
            {
                psBuffer.append(URLEncoder.encode("cust_id")).append("=").append(URLEncoder.encode(Long.toString(cust_id))).append("&");
            }
            if (sid != null)
            {
            ...
            if (appdata != null)
            {
                ...
                addToAppData("cust_id", new String(Long.toString(cust_id)));
