...
public class BulletinTraverser {
    ...
    List flist = new Vector();
    private Perl5Util perl = new Perl5Util();
    PrintWriter writer = null;
    PrintWriter error = null;
    Hashtable htCats = new Hashtable();
            ...
            if (current_file.isDirectory()) {
                ...
                if (path1.endsWith(".htm")) {
                    ...
                    if (year != null && !year.equals(year1))
                        error.println("Error[" + year1 + "]: Publication Year Mismatch ---> /api/" + db + "/" + year1 + "/" + category + "/" + "html/" + fileName + ".htm");
