...
public class BulletinTableDriver
{
    ...
    public void processLITRecord(Hashtable htFields)
    {
        ...
        out.println(db + "\t" + newCy.trim() + "\t" + pubYr.trim() + "\t" + pubDt.trim() + "\t" + fileName.trim() + "\t" + zipFileName.trim() + "\t" + weekNumber);
    ...
    public void processPATRecord(Hashtable htFields)
    {
