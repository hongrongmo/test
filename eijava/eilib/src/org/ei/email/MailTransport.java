...
public class MailTransport
{
    ...
    public MailTransport(String mailhost)
            throws IncompleteMailConfigurationException
    {
        session = getSession(mailhost, false);
    }
    ...
    **/
    public void sendMultiPartMessage( EIMessage message) throws MessagingException
    {
        ...
        //mapBodyParts.put("spacergif",eiProps.getProperty("WEBAPPRESOURCEPATH") + "s.gif");
