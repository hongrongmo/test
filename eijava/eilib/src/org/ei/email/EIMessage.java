...
public class EIMessage {
   ...
   /**
     ...
     **/
    private List tORecepients = new ArrayList();

    /**
     * The CC recepients InternetAddress List
     **/
    private List cCRecepients = new ArrayList();

    /**
     * The BCC recepients InternetAddress List
     **/
    private List bCCRecepients = new ArrayList();
    ...
    /**
     * Sets the subject
     * @param   subject   The subject line in the message
     **/
	...
	**/
     ...
     * @param   recepient of the message. This parameter should conform to an RFC822 address.
     **/
     ...
     **/
    public void addTORecepients(List recepients) throws AddressException{
       for(Iterator iter = recepients.iterator();iter.hasNext();){
     ...
     * @parm recepients     List of CC recepients as Strings. Each object in the list
     *       should be a String conforming to an RFC822 address.
     **/
    public void addCCRecepients(List recepients) throws AddressException{
        for(Iterator iter = recepients.iterator();iter.hasNext();){
     ...
     * @parm recepients List of BCC recepients as Strings. Each object in the list
     *       should be a String conforming to an RFC822 address.
     **/
    public void addBCCRecepients(List recepients) throws AddressException{
        for(Iterator iter = recepients.iterator();iter.hasNext();){
    ...
    public String toString(){
        ...
        buf.append("To:");
        buf.append(ls);
        for(Iterator iter = getTORecepients().iterator();iter.hasNext();){
        ...
        buf.append("CC:");
        buf.append(ls);
        for(Iterator iter = getCCRecepients().iterator();iter.hasNext();){
            buf.append(iter.next().toString());
            if(iter.hasNext()){
                buf.append(",");
                buf.append(ls);
        ...
        buf.append("BCC:");
        buf.append(ls);
        for(Iterator iter = getBCCRecepients().iterator();iter.hasNext();){
            buf.append(iter.next().toString());
            if(iter.hasNext()){
                buf.append(", ");
                buf.append(ls);
