  ...
  EiNavigator geo = nav.getNavigatorByName(EiNavigator.GEO);
    ...
    for(int mindex = 0;itrmods.hasNext();mindex++)
    {
      ...
      if(modifier != null)
      {
        ...
        {
          out.write("<Placemark>");
          out.write("<search><![CDATA[/controller/servlet/Controller?CID=expertSearchCitationFormat&database=" + dbmask + "&RERUN="+searchId+"&geonav=" + geocount + "~" + geovalue  + "~" + geoterm + "]]></search>");
