<%@ page language="java" %><%@ page session="false" %><%@ page import="java.util.*"%><%@ page import="org.ei.tags.*"%><%@ page import="org.ei.session.*"%><%@ page import="org.ei.controller.ControllerClient"%><%@ page import="org.ei.email.*"%><%@ page import="javax.mail.internet.*"%><%
	...
	*/
	...
	if(recnum > 1)
	{
		...
		prevurl.append("SEARCHID=").append(request.getParameter("SEARCHID")).append("&amp;");
		...
		prevurl.append("DOCINDEX=").append(Integer.toString((recnum-1))).append("&amp;");
		prevurl.append("database=").append(request.getParameter("database")).append("&amp;");
		prevurl.append("format=").append(request.getParameter("format"));
	}
	...
	if(recnum < totalcount)
	{
		...
		nexturl.append("SEARCHID=").append(request.getParameter("SEARCHID")).append("&amp;");
		...
		nexturl.append("DOCINDEX=").append(Integer.toString((recnum+1))).append("&amp;");
		nexturl.append("database=").append(request.getParameter("database")).append("&amp;");
		nexturl.append("format=").append(request.getParameter("format"));
	}
	request.setAttribute("NEXT_URL", nexturl);

	StringBuffer srurl = new StringBuffer();
	srurl.append("CID=").append(XSLCIDHelper.searchResultsCid(tQuery.getSearchType())).append("&amp;");
	srurl.append("SEARCHID=").append(request.getParameter("SEARCHID")).append("&amp;");
	srurl.append("COUNT=").append(Integer.toString((recnum))).append("&amp;");
	...
	nsurl.append("CID=").append(XSLCIDHelper.newSearchCid(tQuery.getSearchType())).append("&amp;");
	...
	absurl.append("CID=").append(XSLCIDHelper.formatBase(tQuery.getSearchType())+"AbstractFormat").append("&amp;");
	absurl.append("SEARCHID=").append(request.getParameter("SEARCHID")).append("&amp;");
	...
	absurl.append("DOCINDEX=").append(Integer.toString((recnum+1))).append("&amp;");
	absurl.append("database=").append(request.getParameter("database")).append("&amp;");
	absurl.append("format=").append(XSLCIDHelper.formatBase(tQuery.getSearchType())+"AbstractFormat");

	request.setAttribute("ABS_URL", absurl);

	StringBuffer deturl = new StringBuffer();
	deturl = new StringBuffer();
	deturl.append("CID=").append(XSLCIDHelper.formatBase(tQuery.getSearchType())+"DetailedFormat").append("&amp;");
	deturl.append("SEARCHID=").append(request.getParameter("SEARCHID")).append("&amp;");
	...
	deturl.append("DOCINDEX=").append(Integer.toString((recnum+1))).append("&amp;");
	deturl.append("database=").append(request.getParameter("database")).append("&amp;");
	deturl.append("format=").append(XSLCIDHelper.formatBase(tQuery.getSearchType())+"DetailedFormat");
