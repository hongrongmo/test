...
<%
    ...
    */
    ...
    if((request.getParameter("searchID")!=null) && (request.getParameter("searchID").trim().length() > 0))
    {
	...
	else
	{
	    ...
	    if((request.getParameter("CID")!=null) && (request.getParameter("CID").equalsIgnoreCase("expertSearch")))
        {
    ...
    if((request.getParameter("CID")!=null) && (request.getParameter("CID").trim().equalsIgnoreCase("expertSearch")))
    {
