...
<%
    ...
    {
        combineSearch = request.getParameter("combine").trim();
    }
...
//                    }
            ...
            {  // total docs is not greater than 0
            ...
            //Forword the page when no of results are zero.
            if(flag==true)
            {
                String urlString = "/controller/servlet/Controller?CID=errorCombineSearchResult&SEARCHID="+searchID+"&COUNT=1&FORWARD=true&database="+Integer.toString(queryObject.getDataBase());
                if(sc.hasError())
                {
    ...
    else
    {
        ...
        String urlString = "/controller/servlet/Controller?CID=searchDifferentDatabase&database="+dbName+"&dberr="+dbErr;
        client.setRedirectURL(urlString);
        client.setRemoteControl();
        return;
    }
