...
<xsl:template match="PAGE">
    ...
    <html>
    <head>
        <title>Download Selected Records</title>
    ...
    <xsl:choose>
        <xsl:when test="$ERROR-PAGE='true'">
            ...
            <td valign="top" colspan="2"><img src="/engresources/images/downloadrecords.gif" border="0"/></td>
            </tr>
        ...
        <xsl:otherwise>
            ...
            <table border="0" width="100%" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
                <tr>
                    <td valign="top" height="15" colspan="3"><img src="/engresources/images/s.gif" border="0"/></td>
                </tr>
                <tr>
                    <td valign="top" width="20"><img src="/engresources/images/s.gif" border="0" width="20"/></td>
                    <td valign="top" colspan="2"><a class="EvHeaderText">Download Selected Records</a></td>
                </tr>
                <tr>
                    <td valign="top" width="20"><img src="/engresources/images/s.gif" border="0" width="20"/></td>
                    ...
                    <tr>
                        ...
                        <form name="feedback" method="post" onSubmit="return validate('$SESSIONID','{$DISPLAY-FORMAT}');">
                            ...
                            <table border="0" width="300" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td valign="top" height="15" colspan="2"><img src="/engresources/images/s.gif" border="0" height="15"/></td>
                                </tr>
                            ...
                            <!--    <xsl:choose>
                                ...
                                <tr>
                                    <td valign="top" colspan="2"><A CLASS="MedBlackText"><input type="submit" name="submit" value="Download"/></A></td>
                                </tr>
                            </table>
