...
-->
		...
		<tr>
			<td valign="top" colspan="5" height="15"><img src="/engresources/images/spacer.gif" border="0" height="15"/></td>
		</tr>
		<tr>
			<td valign="top" align="right">
				<A href="/controller/servlet/Controller?CID=deleteFromSelectedSet&amp;viewType=abstractSelectedSet&amp;docid={$DOC-ID}&amp;basketsize={$RESULTS-COUNT}&amp;handle={$INDEX}&amp;DATABASETYPE={$RESULTS-DATABASE}&amp;searchresults={$ENCODED-RESULTS-NAV}&amp;newsearch={$ENCODED-NEWSEARCH-NAV}"><img src="/engresources/images/remove.gif" border="0"/></A>
			</td>
			...
			<td valign="top" width="4"><img src="/engresources/images/spacer.gif" border="0" width="3"/></td>
