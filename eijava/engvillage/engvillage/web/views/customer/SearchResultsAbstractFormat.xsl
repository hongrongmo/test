        ...
        function initialize() {
          if (GBrowserIsCompatible()) {
            ...
            <xsl:for-each select="PAGE-RESULTS/PAGE-ENTRY/EI-DOCUMENT/CRDN/RECT">
              ...
              marker = new GMarker(rectangle.getCenter(),{title:ptname, clickable:false});
  ...
  <xsl:template match="PAGE-ENTRY">
    ...
    <tr>
      ...
      <td valign="top" width="3">
        <img src="/engresources/images/s.gif" border="0" width="3" name="image_basket" />
      </td>
      <td valign="top">
        ...
        <tr>
          ...
          <td align="left" colspan="3">
            <a title="Full-text" onclick="window.open('/controller/servlet/Controller?CID=FullTextLink&amp;docID={$DOC-ID}','newwindow','width=500,height=500,toolbar=no,location=no,scrollbars,resizable');return false">
              <img id="ftimg" src="/engresources/images/av.gif" alt="Full-text" />
            </a>
          </td>
        </tr>
      </xsl:when>
