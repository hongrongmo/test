...
<head>
    ...
    <SCRIPT LANGUAGE="Javascript" SRC="/engresources/js/SaveToFolder.js"/>
</head>
...
<body bgcolor="#FFFFFF" topmargin="0" marginheight="0" marginwidth="0">
  ...
  <table border="0" width="99%" cellspacing="0" cellpadding="0" bgcolor="#C3C8D1">
    <tr height="24"><td bgcolor="#C3C8D1" ><img src="/engresources/images/s.gif" /></td></tr>
  </table>
  </center>
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
      <tr><td valign="top" height="4" colspan="4"><img src="/engresources/images/s.gif" border="0" height="4"/></td></tr>
        ...
        <xsl:choose>
            ...
            <tr><td valign="top" height="4" colspan="4"><img src="/engresources/images/s.gif" border="0" height="8"/></td></tr>
            <tr>
              <td valign="top" width="4"><img src="/engresources/images/s.gif" border="0" width="4"/></td>
                        <td valign="top" colspan="2">
                        <a CLASS="SmBlackText">
        ...
        <xsl:if test="($NUMBER-OF-FOLDERS = 1) or ($NUMBER-OF-FOLDERS = 2)">
          ...
          <xsl:if test="($NUMBER-OF-FOLDERS = 0) or ($NUMBER-OF-FOLDERS = 3)">
            <xsl:attribute name="colspan">2</xsl:attribute>
                ...
                <input type="image" src="/engresources/images/sav.gif" name="submit" value="Submit"/> &#160; &#160;
                <input type="image" src="/engresources/images/cancel.gif" name="cancel" value="Cancel"><xsl:attribute name="onclick">javascript:document.location='/controller/servlet/Controller?<xsl:value-of select="java:decode(BACKURL)"/>';return false;</xsl:attribute></input> &#160; &#160;
                </td>
                <td valign="top" width="4"><img src="/engresources/images/s.gif" border="0" width="4"/></td>
            </tr>
            <tr><td valign="top" height="4" colspan="4"><img src="/engresources/images/s.gif" border="0" height="4"/></td></tr>
  ...
  <xsl:if test="boolean($DOCUMENT-COUNT = 0)">
    ...
    <table border="0" width="99%" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
        ...
        <tr><td valign="top" width="20"><img src="/engresources/images/s.gif" border="0" width="20"/></td><td valign="top" colspan="2"><a class="EvHeaderText">Selected Records</a></td></tr>
        <tr><td valign="top" height="2" colspan="3"><img src="/engresources/images/s.gif" border="0"/></td></tr>
        <tr><td valign="top" width="20"><img src="/engresources/images/s.gif" border="0" width="20"/></td><td valign="top">
        ...
        </td><td valign="top" width="10"><img src="/engresources/images/s.gif" border="0" width="10"/></td></tr>
    </table>
