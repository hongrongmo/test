...
<xsl:template match="/">
  ...
  <TABLE cellSpacing="0" cellPadding="0" width="99%" border="0">
    <TR>
      ...
      <img src="/engresources/images/close.gif" border="0"/></a></TD>
    </TR>
    <TR>
      <TD colspan="2" vAlign="top" height="5"><IMG height="5" src="/engresources/images/spacer.gif" border="0"/></TD></TR>
    <TR>
    ...
    <TR>
      ...
      <IMG height="10" src="/engresources/images/spacer.gif"  border="0"/></TD>
    </TR>
    </TABLE>
  <TABLE width="100%" border="0">
    ...
    <TR>
      <TD colspan="3" height="5"><img src="/engresources/images/s.gif" height="5"/></TD>
    </TR>
    </xsl:if>
    ...
    <TR>
      ...
      <a class="MedBlackText"><b>AUTHOR:</b></a>
        ...
        <td width="5"><img src="/engresources/images/s.gif" width="5"/>
        </td>
        <TD align="left" width="75%">
        <a class="MedBlackText">
            <xsl:value-of select="$AUTHOR" />
    ...
    <TR><TD colspan="3" height="20"><img src="/engresources/images/s.gif" height="20" border="0"/></TD></TR>
  </TABLE></TD>
    </TR>
    <TR>
      <TD width="10%"></TD>
  ...
  <tr><td>
  <center><A CLASS="SmBlackText">&#169; 2010 Elsevier Inc. All rights reserved.</A></center>
  </td></tr>
  </table>
  </BODY>
  </HTML>
