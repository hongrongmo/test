    ...
    <HEAD>
        ...
        <xsl:comment>
            ...
            function toggleAnnotations()
            {
              ...
              {
                document.images["highlights"].src = "/engresources/images/t_off.jpg";
              }
            }
          ...
          <TD width="45%">
            <form style="margin:0;padding:0;text-align:right;" name="pagesel" onsubmit="javascript:return manualPbookPageSelect();" method="POST">
              ...
              <a>
                ...
                <img class="button" src="/engresources/images/bk_fp.gif" alt="First Page"/>
              </a>
              <a id="pp">
                ...
                <img class="button" src="/engresources/images/bk_pp.gif" alt="Previous Page"/>
              </a>
              ...
              <a id="np">
                ...
                <img class="button" src="/engresources/images/bk_np.gif" alt="Next Page"/>
              </a>
              <a>
                ...
                <img class="button" src="/engresources/images/bk_lp.gif" alt="Last Page"/>
              </a>
            </form>
