...
<xsl:template match="PAGE">
   ...
   <!--  <a href="/controller/servlet/Controller?CID=home"><img src="/engresources/images/ev2logo5.gif" border="0"/></a> -->
	...
	<tr>
		<td>&nbsp;</td>
		<td height="15"><img src="/engresources/images/s.gif" height="15"/></td>
		<td>&nbsp;</td>
	</tr>
	...
	<tr>
		<td></td>
		<td height="8"><img src="/engresources/images/s.gif" height="8"/></td>
		<td></td>
	</tr>
	<tr>
		<td>&nbsp;</td>
	...
	<tr>
		<td></td>
		<td height="4"><img src="/engresources/images/s.gif" height="4"/></td>
		<td></td>
	</tr>
	<tr>
		<td>&nbsp;</td>
		...
		<input type="image" src="/engresources/images/login.gif" alt="Accept Invitation" border="0"/>
        </td>
		<td>&nbsp;</td>
	</tr>
	...
	<tr>
		<td>&nbsp;</td>
		<td height="100"><img src="/engresources/images/s.gif" height="100	"/></td>
		<td>&nbsp;</td>
	</tr>
	</form>
	</table>
