...
<head>
        ...
        <SCRIPT LANGUAGE="Javascript" SRC="/engresources/js/ThesaurusForm_V7.js"/>
...
<table border="0" cellspacing="0" cellpadding="0" width="99%">
    <tr>
                ...
                <td valign="top" width="150">
                    ...
                    <tr>
                        <td valign="top" height="1">
                            <img src="/engresources/images/spacer.gif" border="0" width="150" height="1"/>
        ...
        <xsl:choose>
            <xsl:when test="($CONTEXT != 'T')">
                <td valign="top" width="70">
                    ...
                    <tr>
                        <td valign="top" height="1">
                            <img src="/engresources/images/spacer.gif" border="0" width="30" height="1"/>
        ...
        <FORM NAME="clipboard" OnSubmit="javascript:return runValidate();" METHOD="POST" TARGET="_top" ACTION="/controller/servlet/Controller?CID=thesSearchCitationFormat">
            <table border="0" cellspacing="0" cellpadding="0" width="99%">
                <tr>
                    <td valign="top" colspan="9"><img src="/engresources/images/spacer.gif" border="0" height="4"/></td>
                </tr>
                <tr>
			...
			<a href="javascript:makeUrl('Limits.htm')">
                ...
                <tr>
                    <td valign="top" colspan="5"><img src="/engresources/images/spacer.gif" border="0" width="4"/></td>
                    <td valign="top" colspan="3"><img src="/engresources/images/spacer.gif" border="0" width="4"/></td>
                </tr>
			...
			<a href="javascript:makeUrl('Limits.htm')"><img src="/engresources/images/blue_help1.gif" border="0"/></a>
                ...
                <tr>
                    <td valign="top" colspan="5"><img src="/engresources/images/spacer.gif" border="0" width="4"/></td>
                    <td valign="top" colspan="2"><img src="/engresources/images/spacer.gif" border="0" width="4"/></td>
                </tr>
		...
		<a href="javascript:makeUrl('Date_Limits.htm')">
		    <img src="/engresources/images/blue_help1.gif" border="0"/>
                    ...
                    <td valign="top" ><img src="/engresources/images/spacer.gif" border="0" width="4"/></td>
                    <td valign="top" >
                        <INPUT type="image" src="/engresources/images/search_yellow.gif" border="0"/>
                        <xsl:choose>
                            <xsl:when test="($CONTEXT = 'T')">
                                &#160; <a href="javascript:resetForm()"><img src="/engresources/images/reset_yellow.gif" border="0"/></a>
                            </xsl:when>
                        </xsl:choose>
            &#160; <a href="javascript:removeSelected()"><img src="/engresources/images/remove_yellow.gif" border="0"/></a>
                        <xsl:choose>
                            <xsl:when test="($CONTEXT != 'T')">
                                &#160; <a href="/controller/servlet/Controller?CID=thesFrameSet&amp;searchID={$QUERY-ID}&amp;database={$DATABASE}"><img src="/engresources/images/thesrefine.gif" border="0"/></a>
                            </xsl:when>
                        </xsl:choose>
                    </td>
                </tr>
                ...
                <tr>
                    <td valign="top" colspan="9"><img src="/engresources/images/spacer.gif" border="0" width="4"/></td>
                </tr>
            </table>
