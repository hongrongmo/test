...
<form name="checkform">
	...
	<tr><td valign="top" height="10" colspan="5"><img src="/engresources/images/spacer.gif" border="0" height="10"/></td></tr>
...
<tr><td valign="top" height="20" bgcolor="#C3C8D1"><img src="/engresources/images/spacer.gif" border="0" height="20"/></td></tr>
</table>
...
<xsl:template match="BT">
	...
	<table border="0" cellspacing="0" cellpadding="0" width="230">
		<tr>
			<td valign="top" width="6"><img src="/engresources/images/spacer.gif" border="0" width="6"/></td><td valign="top" width="100%"><a CLASS="SmBlackText"><u><b>Broader Terms</b></u></a></td><td valign="top" width="10"><img src="/engresources/images/spacer.gif" border="0" width="10"/></td><td valign="top"><a CLASS="SmBlackText"><b><u>Select</u></b></a></td><td valign="top" width="5"><img src="/engresources/images/spacer.gif" border="0" width="5"/></td>
...
<xsl:template match="LT">
	<tr>
		<td valign="top"><a CLASS="MedBlackText">&#160;&#160;<b>Used for: </b></a></td>
		 <td valign="top" width="6"><img src="/engresources/images/spacer.gif" border="0" width="6"/></td>
		    <td valign="top">
...
<xsl:template match="RT">
	...
	<table border="0" cellspacing="0" cellpadding="0" width="230">
		<tr>
			<td valign="top" width="6"><img src="/engresources/images/spacer.gif" border="0" width="6"/></td><td valign="top" width="100%"><a CLASS="SmBlackText"><u><b>Related Terms</b></u></a></td><td valign="top" width="10"><img src="/engresources/images/spacer.gif" border="0" width="10"/></td><td valign="top"><a CLASS="SmBlackText"><b><u>Select</u></b></a></td><td valign="top" width="5"><img src="/engresources/images/spacer.gif" border="0" width="5"/></td>
...
<xsl:template match="NT">
	...
	<table border="0" cellspacing="0" cellpadding="0" width="230">
		<tr>
			<td valign="top" width="6"><img src="/engresources/images/spacer.gif" border="0" width="6"/></td><td valign="top" width="100%"><a CLASS="SmBlackText"><u><b>Narrower Terms</b></u></a></td><td valign="top" width="10"><img src="/engresources/images/spacer.gif" border="0" width="10"/></td><td valign="top"><a CLASS="SmBlackText"><b><u>Select</u></b></a></td><td valign="top" width="5"><img src="/engresources/images/spacer.gif" border="0" width="5"/></td>
			<!-- Explode commented as of now
			<td valign="top"><a CLASS="SmBlackText"><b><u>Explode</u></b></a></td>
			-->
		</tr>
...
<tr><td valign="top" height="4" colspan="5"><img src="/engresources/images/spacer.gif" border="0" height="4"/></td></tr>
...
<xsl:template match="TREC" mode="SUGGESTED_TERMS">
	...
	<tr>
		<td valign="top" width="15" height="1">
			<img src="/engresources/images/spacer.gif" border="0" width="15" height="1"/>
		</td>
		<td valign="top">
			<a CLASS="RollLink" href="/controller/servlet/Controller?CID=thesFullRec&amp;term={$MT}&amp;database={$DATABASE}"><xsl:apply-templates select="ID/MT" mode="SIMPLE"/></a>
		</td>
	</tr>
</xsl:template>
...
<tr>
	...
	<td valign="top" width="10"><img src="/engresources/images/spacer.gif" border="0" width="10"/>
	</td>
	<td valign="top">
	<xsl:variable name="MTP">
		<xsl:value-of select="sutil:replaceSingleQuotes(ID/MT)" disable-output-escaping="yes"/>
	...
	<img src="/engresources/images/spacer.gif" border="0" width="5"/>
	</td>
...
<xsl:template match="LE" mode="TERM">
	<td valign="top" colspan="5">&#160;
	<a CLASS="DBlueText"><b><i><xsl:value-of select="." disable-output-escaping="yes"/></i></b></a></td>
</xsl:template>
