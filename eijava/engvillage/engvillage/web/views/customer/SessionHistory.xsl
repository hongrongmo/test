    ...
    <table border="0" width="99%" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td valign="top" height="3" colspan="7">
          <img src="/engresources/images/s.gif" border="0" height="3"/>
        </td>
      </tr>
      ...
      <tr>
        ...
        <tr>
          ...
          <td valign="top" width="4" bgcolor="#3173B5"><img src="/engresources/images/s.gif"/></td>
          <td valign="top" bgcolor="#3173B5"><A CLASS="SmWhiteText"><b>Search</b></A><img src="/engresources/images/s.gif" height="1" width="125"/></td>
          <td valign="top" width="4" bgcolor="#3173B5"><img src="/engresources/images/s.gif"/></td>
          <td valign="top" bgcolor="#3173B5"><A CLASS="SmWhiteText"><b>Autostem</b></A></td>
          <td valign="top" width="4" bgcolor="#3173B5"><img src="/engresources/images/s.gif"/></td>
          <td valign="top" bgcolor="#3173B5"><img src="/engresources/images/s.gif" width="12" /></td>
          ...
          <td valign="top" width="4" bgcolor="#3173B5"><img src="/engresources/images/s.gif"/></td>
          <td valign="top" bgcolor="#3173B5" width="88"><A CLASS="SmWhiteText"><b>E-mail Alert</b></A></td>
          <td valign="top" width="4" bgcolor="#3173B5"><img src="/engresources/images/s.gif"/></td>
          <td valign="top" bgcolor="#3173B5" width="88"><A CLASS="SmWhiteText"><b>Save Search</b></A></td>
        </tr>
        <tr>
          <td valign="top" colspan="21" height="15"><img src="/engresources/images/s.gif" height="15"/></td>
        </tr>
        ...
        <xsl:for-each select="/PAGE/SESSION-HISTORY/SESSION-DATA">
          ...
          <tr>
            ...
            <td valign="top" width="4"><img src="/engresources/images/s.gif"/></td>
            ...
            <td valign="top">
                ...
                <xsl:if test="DUPSET/CRITERIA/DBPREF">
                  ...
                  <xsl:for-each select="DUPSET/CRITERIA">
                    ...
                    <tr>
                        <td >
                            <a class="SrtLink"><xsl:attribute name="href">/controller/servlet/Controller?CID=dedup&amp;SEARCHID=<xsl:value-of select="$QUERY-ID"/>&amp;COUNT=1&amp;database=<xsl:value-of select="$DATABASE-MASK"/>&amp;origin=history&amp;fieldpref=<xsl:value-of select="$FIELDPREF"/>&amp;dbpref=<xsl:value-of select="$DBPREF"/></xsl:attribute><xsl:number/>.</a>
                        </td>
                        <td >
            ...
            <td align="middle" valign="top" ><img src="/engresources/images/{SORT-DIRECTION}ar.gif"/></td>
            <td valign="top"><a CLASS="MedBlackText">
                  ...
                  <xsl:when test="($PERSONALIZATION='true')">
                    ...
                    <xsl:choose>
                      <xsl:when test="($SAVEDSEARCH='On')">
                        <img src="/engresources/images/saved_blue.gif" border="0">
                        <xsl:attribute name="name"><xsl:value-of select="concat('image',$SEARCH-INDEX)"/></xsl:attribute>
                        </img>
                      </xsl:when>
                      <xsl:otherwise>
                        <img src="/engresources/images/save_blue.gif" border="0">
                        <xsl:attribute name="name"><xsl:value-of select="concat('image',$SEARCH-INDEX)"/></xsl:attribute>
                        </img>
                      </xsl:otherwise>
                    </xsl:choose>
...
<!-- jam - QUERY-ID is the id of this history element
      ...
      <xsl:when test="boolean($COMPLETE-SEARCH-HISTORY='true')">
        <tr>
          ...
          <td valign="top" colspan="10" align="left">
            ...
            <a href="/controller/servlet/Controller?CID=clearSearchHistory&amp;COUNT={$CURRENT-PAGE}&amp;database={$DATABASE-MASK-PAGE}&amp;SEARCHID={$SEARCH-ID}&amp;searchResultsFormat={$CID}&amp;SEARCHTYPE={$CURR-SEARCH-TYPE}"><img src="/engresources/images/clearsessionhistory.gif" border="0"/></a>
            </xsl:if>
          </td>
       ...
       <tr>
        <td valign="top" colspan="21" height="8"><img src="/engresources/images/s.gif" height="8"/></td>
       </tr>
       <tr>
        <td valign="top" bgcolor="#3173B5" height="1" colspan="21"><img src="/engresources/images/s.gif" height="1"/></td>
       </tr>
    </table>
  </td>
  ...
  <tr>
    <td valign="top" height="8" colspan="3"><img src="/engresources/images/s.gif" height="8" border="0"/></td>
  </tr>
</table>
</form>
