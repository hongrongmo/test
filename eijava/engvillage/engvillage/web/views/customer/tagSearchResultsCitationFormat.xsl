...
<xsl:template match="PAGE">
    ...
    <SCRIPT LANGUAGE="Javascript" SRC="/engresources/js/AutocompleteTagSearch.js"/>
   ...
   <xsl:variable name="REF-CNT">
    ...
    <!-- Show book summary if this is a Referex Book Record (page 0) or a Referex Page Record (page != 0) -->
		<xsl:if test="(EI-DOCUMENT/DOC/DB/DBMASK = '131072')">
		      ...
		      <a class="LgBlueLink" TITLE="Page Details" HREF="/controller/servlet/Controller?CID=tagSearchAbstractFormat&amp;SEARCHID={$ENCODED-SEARCH-ID}&amp;DOCINDEX={$INDEX}&amp;database={$SELECTED-DB}&amp;tagscope={$SCOPE}&amp;format={$CID-PREFIX}AbstractFormat">Page Details</a>
