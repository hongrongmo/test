  	...
  	<center>
  		<table border="0" width="99%" cellspacing="0" cellpadding="0">
            ...
            <xsl:when test="string(/PAGE/CONFIRM)">
      				  <tr><td valign="top" height="4" colspan="2"><a CLASS="MedBlackText">Thank You</a></td></tr>
                <FORM name="cclist">
                  ...
                  <xsl:when test="/PAGE/CONFIRM='editcclist'"> <!-- editied -->
                    <xsl:text disable-output-escaping="yes">
                      ...
                      <script language="javascript">
                        ...
                        {
                          opener.document.images[document.cclist.savedsearchid.value].src="/engresources/images/ccg.gif";
              	        }
              				</script>
                		]]>
                    </xsl:text>
                  ...
                  <xsl:otherwise> <!-- deleted -->
                    <xsl:text disable-output-escaping="yes">
                      ...
                      <script language="javascript">
                        if(typeof(opener) != 'undefined') 
                        {
                          opener.document.images[document.cclist.savedsearchid.value].src="/engresources/images/cco.gif";
              	        }
              				</script>
                		]]>
                    </xsl:text>
            ...
            <xsl:otherwise>
              ...
              <tr><td colspan="2" valign="top" height="3"><img src="/engresources/images/spacer.gif" border="0" height="3"/></td></tr>
                ...
                <textarea type="text" name="list" rows="5" cols="40" maxlength="4000">
                  ...
                  <a CLASS="MedBlackText"><input type="submit" name="notsubmit" value="Submit"/>
