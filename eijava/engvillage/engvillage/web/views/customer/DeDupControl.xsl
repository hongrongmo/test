...
<!-- CS added template for new dedup control -->
  <table border="0" width="100%" cellspacing="0" cellpadding="0">
    ...
    <tr>
      ...
      <td valign="top">
      <a NAME="removedup">
      <form name="removedup" action="/controller/servlet/Controller?EISESSION={$SESSION-ID}&amp;CID=dedup&amp;SEARCHID={$SEARCH-ID}&amp;COUNT={$CURRENT-PAGE}&amp;RESULTSCOUNT={$RESULTS-COUNT}&amp;database={$DATABASE}&amp;DupFlag=true" method="POST">
...
<tr><td valign="top" colspan="3" height="5"><img src="/engresources/images/s.gif"/></td></tr>
<tr><td valign="top" colspan="3" height="20"><img src="/engresources/images/s.gif"/></td></tr>
<tr><td valign="top" align="right">&#160; </td><td valign="middle"><a class="MedBlackText"><xsl:value-of select="$HIT-INDEX" />.</a></td><td valign="top" width="4"><img src="/engresources/images/s.gif" width="4" /></td>
...
<tr><td valign="top" colspan="3" height="80"><img src="/engresources/images/s.gif"/></td></tr>
</xsl:template>
