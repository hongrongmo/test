                    ...
                    <!-- Content Goes Here -->
                  		...
                  		<table border="0" cellspacing="0" cellpadding="0" width="100%" >
                  			...
                  			<FORM name="register" action="/controller/servlet/Controller?CID=updatePersonalAccount&amp;database={$DATABASE}&amp;count={$COUNT}&amp;searchid={$SEARCH-ID}" METHOD="POST"  onSubmit="return validateregister(register)" >
                  				...
                  				<tr><td colspan="4" align="right" ><a href="javascript:deleteAlert({$DATABASE});"><img src="/engresources/images/removeaccount.gif" border="0"/></a>&#160;</td></tr>
                  				...
                  				<xsl:if test="($EMAIL-EXISTS='true')">
                  					<tr>
                  						...
                  						<!-- display the error message if the email already exists in the system. -->
                  											Your e-mail address already exists in the system.
                  								Please use login form, or choose another e-mail address.
                  						</a></td>
                  					</tr>
                  				</xsl:if>
                  				...
                  				<tr>
                  					...
                  					<td valign="top" width="1" ><img src="/engresources/images/s.gif" border="0"/></td>
                  				...
                  				<tr>
                  					<td valign="top" width="3" ><img src="/engresources/images/s.gif" border="0" width="3"/></td>
                  					<td valign="top" ><font color="red"><b>*</b></font><a CLASS="MedBlackText">E-mail address: </a></td>
                  					<td valign="top" width="1" ><img src="/engresources/images/s.gif" border="0"/></td>
                  					<td valign="top" ><a CLASS="MedBlackText">
                  				...
                  				<tr>
                  					...
                  					<td valign="top" colspan="3" >
                  						...
                  						<input type="image" src="/engresources/images/sub.gif" name="submit" value="Submit"/> &#160; &#160;
                  						<input type="image" src="/engresources/images/cancel.gif" name="cancel" value="Cancel" onclick="javascript:document.location='/controller/servlet/Controller?EISESSION=$SESSIONID&amp;CID=myprofile&amp;database={$DATABASE}'; return false;"/> &#160; &#160;
                  						<input type="image" src="/engresources/images/res.gif" name="reset" value="Reset" onclick="javascript:reset(); return false;"/> &#160; &#160;
                            </td>
                  				</tr>
                  ...
                  <tr>
                    ...
                    <td colspan="3">
                      <!-- Content Goes Here -->
              				...
              				<table border="0" cellspacing="0" cellpadding="0" width="100%" >
              					<tr><td valign="top" height="8"><img src="/engresources/images/s.gif" border="0" height="8"/></td></tr>
              					<tr>
              						<td valign="top"><a CLASS="MedBlackText">
              								Your personal account has been updated successfully.
              								An updated account confirmation message has been sent to your e-mail address.
              						</a></td>
              					</tr>
              					<tr><td valign="top" height="8"><img src="/engresources/images/s.gif" border="0" height="8"/></td></tr>
              				</table>
