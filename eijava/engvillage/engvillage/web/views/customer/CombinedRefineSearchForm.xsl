...
<xsl:param name="SORT-OPTION"/>
  ...
  <SCRIPT LANGUAGE="Javascript" SRC="/engresources/js/CombinedSearchForm.js"/>
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="99%" bgcolor="#C3C8D1">
        ...
        <tr>
            ...
            <td valign="top" width="15">
                <img src="/engresources/images/s.gif" width="15"/>
            </td>
        ...
        <tr>
            ...
            <td valign="top" width="7">
                <img src="/engresources/images/s.gif" width="7"/>
            </td>
            <td valign="top" width="7">
                <img src="/engresources/images/s.gif" width="7"/>
            </td>
            ...
            <td valign="top">
                 ...
                 <A CLASS="MedBlackText" onClick="return searchValidation()">
                       <input type="image" src="/engresources/images/search_orange1.gif" border="0"/>
                 </A>&#160;
