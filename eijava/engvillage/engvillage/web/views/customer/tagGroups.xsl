...
<xsl:strip-space elements="html:* xsl:*" />
  ...
  <xsl:template match="TGROUP">
    ...
    <xsl:choose>
		...
		<img src="/engresources/images/grDelete.gif" border="0" alt="Delete Group" />
		</a>
		<br/>
    	</xsl:when>
    	<xsl:otherwise>
    ...
    <center>
      ...
      <form style="margin:0px; padding:0px;" name="taggroup" action="/controller/servlet/Controller?CID=tagGroup&amp;database={$DATABASE}"  method="POST">
        ...
        <table border="0" width="99%" cellpadding="0" cellspacing="0">
          <tr colspan="3">
            <td width ="20%" >&#160;</td>
            <td height="40"><img src="/engresources/images/s.gif" height="40"/></td>
            <td width ="10%">&#160;</td>
          </tr>
          <tr colspan="3">
            <td width ="20%"><img width="18" height="1" src="/engresources/images/s.gif" border="0" /><a title= "Create a New Group" CLASS="LgBlueLink" href="/controller/servlet/Controller?CID=tagCreateGroup">Create a New Group (+)</a></td>
            <td>&#160;</td>
            <td width="10%">&#160;</td>
          </tr>
          <tr colspan="3">
          ...
          <tr colspan="3">
            <td width ="20%">&#160;</td>
            <td height="5"><img src="/engresources/images/s.gif" height="5"/></td>
            <td width ="10%">&#160;</td>
          </tr>
        </table>
      </form>
