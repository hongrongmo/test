    ...
    <xsl:when test="($NUMSEARCHS>0)">
      ...
      <center>
        ...
        <table border="0" cellspacing="0" cellpadding="0" width="99%" bgcolor="#C3C8D1">
          <tr>
              <td valign="top" height="10" colspan="7" bgcolor="#FFFFFF"><img src="/engresources/images/s.gif" height="10" border="0"/></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td valign="top" width="15">
              <img src="/engresources/images/s.gif" border="0" width="15"/>
            </td>
		...
		<a href="javascript:makeUrl('Sorting_from_the_Search_Form.htm')">
          ...
          <tr>
            <td valign="top" height="4" colspan="7"><img src="/engresources/images/s.gif" border="0" height="4"/></td>
          </tr>
          </FORM>
        </table>
          ...
          <tr>
            ...
            <td valign="top" bgcolor="#FFFFFF">
              ...
              <table border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td valign="top" height="10" colspan="3"><img src="/engresources/images/s.gif" border="0" height="10"/></td>
                </tr>
                <tr>
                  ...
                  <td valign="top" width="2">
                    <img src="/engresources/images/s.gif" border="0" width="2"/>
                  </td>
                </tr>
                <tr>
                  <td valign="top" height="10" colspan="3"><img src="/engresources/images/s.gif" border="0" height="10"/></td>
