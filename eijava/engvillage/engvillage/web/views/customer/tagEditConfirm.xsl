...
<br/>
	...
	<a CLASS="LgBlueLink" href="/controller/servlet/Controller?CID=tagSearch&amp;COUNT=1&amp;database={$DATABASE}&amp;scope={$SCOPE}&amp;searchtags={$SEARCH-TAGS}">search results</a> <span CLASS="MedBlackText">, 
