          ...
          <xsl:choose>
            <xsl:when test="($SEARCH-TYPE='Easy') and ($LOCATION='Top')">
              <form style="margin-bottom:0;" name="shortsearch" method="post" action="/controller/servlet/Controller" onsubmit="return shortSearchValidation(this);">
                  ...
                  <img src="/engresources/images/rs.gif" border="0" />
                  </a>
                  <img width="8" height="1" src="/engresources/images/s.gif" border="0" />
                  <a class="SmBlackText">
                    <input style="vertical-align:text-bottom;" class="SmBlackText" type="text" name="searchWord1" size="30" maxlength="256"/>
                    <img width="8" height="1" src="/engresources/images/s.gif" border="0" /><img width="8" height="1" src="/engresources/images/s.gif" border="0" />
                  ...
                  <img width="8" height="1" src="/engresources/images/s.gif" border="0" />
                  <input type="image" src="/engresources/images/go_1.gif" name="search" value="Search" border="0"/>
                  <img width="8" height="1" src="/engresources/images/s.gif" border="0" />
              </form>
            ...
            <table cellspacing="0" cellpadding="0" border="0">
                <tr>
                    <td align="right" valign="middle" height="24">
                      ...
                      <img width="8" height="1" src="/engresources/images/s.gif" border="0" />
                      <xsl:if test="(boolean(($INDEX-VALUE + $RESULTS-PER-PAGE - 1) &lt; $RESULTS-COUNT) and (not($RESULTS-COUNT=$RESULTS-PER-PAGE)))">
