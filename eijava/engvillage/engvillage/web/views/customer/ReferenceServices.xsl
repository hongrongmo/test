...
<table border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td><a href="javascript:;" onclick="toggleDivLayers('Layer12');MM_nbGroup('down','group2','Chemical','/engresources/images/ae/Chemical.gif',0)" onmouseover="MM_nbGroup('over','Chemical','/engresources/images/ae/Chemical_over.gif','',0)" onmouseout="MM_nbGroup('out')"><img src="/engresources/images/ae/Chemical.gif" alt="Chemical" name="Chemical" width="108" height="128" border="0" id="Chemical" onload="MM_nbGroup('init','group2','Chemical','/engresources/images/ae/Chemical_down.gif',0)" /></a></td>
    ...
    <td><a href="javascript:;" onclick="toggleDivLayers('Layer1'); MM_nbGroup('down','group2','Mechanical','/engresources/images/ae/Mechanical.gif',0)" onmouseover="MM_nbGroup('over','Mechanical','/engresources/images/ae/Mechanical_over.gif','',0)" onmouseout="MM_nbGroup('out')"><img src="/engresources/images/ae/Mechanical.gif" alt="Mechanical" name="Mechanical" width="108" height="128" border="0" id="Mechanical" onload="MM_nbGroup('init','group2','Mechanical','/engresources/images/ae/Mechanical_down.gif',0)" /></a></td>
    <td><a href="javascript:;" onclick="toggleDivLayers('Layer8'); MM_nbGroup('down','group2','Electrical','/engresources/images/ae/Electrical.gif',0)" onmouseover="MM_nbGroup('over','Electrical','/engresources/images/ae/Electrical_over.gif','',0)" onmouseout="MM_nbGroup('out')"><img src="/engresources/images/ae/Electrical.gif" alt="Electrical" name="Electrical" width="108" height="128" border="0" id="Electrical" onload="MM_nbGroup('init','group2','Electrical','/engresources/images/ae/Electrical_down.gif',0)" /></a></td>
    <td><a href="javascript:;" onclick="toggleDivLayers('Layer3'); MM_nbGroup('down','group2','SignalProcessing','/engresources/images/ae/SignalProcessing.gif',0)" onmouseover="MM_nbGroup('over','SignalProcessing','/engresources/images/ae/SignalProcessing_over.gif','',0)" onmouseout="MM_nbGroup('out')"><img src="/engresources/images/ae/SignalProcessing.gif" alt="Signal Processing" name="SignalProcessing" width="108" height="128" border="0" id="SignalProcessing"  onload="MM_nbGroup('init','group2','SignalProcessing','/engresources/images/ae/SignalProcessing_down.gif',0)" /></a></td>
    <td><a href="javascript:;" onclick="toggleDivLayers('Layer2'); MM_nbGroup('down','group2','Manufacturing','/engresources/images/ae/Manufacturing.gif',0)" onmouseover="MM_nbGroup('over','Manufacturing','/engresources/images/ae/Manufacturing_over.gif','',0)" onmouseout="MM_nbGroup('out')"><img src="/engresources/images/ae/Manufacturing.gif" alt="Manufacturing" name="Manufacturing" width="108" height="128" border="0" id="Manufacturing" onload="MM_nbGroup('init','group2','Manufacturing','/engresources/images/ae/Manufacturing_down.gif',0)" /></a></td>
    ...
    <td><a href="javascript:;" onclick="toggleDivLayers('Layer9'); MM_nbGroup('down','group2','Management','/engresources/images/ae/Management-.gif',0)" onmouseover="MM_nbGroup('over','Management','/engresources/images/ae/Management_over.gif','',0)" onmouseout="MM_nbGroup('out')"><img src="/engresources/images/ae/Management-.gif" alt="Engineering Management" name="Management" width="108" height="128" border="0" id="Management" onload="MM_nbGroup('init','group2','Management','/engresources/images/ae/Management_down.gif',0)" /></a></td>
    <td><a href="javascript:;" onclick="toggleDivLayers('Layer11');MM_nbGroup('down','group2','Computer','/engresources/images/ae/Computer-.gif',0)" onmouseover="MM_nbGroup('over','Computer','/engresources/images/ae/Computer_over.gif','',0)" onmouseout="MM_nbGroup('out')"><img src="/engresources/images/ae/Computer-.gif" alt="Computer" name="Computer" width="108" height="128" border="0" id="Computer" onload="MM_nbGroup('init','group2','Computer','/engresources/images/ae/Computer_down.gif',0)" /></a></td>
  </tr>
</table>
