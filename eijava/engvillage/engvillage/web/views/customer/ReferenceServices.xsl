...
<table border="0" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td><a href="javascript:;" target="_top" onclick="toggleDivLayers('Layer9');MM_nbGroup('down','group2','Management','/engresources/images/ae/Management-.gif',0)" onmouseover="MM_nbGroup('over','Management','/engresources/images/ae/Management_over.gif','',0)" onmouseout="MM_nbGroup('out')"><img src="/engresources/images/ae/Management-.gif" alt="Management" name="Management" width="108" height="128" border="0" id="Management" onload="MM_nbGroup('init','group2','Management','/engresources/images/ae/Management_down.gif',0)" /></a></td>
