            			...
            			<Form name="feedback" method="post" action="/controller/servlet/Controller?EISESSION=$SESSIONID&amp;CID=FeedbackConfirmation&amp;database={$DBMASK}" onsubmit="return validForm(feedback)">
            				<table border="0" width="100%" cellspacing="0" cellpadding="0">
            					...
            					<tr><td valign="top">
            						...
            						<input type="image" src="/engresources/images/cancel.gif" name="cancel" value="Cancel" onclick="javascript:document.location='/controller/servlet/Controller?EISESSION=$SESSIONID'; return false;"/> &#160; &#160;
