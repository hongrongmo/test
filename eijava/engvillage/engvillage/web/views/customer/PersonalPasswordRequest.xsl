                  ...
                  <!-- Content Goes Here -->
                    ...
                    <FORM name="personallogin" action="/controller/servlet/Controller?CID=sendPersonalPassword" METHOD="POST"  onSubmit="return validateLogin(personallogin)" >
                    	...
                    	<xsl:if test="($EMAIL-EXISTS='false')">
                    		<tr><td valign="top" colspan="2"><a CLASS="RedText">The E-mail you provided is not in system</a></td></tr>
                    	</xsl:if>
                    	<tr>
                    		<td valign="top" height="4" ><img src="/engresources/images/spacer.gif" border="0" height="3"/></td>
                    		<td valign="top" >
                    			<a CLASS="MedBlackText">Please enter your E-mail address and your password will be sent to that E-mail address. </a>
                    		</td>
                    	</tr>
                    	<tr><td valign="top" height="4"  colspan="2"><img src="/engresources/images/spacer.gif" border="0" height="3"/></td></tr>
                    	<tr>
                    		<td valign="top" width="3" ><img src="/engresources/images/spacer.gif" border="0" width="3"/></td>
                    		<td valign="top" ><a CLASS="MedBlackText">
                    			E-mail address: <BR/><input type="text" name="email" size="28"/>
                    		</a></td>
                    	</tr>
                    	...
                    	<tr>
                          ...
                          <input type="image" src="/engresources/images/cancel.gif" name="cancel" value="Cancel">
                            <xsl:choose>
...
<center>
  <table border="0" width="99%" cellspacing="0" cellpadding="0">
	...
	<tr><td valign="top" height="10"><img src="/engresources/images/spacer.gif" border="0" height="10"/></td></tr>
  	<tr><td valign="top"><a CLASS="MedBlackText">Your password has been sent to your e-mail address.</a></td></tr>
