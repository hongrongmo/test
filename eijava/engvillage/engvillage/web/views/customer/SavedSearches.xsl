            ...
            function selectUnselectEmailAlert(cbno,searchid,historycount,sessionid,option)
            {
              ...
              if(option=='EmailAlert')
              {
                  if(cbcheck)
                  {
                    ...
                    {
                      window.alert("You have reached the maximum number of E-mail Alerts that can be saved.");
                    ...
                    else
                    {
                      ...
                      {
                        document.images[searchid].src="/engresources/images/cco.gif";
                      }
                    }
                  }
                  else
                  {
                    ...
                    if(typeof(document.images[searchid]) != 'undefined')
                    {
                      document.images[searchid].src="/engresources/images/spacer.gif";
                    }
                  }
              }
            }
    ...
    <table border="0" width="99%" cellspacing="0" cellpadding="0">
        <tr>
            <td valign="top" colspan="3" height="15">
                 <img src="/engresources/images/s.gif" border="0" height="15"/>
            </td>
        </tr>
        <tr>
        ...
        <tr><td valign="top" height="3" colspan="3"><img src="/engresources/images/spacer.gif" border="0" height="3"/></td></tr>
        ...
        <tr>
            ...
            <table border="0" width="100%" cellspacing="0" cellpadding="0">
                ...
                <img src="/engresources/images/s.gif" width="2" border="0"/></td>
                <td valign="top" bgcolor="#3173B5"><A CLASS="SmWhiteText"><b>No.</b></A></td>
                <td valign="top" width="4" bgcolor="#3173B5"><img src="/engresources/images/s.gif" border="0"/></td>
                <td valign="top" bgcolor="#3173B5"><A CLASS="SmWhiteText"><b>Type</b></A></td>
                <td valign="top" width="8" bgcolor="#3173B5"><img src="/engresources/images/s.gif" border="0"/></td>
                ...
                <td valign="top" width="4" bgcolor="#3173B5"><img src="/engresources/images/s.gif"/></td>
                <td valign="top" bgcolor="#3173B5"><A CLASS="SmWhiteText"><b>Results</b></A></td>
                <td valign="top" width="10" bgcolor="#3173B5"><img src="/engresources/images/s.gif" border="0" width="10"/></td>
                ...
                <td valign="top" width="4" bgcolor="#3173B5"><img src="/engresources/images/s.gif" border="0"/></td>
                <td valign="top" bgcolor="#3173B5" width="66"><A CLASS="SmWhiteText"><b>E-mail Alert</b></A></td>
                <td valign="top" width="4" bgcolor="#3173B5"><img src="/engresources/images/s.gif" border="0"/></td>
                <td valign="top" bgcolor="#3173B5" width="72"><A CLASS="SmWhiteText"><b>Date Saved</b></A></td>
                <td valign="top" width="2" bgcolor="#3173B5"><img src="/engresources/images/s.gif" width="2" border="0"/></td>
                <td valign="top" bgcolor="#3173B5"><img src="/engresources/images/s.gif" height="1"/></td>
                </tr>
                <tr>
                    <td valign="top" colspan="22" height="15"><img src="/engresources/images/s.gif" border="0" height="15"/></td>
                </tr>
            ...
            <xsl:value-of select="java:encode($DATABASE-MASK)"/>
              ...
              <xsl:variable name="REMOTE-QUERY"><xsl:value-of select="REMOTE-QUERY"/></xsl:variable>
                ...
                <tr>
                    ...
                    <td valign="top" width="2"><img src="/engresources/images/s.gif" width="2" border="0"/></td>
                    <td valign="top"><A CLASS="MedBlackText"><xsl:value-of select ="$SEARCH-INDEX"/>.</A></td>

                    <td valign="top" width="4"><img src="/engresources/images/s.gif" border="0"/></td>
                    <td valign="top"><A CLASS="MedBlackText"><xsl:value-of select ="$SEARCH-TYPE"/></A></td>

                    <td valign="top" width="8"><img src="/engresources/images/s.gif" border="0"/></td>
                    ...
                    <td valign="top" >
                    <img src="/engresources/images/{SORT-DIRECTION}ar.gif"/>
                    ...
                    <xsl:if test="boolean($EMAILALERTS-PRESENT='true')">
                          ...
                          <input type="checkbox" name="emailalert" onClick="selectUnselectEmailAlert({$SEARCH-INDEX},'{$QUERY-ID}',{$NUMSEARCHES},'$SESSIONID','EmailAlert')">
                            ...
                            <img name="{$QUERY-ID}" width="24" height="14" alt="Alert Cc: List" border="0">
                              <xsl:if test="($EMAIL-ALERT='On')">
                                <xsl:if test="($CC-LIST='')">
                                  <xsl:attribute name="src">/engresources/images/cco.gif</xsl:attribute>
                                </xsl:if>
                                <xsl:if test="not($CC-LIST='')">
                                  <xsl:attribute name="src">/engresources/images/ccg.gif</xsl:attribute>
                                </xsl:if>
                              </xsl:if>
                              <xsl:if test="not($EMAIL-ALERT='On')">
                                <xsl:attribute name="src">/engresources/images/spacer.gif</xsl:attribute>
                              </xsl:if>
                            </img>
                            </a>
                          </xsl:if>
                      ...
                      <img src="/engresources/images/s.gif" border="0" width="0"/>
                    </xsl:if>
                    </td>
                    <td valign="top" width="4"><img src="/engresources/images/s.gif" border="0"   name="saved_searches"/></td>
                    <td valign="top">
                        ...
                        <img src="/engresources/images/remove.gif" border="0"/>
                        </a>
                    </td>
                ...
                <tr>
                    ...
                    <a href="javascript:confirmClear({$RESULTS-DATABASE},'{$SHOW}');"><img src="/engresources/images/ca.gif" border="0"/></a>
                    </xsl:if>
                    </td>
                    <td valign="top" width="2"><img src="/engresources/images/s.gif" width="2" border="0"/></td>
               </tr>
                ...
                <tr>
                    <td valign="top" colspan="22" height="8"><img src="/engresources/images/s.gif" border="0" height="8"/></td>
                </tr>
                <tr>
                    <td valign="top" bgcolor="#3173B5" height="1" colspan="22"><img src="/engresources/images/s.gif" border="0" height="1"/></td>
                </tr>
            </table>
        </td>
        <td valign="top" width="1" bgcolor="#3173B5"><img src="/engresources/images/s.gif" border="0" width="1"/></td>
        </tr>
        <tr>
            <td valign="top" height="8" colspan="3"><img src="/engresources/images/s.gif" border="0" height="8"/></td>
        </tr>
    </table>
    </form>
  ...
  <xsl:otherwise>
    ...
    <center>
        <table border="0" width="99%" cellspacing="0" cellpadding="0">
            ...
            <xsl:choose>
              <xsl:when test="$SHOW='alerts'">You have no E-mail Alerts.</xsl:when>
              <xsl:otherwise>You have no saved searches.<P>To save a search, go to Search History and click on the "Save" button next to the search query you wish to save. You may save up to <xsl:value-of select="svdsrch:getSavedSearchCount()"/> searches.</P><P>You can also set up E-mail Alerts for saved searches.</P>
              </xsl:otherwise>
            </xsl:choose>
            <P>An E-mail alert is a weekly e-mail message with updated search results from your saved search. To create an E-mail Alert, go to Search History and check the E-mail Alert checkbox next to the "Save" button. You may create up to <xsl:value-of select="svdsrch:getEmailAlertCount()"/> E-mail Alerts.</P>
            </a></td></tr>
        </table>
    </center>
