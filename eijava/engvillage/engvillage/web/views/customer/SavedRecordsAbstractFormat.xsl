...
<xsl:template match="PAGE">
    ...
    <body bgcolor="#FFFFFF" topmargin="0" marginheight="0" marginwidth="0">
        ...
        <table border="0" width="99%" cellspacing="0" cellpadding="0">
            <tr>
                <td align="left" valign="middle" height="24" bgcolor="#C3C8D1"><img width="8" height="1" src="/engresources/images/s.gif" border="0" /><a href="/controller/servlet/Controller?CID=viewPersonalFolders&amp;database={$DATABASE-MASK}"><img src="/engresources/images/myfolders.gif" border="0"/></a></td>
            </tr>
        </table>
            ...
            <tr>
                <td valign="top" colspan="5">
                    <table border="0" width="99%" cellspacing="0" cellpadding="0">
                        ...
                        <tr><td valign="top" align="left"><a class="EvHeaderText">Folder Name: </a><a CLASS="MedBlackText"><xsl:value-of select="$FOLDER-NAME"/></a></td></tr>
  ...
  <xsl:template match="PAGE-ENTRY">
    ...
    <tr>
      <td valign="top" align="left">
        <a href="/controller/servlet/Controller?CID=deleteFromSavedRecords&amp;format=abstract&amp;database={$DATABASE-MASK}&amp;docid={$DOC-ID}&amp;folderid={$FOLDER-ID}">
      ...
      <xsl:choose>
        <xsl:when test="($CHECK-CUSTOM-OPT='true')" >
          <tr>
            ...
            <a href="" onclick="window.open('/controller/servlet/Controller?CID=FullTextLink&amp;docID={$DOC-ID}','newwindow','width=500,height=500,toolbar=no,location=no,scrollbars,resizable');return false"><img name='fullDocImageCit'  src="/engresources/images/av.gif" border="0" /></a>
            </td>
          </tr>
        </xsl:when>
        <xsl:otherwise>
          <tr><td valign="bottom" colspan="4" height="30"><img src="/engresources/images/s.gif" border="0" height="30"/></td>
          </tr>
        </xsl:otherwise>
      </xsl:choose>
