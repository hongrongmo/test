                          ...
                          <table border="0" width="100%" cellspacing="0" cellpadding="0" bgcolor="#F5F5F5">
                            <tr height="30">
                              ...
                              <td valign="middle" bgcolor="#148BA9">
                                <xsl:value-of disable-output-escaping="yes" select="//EBOOK-SEARCH/MAT/HEAD"/>
                              </td>
                              <td valign="top" bgcolor="#148BA9">
                                <img src="/engresources/images/s.gif" border="0" width="4"/>
                              </td>
                              <td valign="middle" bgcolor="#148BA9">
                                <xsl:value-of disable-output-escaping="yes" select="//EBOOK-SEARCH/ELE/HEAD"/>
                              </td>
                              <td valign="top" bgcolor="#148BA9">
                                <img src="/engresources/images/s.gif" border="0" width="4"/>
                              </td>
                              <td valign="middle" bgcolor="#148BA9">
                                <xsl:value-of disable-output-escaping="yes" select="//EBOOK-SEARCH/CHE/HEAD"/>
                              </td>
                            </tr>
                            <tr>
                              ...
                              <td valign="top">
                                ...
                                <table border="0" cellspacing="0" cellpadding="0" width="100%">
                                  ...
                                  <tr>
                                    <td valign="top">
                                      <xsl:value-of disable-output-escaping="yes" select="//EBOOK-SEARCH/MAT/CVS"/>
                                      <br/><xsl:value-of disable-output-escaping="yes" select="//EBOOK-SEARCH/MAT/BSTATE"/>
                                    </td>
                                  </tr>
                                </table>
                              </td>
                              ...
                              <td valign="top">
                                ...
                                <table border="0" cellspacing="0" cellpadding="0" width="100%">
                                  ...
                                  <tr>
                                    <td valign="top">
                                      <xsl:value-of disable-output-escaping="yes" select="//EBOOK-SEARCH/ELE/CVS"/>
                                      <br/><xsl:value-of disable-output-escaping="yes" select="//EBOOK-SEARCH/ELE/BSTATE"/>
                                    </td>
                                  </tr>
                                </table>
                              </td>
                              ...
                              <td valign="top">
                                ...
                                <table border="0" cellspacing="0" cellpadding="0" width="100%" >
                                  <tr>
                                    <td height="5"><img src="/engresources/images/s.gif" height="5"></img></td>
                                  </tr>
                                  <tr>
                                    <td valign="top">
                                      <xsl:value-of disable-output-escaping="yes" select="//EBOOK-SEARCH/CHE/CVS"/>
                                      <br/><xsl:value-of disable-output-escaping="yes" select="//EBOOK-SEARCH/CHE/BSTATE"/>
                                    </td>
                                  </tr>
                                </table>
                              </td>
