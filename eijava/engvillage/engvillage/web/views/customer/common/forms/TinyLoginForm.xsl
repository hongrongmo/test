...
<tr><td valign="top" bgcolor="#3173B5" width="1"><img src="/engresources/images/spacer.gif" border="0" width="1"/></td>
	<td valign="top" bgcolor="#FFFFFF">
		  ...
		  <table border="0" cellspacing="0" cellpadding="0">
			  ...
			  <tr><td valign="top" height="6" colspan="3"><img src="/engresources/images/spacer.gif" border="0" height="6"/></td></tr>
			  <tr><td valign="top" width="3"><img src="/engresources/images/spacer.gif" border="0" width="3"/></td>
				  ...
				  <td valign="top" width="2"><img src="/engresources/images/spacer.gif" border="0" width="2"/></td></tr>
			  <tr><td colspan="3" height="4"><img src="/engresources/images/spacer.gif" height="4"/></td></tr>
			  <tr><td valign="top" width="3"><img src="/engresources/images/spacer.gif" border="0" width="3"/></td>
			  ...
			  <tr><td colspan="3" height="4"><img src="/engresources/images/spacer.gif" height="4"/></td></tr>
			  <tr><td valign="top" width="3"><img src="/engresources/images/spacer.gif" border="0" width="3"/></td>
				  <td valign="top"><input type="image" src="/engresources/images/login.gif" border="0"/></td>
				  <td valign="top" width="2"><img src="/engresources/images/spacer.gif" border="0" width="2"/></td></tr>
			  <tr><td valign="top" height="3"><img src="/engresources/images/spacer.gif" border="0"/></td></tr>
			  </form>
		 </table>
		  <!-- end of tiny form -->
	</td>
	<td valign="top" bgcolor="#3173B5" width="1"><img src="/engresources/images/spacer.gif" border="0" width="1"/></td></tr>
