...
>
  ...
  <xsl:template match="USPTO-QUICK-SEARCH">
    ...
    <SCRIPT LANGUAGE="Javascript" SRC="/engresources/js/QuickSearchForm_V15.js"/>
          ...
          <td valign="top" >
            ...
            <table border="0" align="right" width="100%" cellspacing="0" cellpadding="0">
              <tr>
                <td valign="top" bgcolor="#C3C8D1">
                  <form name="quicksearch" action="/controller/servlet/Controller?CID=usptoQuick" method="post" onSubmit="return searchValidation()">
                     <INPUT type="HIDDEN" name="database" value="{$SELECTED-DB}"/>
                    <table border="0" cellspacing="0" cellpadding="0" width="470" bgcolor="#C3C8D1">
                      <tr>
                        <td valign="top" height="20" colspan="5"><img src="/engresources/images/spacer.gif" border="0" height="20" /></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td valign="top" width="4" bgcolor="#C3C8D1"><img src="/engresources/images/spacer.gif" border="0" width="4" /></td>
                        <td valign="top" colspan="2" bgcolor="#C3C8D1"><a class="SmBlueTableText"><b>SEARCH FOR</b></a></td>
                        <td valign="top" colspan="2" bgcolor="#C3C8D1"><a class="SmBlueTableText"><b>SEARCH IN</b></a></td>
                      </tr>
                      <tr>
                        <td valign="top" width="4" bgcolor="#C3C8D1"><img src="/engresources/images/spacer.gif" border="0" width="4" /></td>
                        <td valign="top" width="15" bgcolor="#C3C8D1"><img src="/engresources/images/spacer.gif" border="0" width="15" /></td>
                        <!-- get search word 1 -->
                        <td valign="top" bgcolor="#C3C8D1">
                          <input type="text" name="searchWord1" size="29">
                            <xsl:attribute name="value"><xsl:value-of select="$SEARCH-WORD-1"/></xsl:attribute>
                          </input>
                        </td>
			...
			<a href="javascript:makeUrl('USPTO_patent_search.htm')">
			    <img src="/engresources/images/blue_help1.gif" border="0"/>
                      ...
                      <tr>
                            ...
                            <tr>
                              ...
                              <td valign="top" height="10" bgcolor="#C3C8D1">
                                ...
                                <input type="text" name="searchWord2" size="17">
                                  <xsl:attribute name="value"><xsl:value-of select="$SEARCH-WORD-2"/></xsl:attribute>
                                </input>
                                </a>
                              </td>
                            </tr>
                        ...
                        <td valign="top" colspan="2" bgcolor="#C3C8D1" width="211" align="left">
                          ...
                          <select name="section2">
                            <xsl:for-each select="//FIELDS/FIELD">
                              <option>
                                <xsl:if test="(@SHORTNAME=$SEARCH-OPTION-2)">
                                  <xsl:attribute name="selected"/>
                                </xsl:if>
                                <xsl:attribute name="value"><xsl:value-of select="@SHORTNAME"/></xsl:attribute>
                                <xsl:value-of select="@DISPLAYNAME"/>
                      ...
                      <tr>
                        <td valign="top" height="4" colspan="5" bgcolor="#C3C8D1"><img src="/engresources/images/spacer.gif" border="0" height="4" /></td>
                      </tr>
                      <tr>
                        <td valign="top" width="4" bgcolor="#C3C8D1"><img src="/engresources/images/spacer.gif" border="0" width="4" /></td>
                        <td valign="top" width="15" bgcolor="#C3C8D1"><img src="/engresources/images/spacer.gif" border="0" width="15" /></td>
                              ...
                              <td valign="top" height="10" bgcolor="#C3C8D1">
                                <a class="MedBlackText">
                                  <input type="text" name="searchWord3" size="17">
                                    <xsl:attribute name="value"><xsl:value-of select="$SEARCH-WORD-3"/></xsl:attribute>
                                  </input>
                                </a>
                              </td>
                            </tr>
                        ...
                        <td valign="top" colspan="2" bgcolor="#C3C8D1" width="211" align="left">
                          <a class="MedBlackText" height="10">&#160; &#160; &#160;
                            <select name="section3">
                              <xsl:for-each select="//FIELDS/FIELD">
                                <option>
                                  <xsl:if test="(@SHORTNAME=$SEARCH-OPTION-3)">
                                    <xsl:attribute name="selected"/>
                                  </xsl:if>
                                  <xsl:attribute name="value"><xsl:value-of select="@SHORTNAME"/></xsl:attribute>
                                  <xsl:value-of select="@DISPLAYNAME"/>
                      ...
                      <tr>
                        <td valign="top" colspan="5" height="8" bgcolor="#C3C8D1"><img src="/engresources/images/spacer.gif" border="0" height="8" /></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td valign="top" width="4" bgcolor="#C3C8D1"><img src="/engresources/images/spacer.gif" border="0" width="4" /></td>
                        <td valign="top" colspan="4" bgcolor="#C3C8D1"><a class="SmBlueTableText"><b>LIMIT BY</b></a></td>
                      </tr>
                      <tr>
                        <td valign="top" width="4" bgcolor="#C3C8D1"><img src="/engresources/images/spacer.gif" border="0" width="4" /></td>
                        <td valign="top" width="15" bgcolor="#C3C8D1"><img src="/engresources/images/spacer.gif" border="0" width="15" /></td>
                        ...
                        <td valign="bottom">&#160;
                          ...
                          <input type="image" src="/engresources/images/search_orange1.gif" name="search" value="Search" border="0"/></a>&#160; &#160;
                          <a href="javascript:doReset()"><img src="/engresources/images/reset_orange1.gif" border="0" /></a>
                        </td>
                      </tr>
                      <tr>
                        <td valign="top" colspan="5" height="1"><img src="/engresources/images/spacer.gif" border="0" height="1" width="455" /></td>
                      </tr>
                    </table>
                </form>
              <!-- end of search form -->
