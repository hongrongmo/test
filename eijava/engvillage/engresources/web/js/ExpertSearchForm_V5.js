...
function flipImage(selectedDbMask)
{
    ...
    //CT
    if (((selectedDbMask & CPX) == CPX) || ((selectedDbMask & INSPEC) == INSPEC) || ((selectedDbMask & NTIS) == NTIS))
    {
...
function calStartYear(selectedDbMask, sYear)
{
    ...
    if((selectedDbMask != 0) && ((selectedDbMask & UPT) == UPT))
    {
