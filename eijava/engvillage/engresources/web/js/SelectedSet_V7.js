     ...
     */
	function viewSelectedSetFormat(sessionid, 
				       basketcount,
				       database,
				       searchresults,
				       newsearch,
				       formvalue)
	{
		...
		if(displaytype == 'detailed')
		{
        	...
        	document.location ="/controller/servlet/Controller?EISESSION="+sessionid+"&CID="+viewformat+"&BASKETCOUNT="+basketcount+"&DATABASETYPE="+database+"&searchresults="+URLEncode(searchresults)+"&newsearch="+URLEncode(newsearch);
	}
