...
*/
			    ...
			    newsearch)
	{
		...
		document.location ="/controller/servlet/Controller?EISESSION="+sessionid+"&CID="+viewformat+"&DATABASETYPE="+database+"&searchresults="+URLEncode(searchresults)+"&newsearch="+URLEncode(newsearch);
	}
