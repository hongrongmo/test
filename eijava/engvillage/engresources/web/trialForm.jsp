	    ...
	    <body id="trial_request">
	        ...
	        <div id="container_inner">
	            ...
	            <div id="content">
	                <div id="content_inner">
	                    ...
	                    <p>Customers interested in learning about site licenses may request a free 30-day trial for any of Ei&rsquo;s electronic products.  See how your organization&rsquo;s research needs can be met.</p>
	                    <p>For site license customers we provide comprehensive usage reporting to help you understand and manage product uptake  across the communities you serve.</p>
											<p>* Required Field</p>
	                    <form name="trialform" id="trialform" method="POST" action="/controller/servlet/Controller" onsubmit="return Validator(this);">
													<input type="hidden" name="CID" value="trialFormCompleted"/>
													<input type="hidden" name="REF-URL" value="<%= java.net.URLEncoder.encode(referrerURL) %>" />
	                        <label for="firstname">
	        ...
	        <dl id="footer">
	            ...
	            <dd>
	                ...
	                <ul>
	                    <li class="first_child">Copyright &copy; 2010 Elsevier Inc. All Rights Reserved</li>
	                </ul>
	            </dd>
	        </dl>
	    </body>
